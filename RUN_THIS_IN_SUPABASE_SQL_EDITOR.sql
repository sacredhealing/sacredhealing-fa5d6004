-- ============================================================================
-- PROJECT: THE SOVEREIGN SANCTUARY - VISHWANANDA CORE STABILITY FIX
-- Run this entire script in your Supabase SQL Editor
-- ============================================================================

-- 1. Refresh PostgREST Schema Cache (Fabrice Bellard Efficiency)
-- Note: This will refresh the API cache to recognize new columns
...
DO $$
BEGIN
  RAISE NOTICE '✅ Migration completed successfully! Schema refreshed, admin functions created, and RLS policies updated.';
END $$;
