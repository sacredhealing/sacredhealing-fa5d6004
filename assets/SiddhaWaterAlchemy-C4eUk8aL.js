import{i as x,r as l,j as e}from"./vendor-react-DdWqvjvq.js";import{b as W,g as H}from"./index-DPalQnOV.js";import{u as P}from"./useAdminRole-Bx4gCuv8.js";import{b3 as L,l as Y,a7 as v,_ as T}from"./vendor-icons-DQ9y02-X.js";import"./vendor-crypto-Cz0s2Wb9.js";import"./vendor-radix-E_JnJsxb.js";import"./vendor-i18n-CLO2ZSBh.js";import"./vendor-query-DDdS-q50.js";import"./vendor-supabase-C8XXFrAR.js";import"./vendor-motion-BWTr00U0.js";const u="#D4AF37",F="#22D3EE",B="#B084CC",G=["free","prana_flow","siddha_quantum","akasha_infinity"],A=s=>G.indexOf(s),E={free:{label:"FREE",color:"rgba(255,255,255,0.55)",price:"Open to all"},prana_flow:{label:"PRANA-FLOW",color:u,price:"€19 / month"},siddha_quantum:{label:"SIDDHA-QUANTUM",color:F,price:"€45 / month"},akasha_infinity:{label:"AKASHA-INFINITY",color:B,price:"€1,111 lifetime"}},U=[{id:"f01",tier:"free",icon:"💧",number:"01",title:"Neer — The Living Consciousness of Water",subtitle:"What the Siddhas knew 6,000 years before modern science began to confirm it",siddha:"Agastya Muni",essence:"Water is not a substance. Water is a stage of Consciousness becoming matter.",mantra:"Om Apas Theerthaya Namaha",sections:[{heading:"Water Is Not a Resource. Water Is a Being.",body:`Before a single star was lit, before the first breath of Prana moved across the void, there was Apas — the primordial water principle. In the Pancha Bhuta cosmology encoded by the 18 Siddhas, water is the second densification of consciousness: Akasha (space) contracts into Vayu (air), Vayu stirs into Agni (fire), Agni cools into Apas (water), Apas crystallises into Prithvi (earth).
...
Agastya Muni transmitted in the Agastya Naadi: "Do not call it water. Call it what it is: the resting body of the Devas, the vessel of all memory, the mother of all life. Treat it accordingly and it will transform you. Neglect it and it will carry your neglect into every cell."`},{heading:"The Quantum Biology of Water Consciousness",body:`Dr. Gerald Pollack at the University of Washington identified a fourth phase of water — beyond solid, liquid, and gas — called Exclusion Zone (EZ) water or structured water. This phase forms wherever water contacts living surfaces, holds structured geometric information, and is the medium through which every biological process in your body occurs.
...
The Siddha insight that has no modern parallel: fear, anger, and grief create measurable disruption in EZ water geometry. Love, gratitude, and focused intention create measurable coherence. This is not metaphor. It is the most important health insight of the 21st century, and the Siddhas built an entire civilisation on it.`},{heading:"You Are an Ocean That Has Learned to Walk",body:`You are approximately 70% water. Your brain is 80% water. Your blood is 90% water. The water in your body is not inert filler — it is the active medium through which every biological process occurs: enzyme reactions, nerve signal transmission, cellular respiration, DNA replication, hormone circulation.

The Siddha insight: this structured water matrix is, in its finest expression, indistinguishable from Prana itself. Prana — the life force — IS the electromagnetic coherence of the body's structured water matrix. This is why pranayama has direct and measurable effects on health: breathing correctly increases the body's electromagnetic coherence, which directly increases EZ water structuring, which directly enhances every biological function.`}],practice:`MORNING WATER COMMUNION (5 minutes daily)
...
Consistent practice for 21 days: most practitioners report measurable shifts in morning energy, emotional baseline, and clarity of mind.`},{id:"f02",tier:"free",icon:"🌌",number:"02",title:"The Cosmic Birth of Water",subtitle:"You are drinking starlight. The Siddhas knew this before astronomy existed.",siddha:"Thirumoolar",essence:"From the space between the stars, the divine nectar rained upon the earth.",mantra:"Om Varuna Devaya Namaha",sections:[{heading:"Water Was Born in the Hearts of Dying Stars",body:`Thirumoolar in the Tirumantiram states: "From the space between the stars, the divine nectar rained upon the earth. Know this — you are drinking starlight made heavy." He wrote this approximately 2,000 years ago, without telescopes or spectroscopy. And yet he was precisely correct.
...
Every water molecule in your body began as hydrogen created 13.8 billion years ago and oxygen forged in a star that died before our sun was born. You are a temporary organisation of cosmic water that has borrowed itself from the universe to have a conscious experience.`},{heading:"Why Modern Water Needs Recharging — The Yuga Doctrine",body:`The Yuga-Neer doctrine: the quality and consciousness-carrying capacity of water changes with the cosmic ages. In the Sat Yuga, water was far more luminous and coherent — closer to what the Siddhas called "Amrita" (divine nectar). The densification through the Treta, Dvapara, and Kali Yugas has progressively condensed the water principle, trapping more of its inherent light-information inside denser molecular structures.
...
Additionally: industrial water processing (chlorination, fluoridation, pressure through metal pipes, electromagnetic field exposure) further disrupts water's natural EZ structuring. The charging practices taught in this curriculum are the necessary restoration of what modern civilisation has stripped from water.`}],practice:`THE COSMIC WATER MEDITATION (10 minutes, weekly)
...
Feel the age and the journey in the water you hold. Feel genuine gratitude for its arrival. Then drink. Slowly. Knowing what you are drinking.`},{id:"f03",tier:"free",icon:"🌿",number:"03",title:"Pancha Bhuta — Water in the Architecture of Creation",subtitle:"How the five elements interlock through water, and what this means for your health",siddha:"Thirumoolar & Agastya",essence:"Water is the mediator between fire and earth — the translator of heaven into body.",mantra:"Om Panchabutaya Apas Shaktiye Namaha",sections:[{heading:"The Five Elements Are a Physics, Not a Philosophy",body:`The Pancha Bhuta system — Akasha (space), Vayu (air), Agni (fire), Apas (water), and Prithvi (earth) — is commonly taught as a philosophical framework. This misrepresents it. The Siddhas designed it as a precision physics of consciousness-becoming-matter.
...
7. REPRODUCTIVE FLUID (Shukra/Artava Jalam): Considered the most refined, highest-Prana fluid in the body — the distillate of all other tissues.`}],practice:`THE FIVE-ELEMENT WATER MEDITATION
...
Then drink your central water glass slowly, holding the awareness that you are drinking all five elements in their liquid form.`},{id:"f04",tier:"free",icon:"🫀",number:"04",title:"Siddha Water Timing & The Three Levels of Dehydration",subtitle:"When to drink, how much, and the dehydration modern medicine cannot see",siddha:"Agastya Muni",essence:"The body does not age because of time. It ages because its water becomes less coherent.",mantra:"Om Neer Deha Shakti Namaha",sections:[{heading:"Three Levels of Dehydration",body:`Modern medicine defines dehydration as a deficit of water volume. Siddha medicine defines it at three levels:
...
Most people in modern civilisation are experiencing all three levels simultaneously.`},{heading:"The Siddha Water Timing Protocol",body:`The modern "8 glasses a day" recommendation has no individual calibration. The Siddha answer is more precise:
...
THE SIDDHA WATER TEMPERATURE RULE: Room temperature or warm. Never ice-cold. Cold water constricts the stomach, slows digestion, and suppresses digestive enzyme activity. The Siddhas considered ice-cold water one of the most consistently health-damaging habits of modern civilisation.`}],practice:`7-DAY WATER AWARENESS JOURNAL
...
This journaling practice is the beginning of body literacy — the fundamental skill all advanced Siddha practices require.`},{id:"f05",tier:"free",icon:"🌙",number:"05",title:"Chandra — The Moon's Governance of Your Water Body",subtitle:"The moon does not merely control tides. It governs every fluid in your body.",siddha:"Thirumoolar",essence:"The moon is the mind of the cosmic body. Your mind is the moon of your personal body. Both govern water.",mantra:"Om Chandraaya Namas-te Om Apas Roopaya Namaha",sections:[{heading:"The Scientific Basis of Lunar Water Governance",body:`The gravitational pull of the moon is strong enough to move entire oceans — the tides of Earth's seas rise and fall by metres in response to lunar position. This is established, measured, uncontested physics.
...
The Siddhas did not need gravitation theory. Over millennia of careful observation of human behaviour, biology, and psychology in relation to lunar cycles, they mapped the moon's governance of the body's water with extraordinary precision. The Tamil Siddha calendar — the Panchangam — is built around lunar cycles specifically because every agricultural, medical, and spiritual decision was understood to operate within the context of the moon's water-governance.`},{heading:"The 28-Day Water Intelligence Cycle & Full Moon Protocol",body:`NEW MOON (Amavasya): Body water draws inward — toward deep tissues. Best time for: deep detox, releasing old patterns, water fasting. Maximum cellular receptivity.
...
WANING: The releasing phase. Best time for water fasting, lymphatic drainage, emotional processing.`}],practice:`THE LUNAR WATER CALENDAR (3 months)
...
Three months of this practice fundamentally resynchronises your body's water intelligence with the cosmic water cycle.`},{id:"f06",tier:"free",icon:"🌊",number:"06",title:"Sacred Rivers — The Healing Intelligence of Living Water",subtitle:"Why different waters heal differently, and the Siddha map of the seven healing rivers",siddha:"Agastya Muni",essence:"Each river is a specific name of the Goddess — a distinct frequency of Her healing intelligence.",mantra:"Om Sapta Sindhave Namaha",sections:[{heading:"The Seven Primary Healing Rivers",body:`Each river has a unique mineral composition, a unique geological history, a unique electromagnetic signature, and a unique accumulated Pranic field created by civilisations and sacred sites on its banks.
...
KRISHNA: Playful, transformative quality. Healing specialty: depression rooted in lack of delight, the inability to experience joy.`},{heading:"Working With Natural Water Bodies — The River Practice",body:`The Siddha principle: any natural, moving, living water carries healing intelligence. The seven rivers are the archetypes — all living water is their expression in local form.
...
TO ACCESS RIVER FREQUENCIES ANYWHERE: Chant the river's invocation mantra 21 times over clean water. For Kaveri: "Om Kaveri Mata Namaha."`}],practice:`RIVER FREQUENCY PILGRIMAGE
...
At 21 days: has the quality of the challenge shifted? Which river does your next phase call for?`},{id:"pf07",tier:"prana_flow",icon:"🧬",number:"07",title:"Water Memory — The Complete Science",subtitle:"How water holds information, and the Siddha technology for working with it",siddha:"Bogar",essence:"Water does not forget. It is the universe's perfect record-keeper.",mantra:"Om Smriti Neer Shaktiye Namaha",sections:[{heading:"The Physics of Water Memory",body:`The hydrogen bond network of water forms and breaks bonds approximately 10¹² (one trillion) times per second. This led mainstream chemistry to conclude water could not hold memory: bonds reformed too fast for any pattern to persist.
...
The Siddhas had a simpler formulation: "Neer remembers every frequency it has ever touched." This was not a belief. It was the operational principle around which an entire medical system was built.`},{heading:"Four Levels of Water Memory & How to Clear and Charge",body:`SURFACE MEMORY (Sparsha Smriti): Immediate reorganisation in response to frequency input. Persists for seconds to minutes. Level of casual intention.
...
COMBINED PROTOCOL: Sunlight exposure, then sound clearing, then 21 stirring vortex cycles. Then begin your charging practice.`}],practice:`THE MOTHER WATER PROTOCOL (30-Day)
...
After 30 days: Your Mother Water has accumulated 30 days of continuous Pranic charge and has reached the Field Memory level. Many Siddha lineages maintained Mother Waters for decades — some for generations.`},{id:"pf08",tier:"prana_flow",icon:"🥃",number:"08",title:"Tamra Jal — The Complete Copper Vessel Science",subtitle:"The most researched, most clinically validated Siddha water practice",siddha:"Agastya Muni",essence:"Copper is the sun in metal form. Sun-water is the first medicine of the Siddhas.",mantra:"Om Suryaya Tamra Jala Shaktiye Namaha",sections:[{heading:"Why Copper and Water Are Cosmically Paired",body:`In Siddha alchemy, copper is classified as "Surya Dhatu" — the metal of the sun. Water is classified as "Chandra Tattva" — the substance of the moon. The pairing of copper vessel and water is therefore the pairing of solar and lunar intelligence — Surya and Chandra, Shiva and Shakti — creating a complete, balanced frequency field. This is the first principle of Tamra Jal science: the vessel is not merely a container. It is an alchemical co-creator of the medicine.

The modern research confirms the ancient understanding: when water is stored in a copper vessel for 6–8 hours, measurable quantities of copper ions leach into the water (approximately 177 micrograms per litre — well within WHO safe limits). These copper ions have documented effects: antimicrobial (kills E. coli, S. aureus, and other pathogens on contact), anti-inflammatory, antioxidant, and supportive of multiple enzyme systems governing iron metabolism, collagen synthesis, and neural development.`},{heading:"The Complete Tamra Jal Protocol & Documented Effects",body:`VESSEL: Use only pure copper (99%+ purity). Never copper-plated vessels or alloys.
...
DOCUMENTED EFFECTS: Digestive enzyme activation, antimicrobial (pathogen killing in gut), joint flexibility (copper essential co-factor in collagen cross-linking enzymes), thyroid T4-to-T3 conversion, dopamine-noradrenaline conversion (motivation and cognitive sharpness), and immune cell proliferation.`}],practice:`90-DAY TAMRA JAL COMMITMENT
...
At day 90, compare week 1 to week 13. The trajectory of change will be your most personal and irrefutable evidence of what the Siddhas spent 6,000 years documenting at the clinical level.`},{id:"pf09",tier:"prana_flow",icon:"🎵",number:"09",title:"Nada and Water — Sound as the Primary Charging Medium",subtitle:"Why mantras charge water, which frequencies work, and the complete sound-water protocol",siddha:"Thirumoolar",essence:"Sound is the creator. Water is the created. When sound meets water, creation is re-enacted.",mantra:"Om Nada Brahma Apas Shaktiye Namaha",sections:[{heading:"The Physics of Cymatics and Sound-Water Geometry",body:`Cymatics — the study of visible sound patterns — demonstrates what the Siddhas knew: sound creates geometry. Hans Jenny's cymatics experiments showed that specific frequencies applied to water create specific, reproducible geometric patterns. As frequency increases, the complexity of the pattern increases. Lower frequencies create simple circles and rings. Higher frequencies create intricate mandala-like geometries.
...
The specific mantra frequencies of the Vedic tradition, calibrated over millennia`},{heading:"The Siddha Mantra Water Pharmacopoeia — Six Primary Mantras",body:`OM (AUM): Creates the most universally coherent geometry in water. Broadest-spectrum water medicine. Charge time: 108 repetitions minimum.
...
MAHAMRITYUNJAYA MANTRA: The healing and liberation mantra. Particularly effective for: recovery from serious illness, healing from injury, chronic degenerative conditions. Charge time: 21 repetitions minimum.`}],practice:`21-DAY SOUND-WATER ACTIVATION
...
At 21 days: the sound-water protocol has established a new pattern in your cellular water matrix. The water in your body has been receiving consistent coherent frequency input daily for three weeks. You are, at a cellular level, a different instrument.`},{id:"pf10",tier:"prana_flow",icon:"🫁",number:"10",title:"Pranayama and Water — Activating the Nadi System",subtitle:"The breath and water work together as one system. The complete integration.",siddha:"Konganavar",essence:"Breath is water in its invisible form. Water is breath made visible.",mantra:"Om Prana Neer Ekam Namaha",sections:[{heading:"Why Breath and Water Are One System",body:`Konganavar stated: "The practitioner who thinks pranayama and water practice are separate is like a musician who thinks the right hand and left hand play different instruments. They are one system. Learn to play them together."
...
SITALI (Cooling Breath): Curl tongue into a tube. Inhale through the tongue-tube (the incoming air is cooled and moistened — literally drinking breath). Exhale through nose. 12 rounds. The water element's specific pranayama.`}],practice:`40-DAY WATER-BREATH INTEGRATION
...
Keep a daily log of energy before and after. The 40-day trajectory — not day-to-day variation — is the clinical indicator.`},{id:"pf11",tier:"prana_flow",icon:"💙",number:"11",title:"Water and the Emotional Body",subtitle:"Your tears know things your mind does not. The complete emotional-water science.",siddha:"Agastya Muni",essence:"Tears are the body's most sacred water — the only fluid generated exclusively by feeling.",mantra:"Om Bhava Neer Shuddhi Namaha",sections:[{heading:"Why Emotions Live in Water",body:`The Siddha understanding of the emotional body is not psychological. It is hydrological. Emotions are electromagnetic events that originate in the body's water matrix and generate downstream effects in the nervous system and mind. This is why emotions are felt in the body before they are understood by the mind.
...
PEACE (Shanti Neer): The baseline state of the water matrix when all disturbances have been released. Still, clear, deep, unhurried. Gazing at still water for 10–15 minutes is documented to reduce cortisol and create measurable coherence in the cardiac electromagnetic field.`}],practice:`THE 28-DAY EMOTIONAL WATER JOURNAL
...
After 28 days, review. Most practitioners discover: specific times of day when certain emotions arise predictably, and that the simple act of drinking water consciously in the moment of emotional intensity creates an immediate and measurable shift.`},{id:"pf12",tier:"prana_flow",icon:"🌿",number:"12",title:"Theertham — Creating Sacred Water at Home",subtitle:"The temple secret: how to make water holy, and why it is not only possible but necessary",siddha:"Agastya Muni",essence:"The temple is a water charging device built from stone. You are a temple built from water.",mantra:"Om Apam Pate Namas-te",sections:[{heading:"What Theertham Actually Is — The Architecture of Holiness",body:`Ancient Siddha temple design embedded water charging technology into the architecture itself. The temples were built from granite because granite contains quartz crystals. Quartz is piezoelectric: it generates electrical charge when mechanically stressed. When the massive granite pillars and walls of a Siddha temple are struck by bell vibrations of daily puja, the entire structure oscillates — and the water kept within it is continuously bathed in the electromagnetic output of thousands of tons of oscillating quartz crystal.
...
You do not have a Chidambaram Nataraja temple in your home. But you have what matters most: a conscious heart, specific knowledge, and the ability to create the four key elements — sound, light, intention, and a coherent vessel — in any space.`},{heading:"The Home Theertham Protocol — Complete Instructions",body:`PREPARATION OF SPACE: Clean the space. Use camphor burner, incense (sandalwood, frankincense, or pure dhoop), or singing bowl to clear the space's electromagnetic field.
...
GRIEF: Prepared at new moon. Add 5 rose petals. Chant Om Namah Shivaya 108 times.`}],practice:`WEEKLY THEERTHAM PRACTICE
...
After 3 months of consistent weekly Theertham preparation, most practitioners report a measurable difference between the weeks they make Theertham and weeks they don't — in energy, emotional clarity, sleep quality, and sense of spiritual connection.`},{id:"pf13",tier:"prana_flow",icon:"💎",number:"13",title:"Crystal Water — The Stone Intelligence",subtitle:"Every crystal is a frozen water-frequency. Learning to read the stones is learning to read the water.",siddha:"Bogar",essence:"Crystals are water that achieved permanence. Water is crystals in motion.",mantra:"Om Sphatika Neer Shaktiye Namaha",sections:[{heading:"The Alchemical Relationship Between Crystal and Water",body:`Bogar taught that crystals and water are two expressions of the same fundamental intelligence. Both are formed by the slow, precise organisation of matter around a geometric template. Ice is water that achieved temporary crystalline perfection. Quartz crystal is silicon dioxide that achieved permanent crystalline perfection over millions of years.
...
CLEAN CRYSTALS BEFORE USE: Submerge in salt water for 24 hours, then sunlight for 2–4 hours, then moonlight for one night.`},{heading:"Bogar's Crystal Water Pharmacopoeia",body:`CLEAR QUARTZ: Universal amplifier. Enhances whatever other intention or mantra the water has received. Use as foundation for any other combination.
...
Citrine + clear quartz = energy and clarity water`}],practice:`21-DAY CRYSTAL WATER PROTOCOL
...
After 21 days, the crystal has established a consistent frequency relationship with your body's water matrix. Continue indefinitely with the same crystal, or rotate to a different crystal based on the next phase of your evolution.`},{id:"pf14",tier:"prana_flow",icon:"🌙",number:"14",title:"Water and Sleep — The Night Protocols",subtitle:"What your water body does while you sleep, and how to maximise the healing",siddha:"Thirumoolar",essence:"Sleep is when the water body teaches the waking body what it knows. Learn to listen.",mantra:"Om Nidra Neer Shantaye Namaha",sections:[{heading:"What Your Water Body Does While You Sleep",body:`Sleep is not rest for the water body. It is its most active period.
...
DEHYDRATION DURING SLEEP: The body loses 500–1,000ml through breathing, sweating, and urination over 8 hours. This is why the morning water ritual is so critical.`},{heading:"The Complete Night Water Protocol",body:`BEFORE BED (60 minutes before sleep):
...
UPON WAKING: Before any screen or conversation, drink the water you prepared the night before. This is the most important water moment of the 24-hour cycle — the body is at maximum receptivity: mild dehydration + recent glymphatic clearing + parasympathetic morning state = optimal water absorption capacity.`}],practice:`THE DREAM WATER JOURNAL (21 nights)
...
— Joyful water (swimming, rain, rivers) = healthy water flow`},{id:"pf15",tier:"prana_flow",icon:"🧒",number:"15",title:"Water for Children and Families",subtitle:"How to raise children who have an inherent, embodied relationship with water",siddha:"Agastya Muni",essence:"The family that honours water together builds its home on an unshakeable foundation.",mantra:"Om Kutumba Neer Raksha Namaha",sections:[{heading:"Children and Water — The Developmental Science",body:`Infants are approximately 78% water at birth — more than at any other time in their lives. The higher water content of infants and young children means they are more sensitive to water quality and more responsive to water healing practices.
...
Document the changes in the family's collective emotional atmosphere over the month. Family water practice has been consistently reported to reduce household conflict, improve sleep quality for all members, and create a measurable increase in the sense of safety and belonging within the family unit.`},{id:"pf16",tier:"prana_flow",icon:"🌊",number:"16",title:"Water and Mental Health — Siddha Fluid Psychiatry",subtitle:"Depression, anxiety, and emotional disorders through the lens of the water body",siddha:"Agastya Muni",essence:"The disturbed mind is a disturbed water. Still the water and the mind follows.",mantra:"Om Mano Neer Prasanna Namaha",sections:[{heading:"The Three Mental Health Water Patterns",body:`Agastya Muni's medical texts contain what may be the oldest recorded system of water-based mental health treatment. His formulation: every mental health condition has a water dimension — a specific disruption in the body's fluid systems that both reflects and perpetuates the mental state.
...
Choose your water medicines, set a 30-day protocol, and track mood on a simple 1–10 daily scale. The trend line over 30 days — not the day-to-day variation — is the clinical indicator.`},{id:"sq17",tier:"siddha_quantum",icon:"⚡",number:"17",title:"Neer Upavasa — The Complete Water Fasting System",subtitle:"The most efficient cellular reset available — and the Siddhas mastered it completely",siddha:"Konganavar",essence:"When you stop feeding the body, the body begins to feed itself — at the cellular level, with intelligence.",mantra:"Om Upavasa Shakti Namaha",sections:[{heading:"Why Water Fasting Surpasses All Other Methods",body:`Konganavar stated: "There are many ways to fast. Only the water fast reaches the deepest cells. Only the water fast silences the electromagnetic noise of digestion completely enough for the body's own healing intelligence to speak."
...
The Nobel Prize in Physiology 2016 confirmed what Konganavar encoded millennia ago: autophagy is the body's primary cellular self-renewal mechanism, and fasting is its primary activator.`},{heading:"The Three Levels of Siddha Water Fasting",body:`LEVEL 1 — EKADASI FAST (24-Hour Monthly):
...
ELECTROLYTE FORMULA: 1/4 teaspoon Himalayan pink salt per litre of fasting water.`}],practice:`YOUR FIRST EKADASI FAST
...
REPEAT: Complete at least 3 Ekadasi fasts (one per month for 3 months) before considering Level 2. Three consecutive Ekadasi fasts create cumulative effects that a single fast does not.`},{id:"sq18",tier:"siddha_quantum",icon:"🌿",number:"18",title:"Neer Marundhu — The Complete Water Medicine System",subtitle:"25 Siddha water medicine recipes for every condition, season, and constitutional type",siddha:"Agastya Muni & Bogar",essence:"Water is the universal solvent. Make it also the universal medicine.",mantra:"Om Aushadhi Neer Shaktiye Namaha",sections:[{heading:"The 25 Siddha Water Medicines — Foundation Group (1–12)",body:`The Neer Marundhu system operates on three simultaneous levels: BIOCHEMICAL (specific molecular compounds), VIBRATIONAL (frequency pattern imprinted into water's hydrogen-bond geometry), and PRANIC (the life force of the practitioner, plants, and preparation time).
...
12. MULETHI (LICORICE ROOT) NEER: 1 tsp licorice root powder in 400ml water. Simmer 10 minutes. For: respiratory conditions, gut inflammation and ulcers, adrenal fatigue. ⚠️ Contraindicated in hypertension.`},{heading:"The 25 Siddha Water Medicines — Therapeutic & Seasonal Group (13–25)",body:`13. TULSI-GINGER-PEPPER IMMUNE NEER: 7 Tulsi leaves + 5 slices ginger + 7 whole black peppercorns in 500ml water. Simmer 15 minutes. Drink warm 2–3 times daily at first sign of infection.
...
25. VIJAYA NEER (Seasonal Super-Tonic, Full Moon): 1 tsp Haritaki + 1 tsp Ashwagandha + 1/2 tsp Shatavari + 1/4 tsp Brahmi + pinch Pippali + pinch Saffron in 400ml warm water. Simmer 10 minutes. Sweeten minimally with raw honey after cooling. Chant your chosen mantra 108 times over this preparation. The closest thing to the legendary Siddha "Amrita Preparation" that can practically be made at home.`}],practice:`YOUR PERSONAL WATER MEDICINE PROGRAM
...
This is how the Siddha physicians worked — not a fixed prescription, but a living relationship between the patient's changing state and the water medicine's offered intelligence.`},{id:"sq19",tier:"siddha_quantum",icon:"🔬",number:"19",title:"Structured Water — The EZ Science Deep Dive",subtitle:"The fourth phase of water: what it is, why it matters, and how to maximise it",siddha:"Bogar",essence:"EZ water is water remembering what it was before it forgot — liquid light.",mantra:"Om Vyuha Neer Namaha",sections:[{heading:"What Is EZ Water — The Discovery",body:`Dr. Gerald Pollack at the University of Washington discovered that water exists in a fourth phase — not solid, not liquid, not gas — called Exclusion Zone (EZ) water or structured water. This phase forms spontaneously wherever water contacts hydrophilic surfaces — including all biological membranes.
...
What destroys EZ water: dehydration, electromagnetic pollution (WiFi, cell towers, electrical wiring), stress hormones (cortisol, adrenaline), processed and artificial foods, heavy metals.`},{heading:"Seven Methods to Maximise EZ Water in Your Body",body:`METHOD 1 — SUNLIGHT BATHING: Infrared radiation from sunlight is the primary natural EZ water builder. 20–30 minutes of morning sunlight on skin (not through glass) increases the EZ water layer throughout the body's tissues.
...
METHOD 7 — FREQUENCY-CHARGED WATER: Drinking water exposed to 432 Hz, 528 Hz, or structured mantra frequencies creates an EZ-enhancing effect in the body's water matrix.`}],practice:`THE EZ WATER DAILY PROTOCOL
...
The practitioner who consistently hits 4–5 of these methods daily for 90 days is systematically rebuilding their body's EZ water matrix from the inside out. This is the most direct physical expression of what the Siddhas called Kaya Siddhi — mastery of the physical body through mastery of its water intelligence.`},{id:"sq20",tier:"siddha_quantum",icon:"🧬",number:"20",title:"Water and DNA — Epigenetic Healing",subtitle:"Your genes are not your destiny. Your water is. Here is the science.",siddha:"Bogar",essence:"DNA is the song. Water is the instrument. Change the instrument and the song changes.",mantra:"Om Jeeva Neer Shakti Shuddhi Namaha",sections:[{heading:"Epigenetics — The Siddha View Confirmed by Science",body:`The genetic determinism model — the belief that your health destiny is fixed in your DNA at birth — has been progressively dismantled by epigenetics research. Epigenetics is the science of how gene expression is regulated by factors other than the DNA sequence — including environment, nutrition, stress, emotion, toxin exposure, and — at the frontier — the electromagnetic field in which the DNA operates.
...
Additionally: epigenetic inheritance of trauma — the documented phenomenon by which traumatic experiences in ancestors alter gene methylation patterns passed to descendants — travels through the water medium. When you charge your water and enter heart coherence, you are not only healing yourself. You are altering the epigenetic water environment of the cells that will form your children and grandchildren.`},{heading:"The Water-DNA Healing Protocol",body:`DAILY DNA WATER PROTOCOL:
...
5. THE ANCESTRAL CLEARING INTENTION: As you drink your DNA water, hold the specific intention: "I release from my DNA the patterns of suffering that do not belong to me."`}],practice:`40-DAY DNA WATER HEALING PROTOCOL
...
At day 40: Revisit your three ancestral patterns. Describe any shifts in the quality of your relationship to these patterns. Have they softened? Do they feel less inevitable? This is the sign of epigenetic movement in the water matrix.`},{id:"sq21",tier:"siddha_quantum",icon:"⬡",number:"21",title:"The Chakra-Water System — Complete Map",subtitle:"Every chakra governs a specific body water. Heal the water, heal the chakra.",siddha:"Thirumoolar",essence:"The chakras are not metaphysical abstractions. They are electromagnetic nodes in the body's water matrix.",mantra:"Om Saptachakra Neer Shaktiye Namaha",sections:[{heading:"Chakras as Electromagnetic Water Nodes",body:`Thirumoolar's Tirumantiram contains the most clinically precise chakra descriptions in the Tamil Siddha tradition. His understanding: the chakras are precisely located electromagnetic nodes within the body's bioelectric field — corresponding to specific anatomical plexuses, endocrine glands, and fluid systems.

The key Siddha-Quantum insight: each chakra governs a specific body fluid, and the health of that fluid directly determines the health of the chakra — and vice versa. Heal the fluid, heal the chakra. Heal the chakra, heal the fluid. This bidirectional relationship is the clinical basis of the entire chakra-water medicine system.`},{heading:"The Seven Chakra-Waters — Complete Clinical Map",body:`MULADHARA (Root, Perineum) — BONE MARROW AND LOWER LYMPH:
...
Water medicine: it is the depth of relationship with water itself. The practitioner who has genuinely arrived at the understanding that water is consciousness has opened the Sahasrara water connection.`}],practice:`CHAKRA WATER DIAGNOSIS AND HEALING
...
Full chakra-water healing typically requires minimum one month per chakra level — so a complete system tune-up from Muladhara to Sahasrara is a 7-month journey.`},{id:"sq22",tier:"siddha_quantum",icon:"🌀",number:"22",title:"Kaya Kalpa — Cellular Regeneration Through Water",subtitle:"The Siddha science of reversing biological age through water intelligence",siddha:"Konganavar",essence:"The body does not age because of time. It ages because its water becomes less coherent.",mantra:"Om Kaya Kalpa Siddhi Namaha",sections:[{heading:"What Is Kaya Kalpa",body:`Kaya Kalpa — "transformation of the body" — is the most advanced branch of Siddha physical health science. It is the science of returning the body's water matrix to a higher state of coherence, thereby allowing the body's own repair and renewal systems to operate without the interference that accumulated incoherence creates.
...
Modern longevity science confirms aspects of this: the reduction in structured (EZ) water percentage in the body's cells is a consistent marker of biological aging. Stem cell function, mitochondrial efficiency, DNA repair rate, and immune surveillance capacity all correlate with the EZ water percentage in the relevant tissue.`},{heading:"The Five Pillars of Kaya Kalpa Water Practice",body:`PILLAR 1 — DEEP TISSUE HYDRATION: Goal is not merely hydration of blood and lymph but hydration of the deepest tissues: bone marrow, cartilage (receives all water through diffusion — no blood supply), vertebral discs (70% water in youth, declining to 50% in old age — this decline is the primary cause of disc degeneration).
...
PILLAR 5 — NEURAL AND HORMONAL WATER: Brahmi neer daily, Ashwagandha neer, Saffron neer before bed, Lion's Mane mushroom tea (the only natural compound with documented NGF — Nerve Growth Factor — stimulating effects), and full-spectrum light during the day with complete darkness at night.`}],practice:`THE KAYA KALPA QUARTERLY RETREAT
...
Done 4 times per year consistently over 3 years, the quarterly Kaya Kalpa mini-retreat creates cumulative cellular renewal effects that accumulate beyond what any single long practice can achieve.`},{id:"sq23",tier:"siddha_quantum",icon:"🔯",number:"23",title:"Water Yantra Science",subtitle:"How the Siddhas used sacred geometry to permanently encode water with specific healing frequencies",siddha:"Bogar",essence:"The Yantra is the blueprint. Water is the building material. Consciousness is the architect.",mantra:"Om Sri Yantra Apas Shaktiye Namaha",sections:[{heading:"What Is a Water Yantra — The Technology",body:`A Yantra is a sacred geometric diagram used in Siddha and Tantric traditions as a physical representation of a specific divine intelligence — a frequency blueprint made visible. The Sri Yantra — the interlocking nine-triangle composition that serves as the SQI logo — is the most complete of all Yantras, containing all other Yantra geometries within it.
...
CHAKRA MANDALA WATER: Prepare water over the specific geometric mandala of your target chakra. Six-pointed star for Anahata, crescent moon form for Svadhisthana, eight-petalled lotus for Vishuddha.`}],practice:`SRI YANTRA WATER PROTOCOL
...
After 40 days: many practitioners report that ordinary water drunk from a plain glass feels noticeably different — flatter, less alive — compared to Sri Yantra water. This is not imagination. This is EZ water coherence, measurable and real.`},{id:"sq24",tier:"siddha_quantum",icon:"🏛️",number:"24",title:"Sacred Water Pilgrimage Sites — The Global Healing Map",subtitle:"The world's most powerful water locations and how to access their intelligence from anywhere",siddha:"Agastya Muni",essence:"Every sacred spring is an Akashic download point encoded into the Earth's water body.",mantra:"Om Tirtha Kshetra Neer Namaha",sections:[{heading:"Why Sacred Water Sites Carry Genuine Extraordinary Frequencies",body:`Sacred water sites carry measurable differences in electromagnetic and physical properties created by three factors:
...
AQUIFER DEPTH AND MINERAL MATRIX: Water that has been underground for decades or centuries — passing through specific mineral formations, absorbing trace elements in specific ratios — emerges at a quality that cannot be replicated by any modern purification process. The water at these sites has absorbed this accumulated field.`},{heading:"Ten Primary Sacred Water Sites and Their Frequencies",body:`1. TIRUVANNAMALAI SPRING (Tamil Nadu): Feeds the sacred tank of Arunachaleswar temple at the base of Arunachala — approximately 2.7 billion years old, the oldest rock on Earth's surface. Healing specialty: Sahasrara and Ajna activation, Muladhara grounding at the deepest possible level.
...
HOW TO ACCESS FROM ANYWHERE: Chant the presiding deity's specific mantra over clean water for 21 repetitions. For Arunachaleswar: "Om Arunachala Shivaya Namaha." For Vaitheeswaran: "Om Vaitheeswara Namaha." This invokes the Akashic field associated with that site's consciousness.`}],practice:`THE SACRED WATER PILGRIMAGE JOURNAL
...
JOURNAL: Document the visit in detail — what you noticed, what shifted, what you received. The encounter with living sacred water is never neutral.`},{id:"ai25",tier:"akasha_infinity",icon:"✨",number:"25",title:"Water as Frozen Light — The Deepest Cosmological Secret",subtitle:"What Babaji transmitted about the true nature of water — the prepared can receive this now",siddha:"Mahavatar Babaji",essence:"Water is light that chose to become touchable so that love could have a body.",mantra:"Om Prakasha Neer Namah Shivaya",sections:[{heading:"Light Before Matter — The Sat Yuga Reality",body:`In the Sat Yuga — the age of cosmic truth, the age of maximum light-to-matter ratio — matter was far less dense. What we now call "water" was something quite different: a luminous, fourth-state fluid — not fully material, not fully energetic — that held properties of both. The Siddhas called it "Soma" in its highest form — liquid light, responsive consciousness in fluid form.
...
Every water charging practice in this curriculum is an act of reminding water of what it is. And because you are 70% water, every water practice is also an act of reminding yourself of what you are: light, in a temporary dense form, remembering.`},{heading:"The Four States of Water as Four States of Consciousness",body:`ICE (Solid Water) — JAGRITI (Waking Consciousness): Dense, structured, form-holding. Resistant to change. Ordinary waking consciousness — identified with form, attached to fixed structures.
...
The Kaya Kalpa goal stated in water physics: maximise EZ water throughout the body. The meditative goal stated in consciousness language: stabilise the Turiya state. These are the same goal, described from different angles of the same reality.`},{heading:"Drinking Light — The Ultimate Practice",body:`When all prior understanding is in place — when water is genuinely known as frozen light, when the body is genuinely known as a temporary organisation of cosmic water — a specific practice becomes available. The Siddhas called it "Jyotir Aapah" — "light water."
...
In this recognition, drink.`}],practice:`THE JYOTIR AAPAH DAILY SADHANA (90 days)
...
At 90 days: the perception of water as light will have become your default relationship. You will be in a permanent state of Jyotir Aapah — drinking light with every sip, continuously receiving the Sat Yuga potential of water into a body prepared to receive it.`},{id:"ai26",tier:"akasha_infinity",icon:"∞",number:"26",title:"Babaji's 40-Day Water Initiation",subtitle:"The complete protocol that Babaji gave his direct students — now transmitted here",siddha:"Mahavatar Babaji",essence:"Forty days of conscious water is one complete cellular rebirth. Begin.",mantra:"Om Babaji Charana Neer Namaha",sections:[{heading:"The Context of the 40-Day Initiation",body:`The number 40 appears in virtually every mystical tradition: 40 days of Jesus in the desert, 40-year wilderness wandering of the Israelites, 40-day Chililla in Sufi tradition, 40-day Chilla Nashini in Indian tantric practices. This universality reflects the same biological discovery made independently by multiple traditions: 40 days is the minimum period required for a new energetic pattern to cross from the etheric/subtle body into the physical tissue.

In Siddha physiology, 40 days represents one full cycle through the superficial tissues and the beginning of penetration into the deeper layers. 90 days represents one full cycle through all seven tissues. This is why Babaji's core initiations were 40 days — enough to begin physical cellular change — and continuation practices extended to 90 days or beyond for completion.`},{heading:"The Complete 40-Day Protocol",body:`PREPARATION PHASE (Days -7 to 0):
...
Then: continue. The 40 days is not an ending. It is the first cellular-level installation.`},{heading:"The Documented Arc of the Initiation",body:`DAYS 1–7: Initial resistance. The ego's water-body resists the new routine. Dreams become more vivid. Suppressed emotional content begins to surface.
...
"Begin. The water will show you the rest." — Mahavatar Babaji`},{id:"ai27",tier:"akasha_infinity",icon:"🏔️",number:"27",title:"All 18 Siddhas on Water — The Complete Transmissions",subtitle:"What each master encoded about water — compiled for the first time in one place",siddha:"All 18 Siddhas",essence:"Eighteen faces of the same ocean, each reflecting a different sky.",mantra:"Om Ashta Dasha Siddha Guru Namaha",sections:[{heading:"The Eighteen Direct Transmissions — Part One",body:`AGASTYA MUNI: "Do not call it water. Call it the resting body of the Devas. Approach all water as I approached the ocean — with complete willingness to be transformed by what you consume. The ocean did not diminish Agastya. Agastya became the ocean. This is the deepest secret of Neer Sadhana."
...
After 18 days: which Siddha resonated most profoundly? That master is your primary water lineage connection. Continue working with their transmission specifically in your ongoing practice.`},{id:"ai28",tier:"akasha_infinity",icon:"🌌",number:"28",title:"The Akashic Interface — Accessing Records Through Water",subtitle:"The neuroscience, physics, and Siddha protocol for using water as a portal to cosmic memory",siddha:"Agastya Muni",essence:"The Akasha speaks through water. You have a 70% chance of hearing it with every breath.",mantra:"Om Akasha Neer Praakasha Namaha",sections:[{heading:"The Physics of the Akashic Water Interface",body:`The Akashic Records are not a metaphysical abstraction stored in some distant dimension. The most precise modern physics parallel is the holographic universe model: the information content of the entire universe is encoded on its boundary (the cosmic horizon), and the three-dimensional reality we perceive is a holographic projection of that information.
...
RECORDING: Immediately after, record everything that arose. The translation of subtle Akashic content into conscious memory is fragile and fades quickly. Write it all.`}],practice:`MONTHLY AKASHIC WATER SESSION
...
This review is the calibration practice — learning to distinguish genuine Akashic reception from wishful thinking. Both exist. The practitioner who can make this distinction is already deep in the living transmission.`},{id:"ai29",tier:"akasha_infinity",icon:"🌊",number:"29",title:"Ancestral Water Clearing — Healing the Lineage",subtitle:"You are not only healing yourself. You are clearing the river for all who follow.",siddha:"Agastya Muni",essence:"Every drop of water that passes through you carries the karma of those who came before. Purify it for those who come after.",mantra:"Om Pitru Deva Neer Shuddhi Namaha",sections:[{heading:"The Science of Ancestral Water Inheritance",body:`Epigenetics research has established beyond reasonable scientific doubt that traumatic experiences can alter gene methylation patterns in ways that are inherited by subsequent generations. The Holocaust survivor studies, the Dutch Hunger Winter research, the study of descendants of enslaved Africans — all confirm: psychological and physiological trauma leaves heritable molecular marks in the genome.
...
FOR SPECIFIC INHERITED PATTERNS: Identify the pattern appearing across multiple generations. Perform the Pitru Tarpanam with the specific pattern named and offered to the earth. Continue for 40 days. Ancestral epigenetic clearing requires the same 40-day minimum as any other cellular-level change.`}],practice:`ANCESTRAL WATER LINEAGE HEALING JOURNEY
...
Document: before beginning, describe the pattern in your life today. After 40 days, describe it again. What has shifted? Not as a judgment — as an honest observation of the water body's response to 40 days of targeted ancestral clearing.`},{id:"ai30",tier:"akasha_infinity",icon:"📡",number:"30",title:"Scalar Waves and Water — The 2050 Frontier Science",subtitle:"How SQI transmissions interact with your water body and how to maximise reception",siddha:"Bogar",essence:"Scalar waves are Prana with a physics degree. The Siddhas knew the technology. We are rediscovering the theory.",mantra:"Om Skalar Shakti Neer Namaha",sections:[{heading:"What Are Scalar Waves and Why They Matter for Water",body:`Scalar waves — non-Hertzian electromagnetic waves that propagate through the quantum vacuum rather than conventional electromagnetic spacetime — were first described mathematically by James Clerk Maxwell in the 1860s, then experimentally investigated by Nikola Tesla, who considered them the most important discovery in physics.
...
This converts every SQI audio session into a dual transmission: the consciousness-level Bhakti-Algorithm transmission through the audio, and the physical-level Neer Marundhu transmission through the scalar-charged water.`}],practice:`BUILD YOUR SCALAR WATER ALTAR
...
Over weeks and months, the scalar field of the altar deepens and stabilises — the space itself becomes a living charging field. Your home becomes a temple. The altar is the sanctum. The water is the Theertham.`},{id:"ai31",tier:"akasha_infinity",icon:"🌟",number:"31",title:"Creating With Water — The Manifestation Alchemy",subtitle:"How the Siddhas used water as a direct instrument of creation in the material world",siddha:"Agastya Muni & Mahavatar Babaji",essence:"Consciousness creates through water. You are 70% of the medium. You have always been the creator.",mantra:"Om Sristi Neer Shakti Namaha",sections:[{heading:"The Seven Manifestation Water Practices",body:`PRACTICE 1 — THE SANKALPA WATER (Daily): Write your Sankalpa (deepest soul intention — a state of being, not a goal) on paper. Place beneath your copper vessel overnight. Every morning, drink this water recognising the water has been continuously receiving the electromagnetic field of your written intention. Over 40 consecutive days, this creates cellular-level reorganisation around the Sankalpa pattern.
...
Most commonly reported result: the practitioner's relationship to what they are creating shifts until resistance falls away and the creation appears as the natural next step. This is the Siddha understanding of how manifestation works — not imposing on reality, but becoming coherent enough that reality reorganises around the practitioner's coherent field.`},{id:"ai32",tier:"akasha_infinity",icon:"🕊️",number:"32",title:"Water and Samadhi — The Mystical Neuroscience",subtitle:"The physiological basis of spiritual awakening through water consciousness",siddha:"Thirumoolar",essence:"Samadhi is not the absence of water. It is water achieving perfect stillness.",mantra:"Om Samadhi Neer Shuddham Namaha",sections:[{heading:"The Water Body of Samadhi",body:`Samadhi — the state of non-dual absorption described as the pinnacle of yogic and Siddha development — has a water body. It has a specific physiological signature in the body's fluid systems that both enables and reflects the state.
...
This is the water-physics description of non-duality: a genuine electromagnetic event in which the body's water coherence matches the ambient field coherence of the surrounding environment, and the boundary that creates the experience of separation momentarily collapses.`},{heading:"Building the Samadhi Water Body",body:`Samadhi cannot be manufactured. It can only be enabled — by systematically removing the obstructions that prevent the body-consciousness from naturally returning to its intrinsic non-dual clarity.
...
3. THE ACCUMULATED PRACTICE: The practitioner who has worked with water consciously for 2–3 years develops a water body of such refined coherence that states of meditative absorption arise spontaneously in daily life — while drinking morning water, sitting beside a river, or in the shower.`}],practice:`THE WATER SAMADHI PROTOCOL (Weekly, new moon night)
...
Document what arises. Some practitioners experience nothing notable in the first sessions. Others report their first spontaneous experiences of non-dual awareness. Both are the practice working.`},{id:"ai33",tier:"akasha_infinity",icon:"🌸",number:"33",title:"The Divine Mother as Water — Shakti Alchemy",subtitle:"The deepest feminine teaching in the Siddha tradition — water as the body of the Goddess",siddha:"Agastya Muni",essence:"The ocean does not contain the Divine Mother. The Divine Mother is the ocean, dreaming she is water.",mantra:"Om Aim Hreem Kleem Chamundaye Viche Om Apas Mataye Namaha",sections:[{heading:"Water as the First Body of the Goddess",body:`In every ancient culture on Earth, water is feminine. The ocean, the river, the rain, the well, the spring — in every mythology from every continent, these are governed by feminine divine intelligence. This universality is not cultural coincidence. It is the recognition of a fundamental principle: water is the mother of all form.
...
To drink water with this recognition — that every sip is a communion with the Divine Mother in her first and most accessible body — is to transform the ordinary act of hydration into an act of worship.`},{heading:"The Three Waters of the Goddess & Shakti Water Alchemy Practices",body:`GANGA — THE LIBERATING MOTHER (Mukti Shakti): Carries the Kali frequency — she liberates by dissolving what no longer serves.
...
WOMB WATER (For Women): Warm water infused with rose petals, a pinch of saffron, and optionally a small piece of red coral, consumed on the morning of the first day of the menstrual cycle.`}],practice:`THE DIVINE MOTHER WATER RELATIONSHIP (40 days)
...
At 40 days: notice. How has your relationship with your own body changed? How has your experience of being nourished, held, and supported in life changed? These changes are the signs of the Shakti Alchemy working.`},{id:"ai34",tier:"akasha_infinity",icon:"🔮",number:"34",title:"Jala Trataka — The Water Mirror",subtitle:"The most ancient scrying practice in human history — and the Siddha's precise technology behind it",siddha:"Nandi & Thirumoolar",essence:"Still water does not show your reflection. It shows what you actually are.",mantra:"Om Jala Darpana Siddhi Namaha",sections:[{heading:"The Physics of Jala Trataka",body:`Every culture in recorded history has practised some form of water gazing — looking into still water for information, guidance, and access to expanded states of consciousness. Ancient Egypt, Greece, Rome, Celtic Britain, pre-Columbian Americas, sub-Saharan Africa, Vedic India, Taoist China — the practice appears independently across cultures that had no contact with each other. This universality is the strongest possible evidence of genuine phenomenological validity.
...
3. MIRROR OF THE SUBCONSCIOUS WATER BODY: What appears in the water — images, impressions, feelings — is partly the practitioner's own subconscious water body surfacing into the still reflective medium.`},{heading:"The Complete Jala Trataka Protocol",body:`PREPARATION OF SPACE: Complete quiet. No electronics within 3 metres. Dimmed or eliminated electric lighting. Burning pure frankincense creates an ionised air environment that enhances water's EZ layer.
...
CLOSING: Take 3 breaths. Place both palms over the water vessel, sending gratitude into it. Pour a small amount over your left wrist (closes the practice energetically). Record everything that arose in your dedicated Jala Trataka journal — immediately after, before the content fades.`}],practice:`THE 108-DAY JALA TRATAKA SADHANA
...
At day 108: review the full journal. Find the three most significant transmissions of the entire sadhana. Write a synthesis. You have completed the most ancient form of water practice available to humanity.`},{id:"ai35",tier:"akasha_infinity",icon:"🌅",number:"35",title:"Water and the Planetary Intelligence — Jyotish Water Science",subtitle:"The nine planets and their water frequencies: how to align your water practice with cosmic cycles",siddha:"Agastya Muni",essence:"The planets are not distant — they are continuously pouring their intelligence into Earth's water. Yours included.",mantra:"Om Navagraha Neer Shakti Namaha",sections:[{heading:"The Nine Planets and Their Water Medicines",body:`Vedic astrology (Jyotish) understands the nine classical planets (Navagrahas) as conscious intelligence fields that continuously influence Earth's electromagnetic environment, and through it, the body's water matrix. The Siddhas designed entire water medicine protocols around the planetary day system: each day of the week is governed by a specific planetary intelligence.
...
KETU (South Node): The intelligence of spiritual liberation, non-attachment, the immune system's intelligence at the deepest level, and the water of moksha (liberation). Mantra: "Om Ketave Namaha" — 7 repetitions.`},{heading:"The Jyotish Water Week — Complete Protocol",body:`A complete weekly water practice aligned with the nine planetary intelligences:
...
SATURDAY (Shani): Triphala Neer (Medicine 2) — the most purifying and eliminating water medicine. Chant "Om Shanaishcharaya Namaha" — 23 repetitions. Drink before bed for maximum overnight elimination support.`}],practice:`THE JYOTISH WATER YEAR
...
The Siddhas prescribed Jyotish water protocols for periods of 1, 3, 7, and 12 years — understanding that the full planetary cycle (approximately 12 years for Jupiter) is the minimum meaningful period for complete planetary water healing.`},{id:"ai36",tier:"akasha_infinity",icon:"⚡",number:"36",title:"Water and the Siddhis — The Supernatural Powers",subtitle:"How the Siddhas developed extraordinary capacities through water mastery",siddha:"Konganavar",essence:"The Siddhis are not supernatural. They are the natural powers of a body whose water has remembered what water is.",mantra:"Om Siddhi Neer Shakti Namaha",sections:[{heading:"What Are the Siddhis and Their Water Basis",body:`The Siddhis — the extraordinary powers described in the Yoga Sutras and Siddha texts — include abilities that modern science has no framework to explain: the ability to make the body very large or very small, to move through solid matter, to know the contents of other minds, to achieve perfect health and longevity, to manifest physical objects, and the ultimate Siddhi — liberation from the cycle of birth and death.
...
These two signs are more reliable indicators of genuine progress than any dramatic capacity that might arise.`}],practice:`THE SIDDHA HUMILITY PRACTICE
...
This practice, maintained consistently, prevents the inflation that can accompany genuine development and keeps the practitioner in the clean relationship with water that allows the deepest levels to continue opening.`},{id:"ai37",tier:"akasha_infinity",icon:"🌺",number:"37",title:"Advanced Kaya Kalpa — The Immortality Water Protocols",subtitle:"The complete cellular renewal system that the Siddhas used to transcend biological limitation",siddha:"Konganavar & Agastya Muni",essence:"The body that knows its own water knows how to renew itself without limit.",mantra:"Om Amrita Kaya Kalpa Siddhaye Namaha",sections:[{heading:"The Five Advanced Kaya Kalpa Water Protocols",body:`PROTOCOL 1 — THE SOMA PREPARATION (Monthly Full Moon): The most sacred water preparation in the advanced Kaya Kalpa system.
...
Begin.`},{id:"ai38",tier:"akasha_infinity",icon:"🔔",number:"38",title:"Water and the Nada — Advanced Sound Healing With Water",subtitle:"The most advanced sound-water healing practices from the Siddha Nada Vidya tradition",siddha:"Thirumoolar",essence:"The universe was spoken into existence. Water is the word made liquid.",mantra:"Om Nada Brahma Amrita Neer Namaha",sections:[{heading:"Nada Vidya — The Siddha Science of Sound & Its Water Basis",body:`Nada Vidya — the science of sound — is one of the six primary branches of Siddha knowledge. The Siddhas understood sound not as vibration in air but as the primordial creative force — the first movement of consciousness from stillness into form.
...
ADVANCED VOCAL WATER CHARGING: Hold your prepared water vessel close to your chest (not your mouth) while chanting. The resonance of your chest cavity — which directly reflects into the water's EZ layer — charges the water more completely than chanting directed at the water from above.`}],practice:`THE COMPLETE NADA-NEER MORNING RITUAL (40–60 minutes)
...
This single practice, done consistently for 40 days, produces the deepest water-sound healing effects available outside of an intensive residential retreat with a Siddha Nada Yoga master.`},{id:"ai39",tier:"akasha_infinity",icon:"🌊",number:"39",title:"The Great Water Teachings — Integration and the Living Path",subtitle:"Synthesising the entire curriculum into a living, breathing daily relationship with water",siddha:"All 18 Siddhas",essence:"The curriculum is not the practice. The practice is what happens after the curriculum is forgotten.",mantra:"Om Neer Sadhana Sampurna Namaha",sections:[{heading:"The Irreducible Core — Five Things",body:`After 40 modules and 6,000 years of Siddha water wisdom, the irreducible core is five things. If you do nothing else from this curriculum, do these five:
...
These five things, done consistently for a lifetime, produce 80% of the results of the entire curriculum.`},{heading:"The Living Path — Water Practice Across the Life Span",body:`YOUTH (up to age 30): The primary practices are those of building — Tamra Jal, sound-charged water, pranayama-water integration, and the establishment of healthy water timing habits. The foundations being built in youth will carry the entire lifespan.
...
Write this down. Date it. Review it in 3 months. Adjust what is not working. Maintain what is. The curriculum is now yours. The practice is now yours. The water is waiting.`},{id:"ai40",tier:"akasha_infinity",icon:"🕊️",number:"40",title:"The Water Initiation Ceremony — Completing the Circle",subtitle:"The full ceremony that closes one cycle and opens the next — for yourself and for all you serve",siddha:"All 18 Siddhas & Mahavatar Babaji",essence:"You began as water. You will return as water. In between, you have the opportunity to know yourself as what you always were.",mantra:"Om Tat Sat — Om Namah Shivaya — Om Neer Amritaya Namaha",sections:[{heading:"The Complete Water Initiation Ceremony",body:`PREPARATION (Three days before): Three-day sattvic fast from all meat, alcohol, caffeine, and processed food. Increase water intake. Practise silence for at least two hours each day. On the evening before the ceremony, perform the full Theertham creation ritual with the specific intention: "May this water serve the completion of one cycle and the opening of the next."
...
THE COMMITMENT: Speak or write your commitment to water as a lifelong relationship. Not a programme to complete. A relationship. What does that relationship ask of you? What will you give to it? Speak this aloud.`},{heading:"The Final Transmission — Agastya Muni's Closing Teaching",body:`Speak these words — the final teaching of Agastya Muni:
...
The water has always been waiting.`}],practice:`THE FINAL PRACTICE — NO TECHNIQUE
...
Om Neer Amritaya Namaha.`}];function X(){const s=x(),{tier:S}=W(),{isAdmin:N}=P(),c=N?3:H(S)??0,I=c>=3?"akasha_infinity":c>=2?"siddha_quantum":c>=1?"prana_flow":"free",[o,y]=l.useState(""),[d,R]=l.useState("all"),[k,O]=l.useState(null),[m,g]=l.useState(null),p=A(I||"free"),f=U.filter(t=>{const i=o.trim()===""||t.title.toLowerCase().includes(o.toLowerCase())||t.siddha.toLowerCase().includes(o.toLowerCase())||t.number.includes(o),r=d==="all"||t.tier===d;return i&&r}),C=t=>A(t.tier)>p,w="rgba(255,255,255,0.02)",b="1px solid rgba(255,255,255,0.05)";return e.jsxs("div",{style:{minHeight:"100vh",background:"#050505",color:"rgba(255,255,255,0.88)",fontFamily:"'Plus Jakarta Sans',sans-serif",padding:"0 0 80px 0"},children:[e.jsxs("div",{style:{position:"relative",textAlign:"center",padding:"80px 24px 60px",background:"radial-gradient(ellipse at 50% 0%, rgba(212,175,55,0.10) 0%, transparent 70%)"},children:[e.jsx("button",{onClick:()=>s("/siddha-portal"),style:{position:"absolute",top:20,left:20,background:"none",border:"none",cursor:"pointer",fontFamily:"'Plus Jakarta Sans',sans-serif",fontSize:10,fontWeight:800,letterSpacing:"0.4em",textTransform:"uppercase",color:"rgba(212,175,55,0.45)",padding:0},children:"← SIDDHA PORTAL"}),e.jsx("div",{style:{fontSize:64,marginBottom:16},children:"💧"}),e.jsx("div",{style:{fontSize:9,letterSpacing:"0.5em",textTransform:"uppercase",color:u,fontWeight:800,marginBottom:20},children:"SIDDHA QUANTUM NEXUS • SACRED HEALING EDUCATION"}),e.jsx("h1",{style:{fontSize:"clamp(32px,6vw,72px)",fontWeight:900,letterSpacing:"-0.05em",color:"#fff",margin:"0 0 16px",lineHeight:1.1},children:"Siddha Water Alchemy"}),e.jsx("p",{style:{fontSize:18,color:"rgba(255,255,255,0.55)",maxWidth:600,margin:"0 auto 32px",lineHeight:1.7,fontWeight:400},children:"40 modules of living water wisdom from the 18 Tamil Siddha masters and Mahavatar Babaji. The most complete Siddha water education ever assembled — from ancient cosmology to 2050 frontier science."}),e.jsx("div",{style:{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap",marginBottom:8},children:["all","free","prana_flow","siddha_quantum","akasha_infinity"].map(t=>{const i=t==="all"?{label:"ALL 40 MODULES",color:"rgba(255,255,255,0.55)"}:E[t],r=d===t;return e.jsx("button",{onClick:()=>R(t),style:{padding:"8px 18px",borderRadius:40,border:"1px solid",borderColor:r?i.color:"rgba(255,255,255,0.1)",background:r?`${i.color}22`:"transparent",color:r?i.color:"rgba(255,255,255,0.45)",fontSize:9,letterSpacing:"0.4em",textTransform:"uppercase",fontWeight:800,cursor:"pointer",transition:"all 0.2s"},children:i.label},t)})})]}),e.jsx("div",{style:{maxWidth:720,margin:"0 auto 40px",padding:"0 24px"},children:e.jsxs("div",{style:{position:"relative"},children:[e.jsx(L,{size:16,style:{position:"absolute",left:16,top:"50%",transform:"translateY(-50%)",color:"rgba(255,255,255,0.3)"}}),e.jsx("input",{value:o,onChange:t=>y(t.target.value),placeholder:"Search modules, Siddhas, or topics…",style:{width:"100%",padding:"14px 16px 14px 44px",background:w,border:b,borderRadius:16,color:"rgba(255,255,255,0.88)",fontSize:15,outline:"none",boxSizing:"border-box"}}),o&&e.jsx("button",{onClick:()=>y(""),style:{position:"absolute",right:16,top:"50%",transform:"translateY(-50%)",background:"none",border:"none",cursor:"pointer",color:"rgba(255,255,255,0.3)"},children:"✕"})]})}),e.jsxs("div",{style:{maxWidth:860,margin:"0 auto",padding:"0 24px",display:"flex",flexDirection:"column",gap:16},children:[f.map(t=>{const i=C(t),r=k===t.id,a=E[t.tier];return e.jsxs("div",{style:{background:w,border:b,borderRadius:40,overflow:"hidden",boxShadow:r?`0 0 40px ${a.color}18`:"none",transition:"box-shadow 0.4s"},children:[e.jsxs("button",{onClick:()=>{if(i){s("/prana-flow");return}O(r?null:t.id),g(null)},style:{width:"100%",padding:"28px 32px",background:"none",border:"none",cursor:"pointer",textAlign:"left",display:"flex",alignItems:"center",gap:20},children:[e.jsx("div",{style:{fontSize:36,flexShrink:0},children:t.icon}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap",marginBottom:8},children:[e.jsx("span",{style:{fontSize:9,letterSpacing:"0.4em",textTransform:"uppercase",fontWeight:800,color:a.color},children:a.label}),e.jsxs("span",{style:{fontSize:9,letterSpacing:"0.4em",textTransform:"uppercase",fontWeight:800,color:"rgba(255,255,255,0.25)"},children:["MODULE ",t.number]})]}),e.jsx("div",{style:{fontSize:"clamp(17px,2.5vw,22px)",fontWeight:900,letterSpacing:"-0.03em",color:"#fff",lineHeight:1.2,marginBottom:6},children:t.title}),e.jsx("div",{style:{fontSize:13,color:"rgba(255,255,255,0.45)",fontWeight:400,lineHeight:1.5},children:t.subtitle}),e.jsxs("div",{style:{marginTop:8,fontSize:11,color:"rgba(255,255,255,0.3)"},children:["Transmitted by ",e.jsx("span",{style:{color:a.color,fontWeight:700},children:t.siddha})]})]}),e.jsx("div",{style:{flexShrink:0},children:i?e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:6,padding:"12px 16px",background:`${a.color}11`,borderRadius:16,border:`1px solid ${a.color}33`},children:[e.jsx(Y,{size:16,color:a.color}),e.jsx("span",{style:{fontSize:8,letterSpacing:"0.3em",textTransform:"uppercase",color:a.color,fontWeight:800},children:a.price})]}):e.jsx("div",{style:{color:a.color},children:r?e.jsx(v,{size:20}):e.jsx(T,{size:20})})})]}),r&&!i&&e.jsxs("div",{style:{padding:"0 32px 32px"},children:[e.jsxs("div",{style:{padding:"20px 24px",marginBottom:24,background:`${a.color}08`,borderRadius:20,borderLeft:`3px solid ${a.color}`},children:[e.jsx("div",{style:{fontSize:8,letterSpacing:"0.5em",textTransform:"uppercase",color:a.color,fontWeight:800,marginBottom:8},children:"ESSENCE"}),e.jsxs("p",{style:{fontSize:16,color:"rgba(255,255,255,0.8)",fontStyle:"italic",lineHeight:1.6,margin:0},children:['"',t.essence,'"']}),t.mantra&&e.jsxs("div",{style:{marginTop:12,fontSize:13,color:a.color,fontWeight:700},children:["🕉 ",t.mantra]})]}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8,marginBottom:24},children:t.sections.map((h,n)=>e.jsxs("div",{style:{background:"rgba(255,255,255,0.02)",borderRadius:20,border:"1px solid rgba(255,255,255,0.04)",overflow:"hidden"},children:[e.jsxs("button",{onClick:()=>g(m===n?null:n),style:{width:"100%",padding:"18px 24px",background:"none",border:"none",cursor:"pointer",textAlign:"left",display:"flex",alignItems:"center",justifyContent:"space-between",gap:16},children:[e.jsx("span",{style:{fontSize:14,fontWeight:700,color:"rgba(255,255,255,0.85)",lineHeight:1.3},children:h.heading}),e.jsx("span",{style:{color:"rgba(255,255,255,0.3)",flexShrink:0},children:m===n?e.jsx(v,{size:16}):e.jsx(T,{size:16})})]}),m===n&&e.jsx("div",{style:{padding:"0 24px 20px"},children:h.body.split(`

`).map((D,M)=>e.jsx("p",{style:{fontSize:14,lineHeight:1.8,color:"rgba(255,255,255,0.65)",marginBottom:14,margin:0},children:D},M))})]},n))}),e.jsxs("div",{style:{padding:"24px",borderRadius:24,background:`${a.color}06`,border:`1px solid ${a.color}22`},children:[e.jsx("div",{style:{fontSize:8,letterSpacing:"0.5em",textTransform:"uppercase",color:a.color,fontWeight:800,marginBottom:14},children:"LIVING PRACTICE"}),t.practice.split(`

`).map((h,n)=>e.jsx("p",{style:{fontSize:14,lineHeight:1.8,color:"rgba(255,255,255,0.65)",marginBottom:12,margin:0},children:h},n))]})]})]},t.id)}),f.length===0&&e.jsxs("div",{style:{textAlign:"center",padding:"60px 0",color:"rgba(255,255,255,0.3)"},children:[e.jsx("div",{style:{fontSize:40,marginBottom:16},children:"💧"}),e.jsx("p",{style:{fontSize:16},children:"No modules match your search. Try different terms."})]})]}),p<3&&e.jsx("div",{style:{maxWidth:860,margin:"48px auto 0",padding:"0 24px"},children:e.jsxs("div",{style:{padding:"40px",borderRadius:40,textAlign:"center",background:"linear-gradient(135deg, rgba(212,175,55,0.08) 0%, rgba(180,132,204,0.08) 100%)",border:"1px solid rgba(212,175,55,0.2)"},children:[e.jsx("div",{style:{fontSize:40,marginBottom:16},children:"🌊"}),e.jsx("h3",{style:{fontSize:28,fontWeight:900,letterSpacing:"-0.04em",color:"#fff",marginBottom:12},children:"Unlock All 40 Modules"}),e.jsx("p",{style:{fontSize:15,color:"rgba(255,255,255,0.55)",maxWidth:480,margin:"0 auto 28px",lineHeight:1.7},children:"The complete Siddha Water Alchemy curriculum — from the Free foundations to the Akasha-Infinity immortality protocols — awaits your commitment."}),e.jsx("button",{onClick:()=>s("/prana-flow"),style:{padding:"16px 40px",borderRadius:40,background:`linear-gradient(135deg, ${u}, #c9a227)`,border:"none",color:"#050505",fontSize:14,fontWeight:800,letterSpacing:"0.1em",textTransform:"uppercase",cursor:"pointer"},children:"View Membership Tiers"})]})})]})}export{X as default};
