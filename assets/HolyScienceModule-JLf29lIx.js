import{R as A,j as e,q as z,g as V,r as j}from"./vendor-react--OR-uH7S.js";import{u as R,a as J,h as I,g as x,b as L}from"./index-RRXEvQfm.js";import{u as G}from"./useAdminRole-CCeebBaS.js";import{u as U}from"./useHolyScienceProgress-U3k-qNPa.js";import{u as O,M as $}from"./useSectionProgress-DAFvPfUS.js";import{f as _,v as Q}from"./tokens-DuZPxu2i.js";import{C as D,i as X,s as Z}from"./vendor-icons-CZmAPI07.js";import"./vendor-crypto-DfHPQj82.js";import"./vendor-radix-7CUZPdy3.js";import"./vendor-i18n-BS5B6gzd.js";import"./vendor-query-D1GokQmc.js";import"./vendor-supabase-DRj4EguU.js";import"./vendor-motion-Dm4zQNot.js";import"./describeError-BoR2s31v.js";const ee=[{id:1,number:"01",tier:"free",title:"Introduction to The Holy Science",subtitle:"Who Was Sri Yukteshwar & Why This Book Matters in 2026",transmissionType:"Akasha-Intro",totalDuration:"42 min",lessons:[{id:"1-1",tier:"free",duration:"14 min",title:"Sri Yukteshwar — Life of a Cosmic Mathematician",content:`Sri Yukteshwar Giri (1855–1936) is among the most misunderstood masters of modern India — not because he was obscure, but because his teaching was so precise and technically demanding that most spiritual literature softens it into something far less potent than what he actually left behind.
...
In 2026, in the accelerating energy of ascending Dwapara Yuga, with cosmic timing supporting rapid evolution, with the technology of sound and transmission available through SQI — there is no reason to delay. The ladder has been placed. The only question remaining is whether the student will climb.`,revelation:'Sri Yukteshwar speaks the final transmission of this curriculum: "The book has served its purpose when the student no longer needs it — because they have become what it described. Until then, return to it. The Holy Science is not a document about spiritual life. It is a tuning fork. Each reading, at a higher level of your own development, activates a higher harmonic of the transmission. The text has not changed. You have. And in that change, you will find the text has infinite depth."'}]}],p="#A78BFA",B={fontSize:21,lineHeight:1.8,color:"rgba(255,250,240,0.86)",fontFamily:"'Cormorant Garamond',serif",maxWidth:"68ch",whiteSpace:"pre-line"};function ae(g){return g.split(/(\*\*[^*]+\*\*)/g).map((i,l)=>i.startsWith("**")&&i.endsWith("**")?e.jsx("strong",{style:{color:"rgba(255,255,255,0.98)",fontWeight:700},children:i.slice(2,-2)},l):e.jsx(A.Fragment,{children:i},l))}const te=({moduleKey:g,dbModuleId:v})=>{const i=ee.find(h=>`m${h.id}`===g),[l,u]=A.useState(0),{rows:Y,toggleSectionComplete:M,setSectionNotes:k}=O(v,"user_holy_science_section_progress"),[T,m]=A.useState({});return i?e.jsx("div",{children:i.lessons.map((h,o)=>{const s=h.id,t=l===o,a=Y[s],n=a?.completed??!1,S=a?.notes??"",c=T[s]??"idle";return e.jsxs("div",{style:{marginBottom:10,borderRadius:20,overflow:"hidden",border:`1px solid ${t?"rgba(167,139,250,0.35)":n?"rgba(167,139,250,0.2)":"rgba(255,255,255,0.06)"}`,background:t?"rgba(167,139,250,0.04)":"rgba(255,255,255,0.012)"},children:[e.jsxs("button",{type:"button",onClick:()=>u(t?-1:o),style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",textAlign:"left",padding:"16px 20px",cursor:"pointer",background:"none",border:"none"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,minWidth:0},children:[e.jsx("span",{style:{width:26,height:26,borderRadius:"50%",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:800,border:`1.5px solid ${n||t?p:"rgba(255,255,255,0.15)"}`,background:n?"rgba(167,139,250,0.22)":t?"rgba(167,139,250,0.14)":"transparent",color:n||t?p:"rgba(255,255,255,0.4)"},children:n?e.jsx(D,{size:13}):o+1}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("div",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.1rem",fontWeight:700,color:t?p:"rgba(255,255,255,0.85)"},children:h.title}),e.jsx("div",{style:{fontSize:10,color:"rgba(255,255,255,0.35)",marginTop:2},children:h.duration})]})]}),e.jsx(X,{size:16,style:{flexShrink:0,color:t?p:"rgba(255,255,255,0.3)",transform:t?"rotate(180deg)":"none",transition:"transform .2s"}})]}),t&&e.jsxs("div",{style:{padding:"0 20px 24px"},children:[e.jsx("p",{style:{...B,marginBottom:h.revelation?18:0},children:ae(h.content)}),h.revelation&&e.jsxs("div",{style:{background:"rgba(212,175,55,0.05)",border:"1px solid rgba(212,175,55,0.18)",borderRadius:18,padding:"18px 20px"},children:[e.jsx("div",{style:{fontSize:8,fontWeight:800,letterSpacing:".3em",textTransform:"uppercase",color:"#D4AF37",marginBottom:10},children:"Akasha-Archive Transmission"}),e.jsx("p",{style:{fontSize:17,lineHeight:1.75,color:"rgba(255,255,255,0.85)",fontFamily:"'Cormorant Garamond',serif",margin:0,fontStyle:"italic"},children:h.revelation})]}),e.jsxs("div",{style:{marginTop:24,paddingTop:18,borderTop:"1px solid rgba(255,255,255,0.06)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8},children:[e.jsx("span",{style:{fontSize:9,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Notes"}),c==="saving"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Saving…"}),c==="saved"&&e.jsxs("span",{style:{fontSize:9,textTransform:"uppercase",color:p,display:"flex",alignItems:"center",gap:4},children:[e.jsx(D,{size:10})," Saved"]}),c==="error"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"#F87171"},children:"Could not save"})]}),e.jsx("textarea",{value:S,onChange:C=>{const P=C.target.value;m(f=>({...f,[s]:"saving"})),k(s,P,f=>m(b=>({...b,[s]:f?"saved":"error"})))},rows:3,placeholder:"Your reflections...",style:{width:"100%",resize:"vertical",borderRadius:14,border:"1px solid rgba(255,255,255,.1)",background:"rgba(5,5,5,.6)",padding:"10px 12px",fontSize:14.5,color:"rgba(255,255,255,.85)",fontFamily:"'Plus Jakarta Sans',sans-serif"}})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:18,flexWrap:"wrap",gap:10},children:[e.jsxs("button",{type:"button",onClick:()=>void M(s),style:{display:"inline-flex",alignItems:"center",gap:6,background:n?"rgba(167,139,250,0.14)":"rgba(255,255,255,0.04)",border:`1px solid ${n?"rgba(167,139,250,0.4)":"rgba(255,255,255,0.12)"}`,color:n?p:"rgba(255,255,255,0.6)",padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:800,letterSpacing:".1em",textTransform:"uppercase",cursor:"pointer"},children:[e.jsx(D,{size:13})," ",n?"Completed":"Mark Complete"]}),e.jsx("button",{type:"button",disabled:o===i.lessons.length-1,onClick:()=>u(Math.min(i.lessons.length-1,o+1)),style:{background:o===i.lessons.length-1?"transparent":"rgba(167,139,250,0.14)",border:`1px solid ${o===i.lessons.length-1?"rgba(255,255,255,0.1)":"rgba(167,139,250,0.4)"}`,color:o===i.lessons.length-1?"rgba(255,255,255,0.25)":p,padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:700,cursor:o===i.lessons.length-1?"default":"pointer"},children:o===i.lessons.length-1?"Last lesson":"Next lesson →"})]})]})]},s)})}):e.jsx("p",{style:B,children:"This module's content is being prepared."})};function fe(){const{id:g}=z(),v=V(),{user:i}=R(),{isAdmin:l}=G(),{tier:u,loading:Y,settled:M}=J(),k=!Y&&M,{courses:T,progressByModuleId:m,markComplete:h,touchAccessed:o,stats:s}=U(k),t=j.useMemo(()=>[...T].sort((y,w)=>y.module_number-w.module_number),[T]),a=j.useMemo(()=>t.find(y=>y.id===g),[t,g]);A.useEffect(()=>{a?.id&&i?.id&&o(a.id)},[a?.id,i?.id]);const n=a?t.findIndex(y=>y.id===a.id):-1,S=n>0?t[n-1]:null,c=n>=0&&n<t.length-1?t[n+1]:null,C=c?I(l,u,x(c.tier_required)):!1,P=j.useMemo(()=>[{slug:"free",label:"Atma-Seed"},{slug:"prana-flow",label:"Prana-Flow"},{slug:"siddha-quantum",label:"Siddha-Quantum"},{slug:"akasha-infinity",label:"Akasha-Infinity"}].map(w=>{const d=t.filter(r=>(r.tier_required||"free")===w.slug),K=d.filter(r=>m[r.id]?.completed).length,W=a?d.some(r=>r.id===a.id):!1;return{id:`tier-${w.slug}`,title:w.label,meta:`${K} / ${d.length} modules${K===d.length&&d.length>0?" complete":""}`,done:d.length>0&&K===d.length,current:W,items:d.map(r=>{const H=!!m[r.id]?.completed,q=a?r.id===a.id:!1,F=I(l,u,x(r.tier_required)),N=H?"done":q?"current":F?"available":"locked";return{id:r.id,number:r.module_number,title:r.title,state:N,href:`/holy-science/module/${r.id}`}})}}),[t,m,a,l,u]);if(!k||!a)return e.jsx("div",{style:{minHeight:"100vh",background:"#050505",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("div",{style:{width:36,height:36,borderRadius:"50%",border:"2px solid rgba(167,139,250,.2)",borderTopColor:"#A78BFA",animation:"spin 0.8s linear infinite"}})});const f=I(l,u,x(a.tier_required)),b=Q(.9),E=L(x(a.tier_required));return e.jsx($,{accent:b,academyName:"Holy Science Curriculum",academyHref:"/holy-science",courseTitle:"Kaivalya Darsanam Decoded",courseIcon:e.jsx(Z,{size:24}),moduleNumber:a.module_number,totalModules:s.totalModules,moduleTitle:a.title,thesis:a.subtitle||void 0,progressLabel:`${s.completedModules} / ${s.totalModules} · ${s.completionPercent}%`,progressPercent:s.completionPercent,railGroups:P,contentBlocks:[],locked:!f,lockedCta:e.jsx("button",{type:"button",onClick:()=>v(E),style:{borderRadius:999,padding:"13px 26px",background:`linear-gradient(135deg, ${b}, ${_(b,.7)})`,border:"none",color:"#050505",fontSize:10,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",cursor:"pointer"},children:"Unlock This Module"}),onMarkComplete:()=>void h(a.id),isComplete:!!m[a.id]?.completed,prevHref:S?`/holy-science/module/${S.id}`:null,nextHref:c&&C?`/holy-science/module/${c.id}`:null,footerExtra:i?.id?e.jsx(te,{moduleKey:a.module_key,dbModuleId:a.id}):null})}export{fe as default};
