import{R as O,j as e,q as V,g as j,r as N}from"./vendor-react--OR-uH7S.js";import{u as F,a as z,h as M,g as A,b as U}from"./index-RRXEvQfm.js";import{u as W}from"./useAdminRole-CCeebBaS.js";import{u as K}from"./useSacredGeometryProgress-DRhimnBx.js";import{u as J,M as _}from"./useSectionProgress-DAFvPfUS.js";import{f as $,g as Q}from"./tokens-DuZPxu2i.js";import{C as x,i as Z,ap as X}from"./vendor-icons-CZmAPI07.js";import"./vendor-crypto-DfHPQj82.js";import"./vendor-radix-7CUZPdy3.js";import"./vendor-i18n-BS5B6gzd.js";import"./vendor-query-D1GokQmc.js";import"./vendor-supabase-DRj4EguU.js";import"./vendor-motion-Dm4zQNot.js";import"./describeError-BoR2s31v.js";const ee=[{id:"language-of-creation",number:1,title:"The Language of Creation",subtitle:"Sacred Geometry Foundations",tier:"free",icon:"◈",description:"Before the first sound vibrated into form, there was Pattern. Sacred Geometry is the Akashic Source Code through which Infinite Intelligence expresses itself into manifest reality.",lessons:[{id:"f1-1",title:"What Sacred Geometry Really Is — Beyond the Symbol",duration:"18 min",content:`Sacred Geometry is not an art form or mathematical curiosity — it is the literal Source Code of Reality. Every atom, every cell, every galaxy, every thought-form follows precise geometric laws the 18 Tamil Siddhas called "Brahma-Rekha" — the Lines of the Creator.
...
CONSECRATION ACTIVATION — PRANA PRATISHTHA FOR BUILDINGS: After construction, the building must be consecrated as a living being through Vaastu Shanti (space peace ritual) and Griha Pravesh (first entry ritual). Without this, a building is a shell — beautiful geometry but not activated. With proper consecration, the building becomes a living yantra that serves its inhabitants' evolution for as long as it stands. Ancient temples have maintained their scalar charge through continuous consecration for over 2,000 years — they have become inexhaustible scalar potential reservoirs available to all who enter with an open heart.`}]}],m="#D4AF37",P={fontSize:21,lineHeight:1.8,color:"rgba(255,250,240,0.86)",fontFamily:"'Cormorant Garamond',serif",maxWidth:"68ch",whiteSpace:"pre-line"},te=({moduleKey:b,dbModuleId:E})=>{const n=ee.find(h=>h.id===b),[g,d]=O.useState(0),{rows:I,toggleSectionComplete:k,setSectionNotes:w}=J(E,"user_sacred_geometry_section_progress"),[v,u]=O.useState({});return n?e.jsx("div",{children:n.lessons.map((h,s)=>{const r=h.id,a=g===s,t=I[r],i=t?.completed??!1,S=t?.notes??"",l=v[r]??"idle";return e.jsxs("div",{style:{marginBottom:10,borderRadius:20,overflow:"hidden",border:`1px solid ${a?"rgba(212,175,55,0.35)":i?"rgba(212,175,55,0.2)":"rgba(255,255,255,0.06)"}`,background:a?"rgba(212,175,55,0.04)":"rgba(255,255,255,0.012)"},children:[e.jsxs("button",{type:"button",onClick:()=>d(a?-1:s),style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",textAlign:"left",padding:"16px 20px",cursor:"pointer",background:"none",border:"none"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,minWidth:0},children:[e.jsx("span",{style:{width:26,height:26,borderRadius:"50%",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:800,border:`1.5px solid ${i||a?m:"rgba(255,255,255,0.15)"}`,background:i?"rgba(212,175,55,0.22)":a?"rgba(212,175,55,0.14)":"transparent",color:i||a?m:"rgba(255,255,255,0.4)"},children:i?e.jsx(x,{size:13}):s+1}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("div",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.1rem",fontWeight:700,color:a?m:"rgba(255,255,255,0.85)"},children:h.title}),e.jsx("div",{style:{fontSize:10,color:"rgba(255,255,255,0.35)",marginTop:2},children:h.duration})]})]}),e.jsx(Z,{size:16,style:{flexShrink:0,color:a?m:"rgba(255,255,255,0.3)",transform:a?"rotate(180deg)":"none",transition:"transform .2s"}})]}),a&&e.jsxs("div",{style:{padding:"0 20px 24px"},children:[e.jsx("p",{style:P,children:h.content}),e.jsxs("div",{style:{marginTop:24,paddingTop:18,borderTop:"1px solid rgba(255,255,255,0.06)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8},children:[e.jsx("span",{style:{fontSize:9,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Notes"}),l==="saving"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Saving…"}),l==="saved"&&e.jsxs("span",{style:{fontSize:9,textTransform:"uppercase",color:m,display:"flex",alignItems:"center",gap:4},children:[e.jsx(x,{size:10})," Saved"]}),l==="error"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"#F87171"},children:"Could not save"})]}),e.jsx("textarea",{value:S,onChange:R=>{const C=R.target.value;u(f=>({...f,[r]:"saving"})),w(r,C,f=>u(y=>({...y,[r]:f?"saved":"error"})))},rows:3,placeholder:"Your reflections...",style:{width:"100%",resize:"vertical",borderRadius:14,border:"1px solid rgba(255,255,255,.1)",background:"rgba(5,5,5,.6)",padding:"10px 12px",fontSize:14.5,color:"rgba(255,255,255,.85)",fontFamily:"'Plus Jakarta Sans',sans-serif"}})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:18,flexWrap:"wrap",gap:10},children:[e.jsxs("button",{type:"button",onClick:()=>void k(r),style:{display:"inline-flex",alignItems:"center",gap:6,background:i?"rgba(212,175,55,0.14)":"rgba(255,255,255,0.04)",border:`1px solid ${i?"rgba(212,175,55,0.4)":"rgba(255,255,255,0.12)"}`,color:i?m:"rgba(255,255,255,0.6)",padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:800,letterSpacing:".1em",textTransform:"uppercase",cursor:"pointer"},children:[e.jsx(x,{size:13})," ",i?"Completed":"Mark Complete"]}),e.jsx("button",{type:"button",disabled:s===n.lessons.length-1,onClick:()=>d(Math.min(n.lessons.length-1,s+1)),style:{background:s===n.lessons.length-1?"transparent":"rgba(212,175,55,0.14)",border:`1px solid ${s===n.lessons.length-1?"rgba(255,255,255,0.1)":"rgba(212,175,55,0.4)"}`,color:s===n.lessons.length-1?"rgba(255,255,255,0.25)":m,padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:700,cursor:s===n.lessons.length-1?"default":"pointer"},children:s===n.lessons.length-1?"Last lesson":"Next lesson →"})]})]})]},r)})}):e.jsx("p",{style:P,children:"This module's content is being prepared."})};function fe(){const{id:b}=V(),E=j(),{user:n}=F(),{isAdmin:g}=W(),{tier:d,loading:I,settled:k}=z(),w=!I&&k,{courses:v,progressByModuleId:u,markComplete:h,touchAccessed:s,stats:r}=K(w),a=N.useMemo(()=>[...v].sort((p,T)=>p.module_number-T.module_number),[v]),t=N.useMemo(()=>a.find(p=>p.id===b),[a,b]);O.useEffect(()=>{t?.id&&n?.id&&s(t.id)},[t?.id,n?.id]);const i=t?a.findIndex(p=>p.id===t.id):-1,S=i>0?a[i-1]:null,l=i>=0&&i<a.length-1?a[i+1]:null,R=l?M(g,d,A(l.tier_required)):!1,C=N.useMemo(()=>[{slug:"free",label:"Atma-Seed"},{slug:"prana-flow",label:"Prana-Flow"},{slug:"siddha-quantum",label:"Siddha-Quantum"},{slug:"akasha-infinity",label:"Akasha-Infinity"}].map(T=>{const c=a.filter(o=>(o.tier_required||"free")===T.slug),H=c.filter(o=>u[o.id]?.completed).length,D=t?c.some(o=>o.id===t.id):!1;return{id:`tier-${T.slug}`,title:T.label,meta:`${H} / ${c.length} modules${H===c.length&&c.length>0?" complete":""}`,done:c.length>0&&H===c.length,current:D,items:c.map(o=>{const G=!!u[o.id]?.completed,B=t?o.id===t.id:!1,Y=M(g,d,A(o.tier_required)),q=G?"done":B?"current":Y?"available":"locked";return{id:o.id,number:o.module_number,title:o.title,state:q,href:`/sacred-geometry/module/${o.id}`}})}}),[a,u,t,g,d]);if(!w||!t)return e.jsx("div",{style:{minHeight:"100vh",background:"#050505",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("div",{style:{width:36,height:36,borderRadius:"50%",border:"2px solid rgba(212,175,55,.2)",borderTopColor:"#D4AF37",animation:"spin 0.8s linear infinite"}})});const f=M(g,d,A(t.tier_required)),y=Q(.9),L=U(A(t.tier_required));return e.jsx(_,{accent:y,academyName:"Sacred Geometry Education",academyHref:"/sacred-geometry",courseTitle:"The Language of Creation",courseIcon:e.jsx(X,{size:24}),moduleNumber:t.module_number,totalModules:r.totalModules,moduleTitle:t.title,thesis:t.subtitle||void 0,progressLabel:`${r.completedModules} / ${r.totalModules} · ${r.completionPercent}%`,progressPercent:r.completionPercent,railGroups:C,contentBlocks:[],locked:!f,lockedCta:e.jsx("button",{type:"button",onClick:()=>E(L),style:{borderRadius:999,padding:"13px 26px",background:`linear-gradient(135deg, ${y}, ${$(y,.7)})`,border:"none",color:"#050505",fontSize:10,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",cursor:"pointer"},children:"Unlock This Module"}),onMarkComplete:()=>void h(t.id),isComplete:!!u[t.id]?.completed,prevHref:S?`/sacred-geometry/module/${S.id}`:null,nextHref:l&&R?`/sacred-geometry/module/${l.id}`:null,footerExtra:n?.id?e.jsx(te,{moduleKey:t.module_key,dbModuleId:t.id}):null})}export{fe as default};
