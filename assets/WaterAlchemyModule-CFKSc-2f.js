...
Om Neer Amritaya Namaha.`}],s="#22D3EE",W={fontSize:16,lineHeight:1.75,color:"rgba(255,255,255,0.8)",fontFamily:"'Cormorant Garamond',serif",whiteSpace:"pre-line"},ee=({moduleKey:b,dbModuleId:S})=>{const h=X.find(r=>r.id===b),[y,m]=x.useState(0),{rows:N,toggleSectionComplete:I,setSectionNotes:v}=J(S,"user_water_alchemy_section_progress"),[T,u]=x.useState({});if(!h)return e.jsx("p",{style:W,children:"This module's content is being prepared."});const l=h.sections.map((r,i)=>({sectionId:`s${i}`,title:r.heading,render:()=>e.jsx("p",{style:W,children:r.body})}));return l.push({sectionId:"practice",title:"Living Practice",render:()=>e.jsxs(e.Fragment,{children:[e.jsx("p",{style:W,children:h.practice}),h.mantra&&e.jsx("div",{style:{marginTop:16,textAlign:"center"},children:e.jsxs("p",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:18,fontWeight:600,color:s,margin:0},children:["🕉 ",h.mantra]})})]})}),e.jsxs("div",{children:[e.jsxs("div",{style:{padding:"16px 20px",marginBottom:14,background:`${s}08`,borderRadius:20,borderLeft:`3px solid ${s}`},children:[e.jsx("div",{style:{fontSize:8,letterSpacing:"0.5em",textTransform:"uppercase",color:s,fontWeight:800,marginBottom:8},children:"Essence"}),e.jsxs("p",{style:{fontSize:16,color:"rgba(255,255,255,0.8)",fontStyle:"italic",lineHeight:1.6,margin:0},children:['"',h.essence,'"']}),e.jsxs("div",{style:{marginTop:10,fontSize:11,color:"rgba(255,255,255,0.4)"},children:["Transmitted by ",e.jsx("span",{style:{color:s,fontWeight:700},children:h.siddha})]})]}),l.map((r,i)=>{const a=y===i,t=N[r.sectionId],n=t?.completed??!1,A=t?.notes??"",c=T[r.sectionId]??"idle";return e.jsxs("div",{style:{marginBottom:10,borderRadius:20,overflow:"hidden",border:`1px solid ${a?"rgba(34,211,238,0.35)":n?"rgba(34,211,238,0.2)":"rgba(255,255,255,0.06)"}`,background:a?"rgba(34,211,238,0.04)":"rgba(255,255,255,0.012)"},children:[e.jsxs("button",{type:"button",onClick:()=>m(a?-1:i),style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",textAlign:"left",padding:"16px 20px",cursor:"pointer",background:"none",border:"none"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,minWidth:0},children:[e.jsx("span",{style:{width:26,height:26,borderRadius:"50%",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:800,border:`1.5px solid ${n||a?s:"rgba(255,255,255,0.15)"}`,background:n?"rgba(34,211,238,0.22)":a?"rgba(34,211,238,0.14)":"transparent",color:n||a?s:"rgba(255,255,255,0.4)"},children:n?e.jsx(D,{size:13}):i+1}),e.jsx("div",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.05rem",fontWeight:700,color:a?s:"rgba(255,255,255,0.85)"},children:r.title})]}),e.jsx(Q,{size:16,style:{flexShrink:0,color:a?s:"rgba(255,255,255,0.3)",transform:a?"rotate(180deg)":"none",transition:"transform .2s"}})]}),a&&e.jsxs("div",{style:{padding:"0 20px 24px"},children:[r.render(),e.jsxs("div",{style:{marginTop:24,paddingTop:18,borderTop:"1px solid rgba(255,255,255,0.06)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8},children:[e.jsx("span",{style:{fontSize:9,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Notes"}),c==="saving"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Saving…"}),c==="saved"&&e.jsxs("span",{style:{fontSize:9,textTransform:"uppercase",color:s,display:"flex",alignItems:"center",gap:4},children:[e.jsx(D,{size:10})," Saved"]}),c==="error"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"#F87171"},children:"Could not save"})]}),e.jsx("textarea",{value:A,onChange:R=>{const k=R.target.value;u(p=>({...p,[r.sectionId]:"saving"})),v(r.sectionId,k,p=>u(f=>({...f,[r.sectionId]:p?"saved":"error"})))},rows:3,placeholder:"Your reflections...",style:{width:"100%",resize:"vertical",borderRadius:14,border:"1px solid rgba(255,255,255,.1)",background:"rgba(5,5,5,.6)",padding:"10px 12px",fontSize:14.5,color:"rgba(255,255,255,.85)",fontFamily:"'Plus Jakarta Sans',sans-serif"}})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:18,flexWrap:"wrap",gap:10},children:[e.jsxs("button",{type:"button",onClick:()=>void I(r.sectionId),style:{display:"inline-flex",alignItems:"center",gap:6,background:n?"rgba(34,211,238,0.14)":"rgba(255,255,255,0.04)",border:`1px solid ${n?"rgba(34,211,238,0.4)":"rgba(255,255,255,0.12)"}`,color:n?s:"rgba(255,255,255,0.6)",padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:800,letterSpacing:".1em",textTransform:"uppercase",cursor:"pointer"},children:[e.jsx(D,{size:13})," ",n?"Completed":"Mark Complete"]}),e.jsx("button",{type:"button",disabled:i===l.length-1,onClick:()=>m(Math.min(l.length-1,i+1)),style:{background:i===l.length-1?"transparent":"rgba(34,211,238,0.14)",border:`1px solid ${i===l.length-1?"rgba(255,255,255,0.1)":"rgba(34,211,238,0.4)"}`,color:i===l.length-1?"rgba(255,255,255,0.25)":s,padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:700,cursor:i===l.length-1?"default":"pointer"},children:i===l.length-1?"Last section":"Next section →"})]})]})]},r.sectionId)})]})},te="rgba(34,211,238,0.9)";function pe(){const{id:b}=B(),S=U(),{user:h}=q(),{isAdmin:y}=V(),{tier:m,loading:N,settled:I}=K(),v=!N&&I,{courses:T,progressByModuleId:u,markComplete:l,touchAccessed:r,stats:i}=z(v),a=C.useMemo(()=>[...T].sort((g,w)=>g.module_number-w.module_number),[T]),t=C.useMemo(()=>a.find(g=>g.id===b),[a,b]);x.useEffect(()=>{t?.id&&h?.id&&r(t.id)},[t?.id,h?.id]);const n=t?a.findIndex(g=>g.id===t.id):-1,A=n>0?a[n-1]:null,c=n>=0&&n<a.length-1?a[n+1]:null,R=c?M(y,m,E(c.tier_required)):!1,k=C.useMemo(()=>[{slug:"free",label:"Atma-Seed"},{slug:"prana-flow",label:"Prana-Flow"},{slug:"siddha-quantum",label:"Siddha-Quantum"},{slug:"akasha-infinity",label:"Akasha-Infinity"}].map(w=>{const d=a.filter(o=>(o.tier_required||"free")===w.slug),O=d.filter(o=>u[o.id]?.completed).length,H=t?d.some(o=>o.id===t.id):!1;return{id:`tier-${w.slug}`,title:w.label,meta:`${O} / ${d.length} modules${O===d.length&&d.length>0?" complete":""}`,done:d.length>0&&O===d.length,current:H,items:d.map(o=>{const L=!!u[o.id]?.completed,Y=t?o.id===t.id:!1,F=M(y,m,E(o.tier_required)),G=L?"done":Y?"current":F?"available":"locked";return{id:o.id,number:o.module_number,title:o.title,state:G,href:`/sacred-water/module/${o.id}`}})}}),[a,u,t,y,m]);if(!v||!t)return e.jsx("div",{style:{minHeight:"100vh",background:"#050505",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("div",{style:{width:36,height:36,borderRadius:"50%",border:"2px solid rgba(34,211,238,.2)",borderTopColor:"#22D3EE",animation:"spin 0.8s linear infinite"}})});const p=M(y,m,E(t.tier_required)),f=te,P=j(E(t.tier_required));return e.jsx(Z,{accent:f,academyName:"Sacred Water Alchemy",academyHref:"/sacred-water",courseTitle:"Living Water",courseIcon:e.jsx($,{size:24}),moduleNumber:t.module_number,totalModules:i.totalModules,moduleTitle:t.title,thesis:t.subtitle||void 0,progressLabel:`${i.completedModules} / ${i.totalModules} · ${i.completionPercent}%`,progressPercent:i.completionPercent,railGroups:k,contentBlocks:[],locked:!p,lockedCta:e.jsx("button",{type:"button",onClick:()=>S(P),style:{borderRadius:999,padding:"13px 26px",background:`linear-gradient(135deg, ${f}, ${_(f,.7)})`,border:"none",color:"#050505",fontSize:10,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",cursor:"pointer"},children:"Unlock This Module"}),onMarkComplete:()=>void l(t.id),isComplete:!!u[t.id]?.completed,prevHref:A?`/sacred-water/module/${A.id}`:null,nextHref:c&&R?`/sacred-water/module/${c.id}`:null,footerExtra:h?.id?e.jsx(ee,{moduleKey:t.module_key,dbModuleId:t.id}):null})}export{pe as default};
