import{R as A,j as e,q as z,g as G,r as W}from"./vendor-react--OR-uH7S.js";import{u as O,a as U,h as K,g as N,b as Q}from"./index-RRXEvQfm.js";import{u as _}from"./useAdminRole-CCeebBaS.js";import{u as $,J as X}from"./jyotishModules-zUZa2AOq.js";import{u as Z,M as ee}from"./useSectionProgress-DAFvPfUS.js";import{f as ae}from"./tokens-DuZPxu2i.js";import{C as I,i as te,S as ie}from"./vendor-icons-CZmAPI07.js";import"./vendor-crypto-DfHPQj82.js";import"./vendor-radix-7CUZPdy3.js";import"./vendor-i18n-BS5B6gzd.js";import"./vendor-query-D1GokQmc.js";import"./vendor-supabase-DRj4EguU.js";import"./vendor-motion-Dm4zQNot.js";import"./describeError-BoR2s31v.js";const ne=[{moduleId:1,opening:`Before the first sunrise of this creation, before a single star was named, there was only sound — the primordial Nāda vibrating through infinite darkness. From that sound the Vedas arose. And from the Vedas, I — Bhrigu — received the grammar of time itself from Lord Brahma.
...
Aum Tat Sat.
Jai Bhrigu. Jai Jyotish.`,quiz:[{question:"What is the first step in the Siddha Reading Protocol?",options:["Identify the strongest yoga","Assess the Moon sign","Assess the Lagna and its lord completely","Check the current dasha"],answer:2,explanation:"The first and foundational step is always the complete Lagna assessment — the Ascendant sign, the Lagna lord, its placement, its strength, and any planets influencing the 1st house. This sets the entire filter for the reading."},{question:"The Rule of Three means?",options:["Use three dasha systems","Always do three chart readings per session","Never make a specific prediction from fewer than three independent confirming indicators","Check three divisional charts minimum"],answer:2,explanation:"The Rule of Three is the Siddha Jyotishi's fundamental standard: wait for three independent confirming indicators before making a specific prediction. One or two indicators warrant honest uncertainty."},{question:"When should the specialty system (BNN, Jaimini, Medical Jyotish) be applied in the protocol?",options:["Step 1, before the basic assessment","Step 5, replacing yoga identification","Step 9, after the foundational 8 steps are complete","Only for advanced clients"],answer:2,explanation:"Specialty systems are applied at Step 9 — after all foundational assessments (Lagna, Moon, yoga, dasha, transits, D9) are complete. The specialty system answers the specific question being asked, not the general chart reading."},{question:'What does "speaking from compassion, not brilliance" mean for a Jyotishi?',options:["Avoiding technical language","Prioritizing the person's need to understand over the display of astrological knowledge","Only giving positive predictions","Never using Sanskrit terms"],answer:1,explanation:"Speaking from compassion means the Jyotishi's primary motivation is helping the person understand what serves them — not demonstrating technical mastery. The moment performance replaces service, the reading loses its dharmic quality."},{question:"The final teaching of Module 32 is that the greatest Jyotishis were great because of what?",options:["Their vast memorization of texts","Their exclusive use of the Vimshottari system","Their consciousness being clear enough to receive the chart's truth without distortion","Their access to the most ancient manuscripts"],answer:2,explanation:"The final transmission is that technique is the instrument but consciousness is the musician. The greatest Jyotishis throughout history were great because their consciousness was clear enough to receive the chart's truth without the distortions of ego, fear, or personal bias."}]}],he=[...ne,...se,...re,...oe];function le(y){return he.find(S=>S.moduleId===y)}const f="#22D3EE",P={fontSize:20,lineHeight:1.8,color:"rgba(255,250,240,0.86)",fontFamily:"'Cormorant Garamond',serif",maxWidth:"68ch",whiteSpace:"pre-line"};function D(y){return y.split(/(\*\*[^*]+\*\*)/g).map((n,d)=>n.startsWith("**")&&n.endsWith("**")?e.jsx("strong",{style:{color:"rgba(255,255,255,0.98)",fontWeight:700},children:n.slice(2,-2)},d):e.jsx(A.Fragment,{children:n},d))}const ce=({moduleId:y,dbModuleId:S})=>{const n=le(y),[d,b]=A.useState(0),[q,C]=A.useState({}),{rows:J,toggleSectionComplete:v,setSectionNotes:R}=Z(S,"user_jyotish_vidya_section_progress"),[B,r]=A.useState({});if(!n)return e.jsx("p",{style:P,children:"This module's content is being prepared."});const l=[{sectionId:"opening",title:"Opening Transmission",render:()=>e.jsx("p",{style:P,children:D(n.opening)})},...n.sections.map((a,t)=>({sectionId:`section-${t}`,title:a.title,render:()=>e.jsxs(e.Fragment,{children:[e.jsx("p",{style:{...P,marginBottom:a.keyTerms&&a.keyTerms.length>0?18:0},children:D(a.body)}),a.keyTerms&&a.keyTerms.length>0&&e.jsxs("div",{style:{background:"rgba(34,211,238,0.05)",border:"1px solid rgba(34,211,238,0.18)",borderRadius:18,padding:"16px 20px"},children:[e.jsx("div",{style:{fontSize:8,fontWeight:800,letterSpacing:".3em",textTransform:"uppercase",color:f,marginBottom:10},children:"Key Terms"}),a.keyTerms.map((i,s)=>e.jsxs("div",{style:{marginBottom:s<a.keyTerms.length-1?10:0},children:[e.jsx("span",{style:{fontWeight:700,color:"rgba(255,255,255,0.9)"},children:i.term}),i.sanskrit&&e.jsx("span",{style:{color:"rgba(255,255,255,0.4)",marginLeft:6,fontSize:13},children:i.sanskrit}),e.jsx("div",{style:{fontSize:14,color:"rgba(255,255,255,0.65)",fontFamily:"'Cormorant Garamond',serif"},children:i.definition})]},s))]})]})})),{sectionId:"practice",title:"Practice",render:()=>e.jsx("div",{style:{background:"rgba(212,175,55,0.05)",border:"1px solid rgba(212,175,55,0.18)",borderRadius:18,padding:"18px 20px"},children:e.jsx("p",{style:{fontSize:17,lineHeight:1.75,color:"rgba(255,255,255,0.85)",fontFamily:"'Cormorant Garamond',serif",margin:0},children:D(n.practice)})})},{sectionId:"closing",title:"Closing Transmission",render:()=>e.jsx("p",{style:{...P,fontStyle:"italic"},children:D(n.closing)})}];return n.quiz&&n.quiz.length>0&&l.push({sectionId:"quiz",title:`Quiz — ${n.quiz.length} Questions`,render:()=>e.jsx("div",{children:n.quiz.map((a,t)=>{const i=q[t],s=i!==void 0;return e.jsxs("div",{style:{marginBottom:t<n.quiz.length-1?22:0},children:[e.jsxs("p",{style:{fontSize:16,fontWeight:700,color:"rgba(255,255,255,0.9)",marginBottom:10,fontFamily:"'Cormorant Garamond',serif"},children:[t+1,". ",a.question]}),a.options.map((o,m)=>{const p=m===a.answer,w=i===m;let k="rgba(255,255,255,0.03)",c="rgba(255,255,255,0.1)";return s&&p?(k="rgba(74,222,128,0.1)",c="rgba(74,222,128,0.4)"):s&&w&&!p&&(k="rgba(248,113,113,0.1)",c="rgba(248,113,113,0.4)"),e.jsx("button",{type:"button",disabled:s,onClick:()=>C(M=>({...M,[t]:m})),style:{display:"block",width:"100%",textAlign:"left",marginBottom:6,padding:"10px 14px",borderRadius:12,background:k,border:`1px solid ${c}`,color:"rgba(255,255,255,0.8)",fontSize:14,cursor:s?"default":"pointer",fontFamily:"'Plus Jakarta Sans',sans-serif"},children:o},m)}),s&&e.jsx("p",{style:{fontSize:13,color:"rgba(255,255,255,0.55)",marginTop:6,fontStyle:"italic"},children:a.explanation})]},t)})})}),e.jsx("div",{children:l.map((a,t)=>{const i=d===t,s=J[a.sectionId],o=s?.completed??!1,m=s?.notes??"",p=B[a.sectionId]??"idle";return e.jsxs("div",{style:{marginBottom:10,borderRadius:20,overflow:"hidden",border:`1px solid ${i?"rgba(34,211,238,0.35)":o?"rgba(34,211,238,0.2)":"rgba(255,255,255,0.06)"}`,background:i?"rgba(34,211,238,0.04)":"rgba(255,255,255,0.012)"},children:[e.jsxs("button",{type:"button",onClick:()=>b(i?-1:t),style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",textAlign:"left",padding:"16px 20px",cursor:"pointer",background:"none",border:"none"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,minWidth:0},children:[e.jsx("span",{style:{width:26,height:26,borderRadius:"50%",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:800,border:`1.5px solid ${o||i?f:"rgba(255,255,255,0.15)"}`,background:o?"rgba(34,211,238,0.22)":i?"rgba(34,211,238,0.14)":"transparent",color:o||i?f:"rgba(255,255,255,0.4)"},children:o?e.jsx(I,{size:13}):t+1}),e.jsx("div",{style:{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.05rem",fontWeight:700,color:i?f:"rgba(255,255,255,0.85)"},children:a.title})]}),e.jsx(te,{size:16,style:{flexShrink:0,color:i?f:"rgba(255,255,255,0.3)",transform:i?"rotate(180deg)":"none",transition:"transform .2s"}})]}),i&&e.jsxs("div",{style:{padding:"0 20px 24px"},children:[a.render(),e.jsxs("div",{style:{marginTop:24,paddingTop:18,borderTop:"1px solid rgba(255,255,255,0.06)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8},children:[e.jsx("span",{style:{fontSize:9,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Notes"}),p==="saving"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"rgba(255,255,255,0.35)"},children:"Saving…"}),p==="saved"&&e.jsxs("span",{style:{fontSize:9,textTransform:"uppercase",color:f,display:"flex",alignItems:"center",gap:4},children:[e.jsx(I,{size:10})," Saved"]}),p==="error"&&e.jsx("span",{style:{fontSize:9,textTransform:"uppercase",color:"#F87171"},children:"Could not save"})]}),e.jsx("textarea",{value:m,onChange:w=>{const k=w.target.value;r(c=>({...c,[a.sectionId]:"saving"})),R(a.sectionId,k,c=>r(M=>({...M,[a.sectionId]:c?"saved":"error"})))},rows:3,placeholder:"Your reflections...",style:{width:"100%",resize:"vertical",borderRadius:14,border:"1px solid rgba(255,255,255,.1)",background:"rgba(5,5,5,.6)",padding:"10px 12px",fontSize:14.5,color:"rgba(255,255,255,.85)",fontFamily:"'Plus Jakarta Sans',sans-serif"}})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:18,flexWrap:"wrap",gap:10},children:[e.jsxs("button",{type:"button",onClick:()=>void v(a.sectionId),style:{display:"inline-flex",alignItems:"center",gap:6,background:o?"rgba(34,211,238,0.14)":"rgba(255,255,255,0.04)",border:`1px solid ${o?"rgba(34,211,238,0.4)":"rgba(255,255,255,0.12)"}`,color:o?f:"rgba(255,255,255,0.6)",padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:800,letterSpacing:".1em",textTransform:"uppercase",cursor:"pointer"},children:[e.jsx(I,{size:13})," ",o?"Completed":"Mark Complete"]}),e.jsx("button",{type:"button",disabled:t===l.length-1,onClick:()=>b(Math.min(l.length-1,t+1)),style:{background:t===l.length-1?"transparent":"rgba(34,211,238,0.14)",border:`1px solid ${t===l.length-1?"rgba(255,255,255,0.1)":"rgba(34,211,238,0.4)"}`,color:t===l.length-1?"rgba(255,255,255,0.25)":f,padding:"9px 16px",borderRadius:999,fontSize:10.5,fontWeight:700,cursor:t===l.length-1?"default":"pointer"},children:t===l.length-1?"Last section":"Next section →"})]})]})]},a.sectionId)})})},de="rgba(34,211,238,0.9)";function Ae(){const{moduleId:y}=z(),S=G(),{user:n}=O(),{isAdmin:d}=_(),{tier:b,loading:q,settled:C}=U(),J=!q&&C,{progressByModuleId:v,markComplete:R,touchAccess:B}=$(J),r=W.useMemo(()=>[...X].sort((u,x)=>u.id-x.id),[]),l=Number(y),a=W.useMemo(()=>r.find(u=>u.id===l),[r,l]);A.useEffect(()=>{a?.id&&n?.id&&B(a.id)},[a?.id,n?.id]);const t=a?r.findIndex(u=>u.id===a.id):-1,i=t>0?r[t-1]:null,s=t>=0&&t<r.length-1?r[t+1]:null,o=s?K(d,b,N(s.tier)):!1,m=W.useMemo(()=>[{slug:"free",label:"Atma-Seed"},{slug:"prana",label:"Prana-Flow"},{slug:"siddha",label:"Siddha-Quantum"},{slug:"akasha",label:"Akasha-Infinity"}].map(x=>{const g=r.filter(h=>h.tier===x.slug),L=g.filter(h=>{const T=v[h.id];return T&&(T.status==="completed"||T.completion_percentage>=100)}).length,E=a?g.some(h=>h.id===a.id):!1;return{id:`tier-${x.slug}`,title:x.label,meta:`${L} / ${g.length} modules${L===g.length&&g.length>0?" complete":""}`,done:g.length>0&&L===g.length,current:E,items:g.map(h=>{const T=v[h.id],j=!!(T&&(T.status==="completed"||T.completion_percentage>=100)),Y=a?h.id===a.id:!1,F=K(d,b,N(h.tier)),H=j?"done":Y?"current":F?"available":"locked";return{id:String(h.id),number:h.id,title:h.title,state:H,href:`/jyotish-vidya/module/${h.id}`}})}}),[r,v,a,d,b]);if(!a)return e.jsx("div",{style:{minHeight:"100vh",background:"#050505",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("div",{style:{width:36,height:36,borderRadius:"50%",border:"2px solid rgba(34,211,238,.2)",borderTopColor:"#22D3EE",animation:"spin 0.8s linear infinite"}})});const p=K(d,b,N(a.tier)),w=de,k=Q(N(a.tier)),c=v[a.id],M=!!(c&&(c.status==="completed"||c.completion_percentage>=100)),V=Object.values(v).filter(u=>u.status==="completed"||u.completion_percentage>=100).length;return e.jsx(ee,{accent:w,academyName:"Sovereign Jyotish Vidya",academyHref:"/jyotish-vidya",courseTitle:"Bhrigu's Living Transmission",courseIcon:e.jsx(ie,{size:24}),moduleNumber:a.id,totalModules:r.length,moduleTitle:a.title,thesis:a.subtitle||void 0,progressLabel:`${V} / ${r.length} · ${Math.round(V/r.length*100)}%`,progressPercent:Math.round(V/r.length*100),railGroups:m,contentBlocks:[],locked:!p,lockedCta:e.jsx("button",{type:"button",onClick:()=>S(k),style:{borderRadius:999,padding:"13px 26px",background:`linear-gradient(135deg, ${w}, ${ae(w,.7)})`,border:"none",color:"#050505",fontSize:10,fontWeight:800,letterSpacing:".2em",textTransform:"uppercase",cursor:"pointer"},children:"Unlock This Module"}),onMarkComplete:()=>void R(a.id),isComplete:M,prevHref:i?`/jyotish-vidya/module/${i.id}`:null,nextHref:s&&o?`/jyotish-vidya/module/${s.id}`:null,footerExtra:n?.id?e.jsx(ce,{moduleId:a.id,dbModuleId:String(a.id)}):null})}export{Ae as default};
