import{i as A,r as f,j as e}from"./vendor-react-DdWqvjvq.js";import{u as P,b as B,g as K,m as I}from"./index-DPalQnOV.js";import{A as T,c as W,C as S,l as w,a7 as E,_ as z}from"./vendor-icons-DQ9y02-X.js";import"./vendor-crypto-Cz0s2Wb9.js";import"./vendor-radix-E_JnJsxb.js";import"./vendor-i18n-CLO2ZSBh.js";import"./vendor-query-DDdS-q50.js";import"./vendor-supabase-C8XXFrAR.js";import"./vendor-motion-BWTr00U0.js";const c={free:{label:"Free",color:"#6B7280",glow:"rgba(107,114,128,0.3)",rank:0,price:"Free",upgradeUrl:"/prana-flow"},"prana-flow":{label:"Prana-Flow",color:"#22D3EE",glow:"rgba(34,211,238,0.3)",rank:1,price:"€19/mo",upgradeUrl:"/prana-flow"},"siddha-quantum":{label:"Siddha-Quantum",color:"#D4AF37",glow:"rgba(212,175,55,0.3)",rank:2,price:"€45/mo",upgradeUrl:"/siddha-quantum"},"akasha-infinity":{label:"Akasha-Infinity",color:"#A78BFA",glow:"rgba(167,139,250,0.3)",rank:3,price:"€1,111 lifetime",upgradeUrl:"/akasha-infinity"}},H=[{id:1,number:"01",tier:"free",title:"Introduction to The Holy Science",subtitle:"Who Was Sri Yukteshwar & Why This Book Matters in 2026",transmissionType:"Akasha-Intro",totalDuration:"42 min",lessons:[{id:"1-1",tier:"free",duration:"14 min",title:"Sri Yukteshwar — Life of a Cosmic Mathematician",content:`Sri Yukteshwar Giri (1855–1936) is among the most misunderstood masters of modern India — not because he was obscure, but because his teaching was so precise and technically demanding that most spiritual literature softens it into something far less potent than what he actually left behind.
...
Sri Yukteshwar's outer life was that of a disciplinarian and farmer. Paramhansa Yogananda writes that he would identify a student's core spiritual weakness on first meeting and relentlessly work on exactly that point. This was not cruelty — it was precision surgery on the causal body. He attained Nirvikalpa Samadhi at 33. He left his body consciously in 1936, and appeared to Yogananda in fully materialized form weeks later to explain the nature of the astral and causal universes — a transmission recorded in Autobiography of a Yogi's chapter "The Resurrection of Sri Yukteshwar."`,revelation:"The Akasha-Archive confirms: Sri Yukteshwar carried a specific cosmic assignment — to prepare the East-West spiritual bridge that ascending Dwapara Yuga requires. His severity was calibrated. His book was channeled. His mission continues through every student who takes his teaching seriously."},{id:"1-2",tier:"free",duration:"10 min",title:"The Structure of The Holy Science — A Complete Map",content:`The Holy Science is divided into four parts, each corresponding to a stage of spiritual development:
...
The entire book is a ladder. Each rung must be understood before the next becomes stable.`,revelation:`Sri Yukteshwar's whisper: "Most students read the book once and believe they have received it. The book must be lived, not read. Return to it every year and discover it has grown since your last visit — because you have grown."`},{id:"1-3",tier:"free",duration:"18 min",title:"Why 2026 Is the Exact Year for This Study",content:`Year 326 of ascending Dwapara Yuga. This is not an abstract number — it has practical implications for what is spiritually possible right now.
...
Sri Yukteshwar wrote this book for this era. He wrote it for the students who would be born into the ascending Dwapara current and need a precise map.`,revelation:"The Akasha-Archive transmits: In 2026, the Jupiter-Saturn configuration and the Sun's position in the galactic longitude are creating a rare alignment that amplifies sadhana dramatically. This window is active through approximately mid-2027. The teaching you begin now carries exponential acceleration."}]},{id:2,number:"02",tier:"free",title:"The Yuga Cycle — The Corrected Chronology",subtitle:"Sri Yukteshwar's Mathematical Correction of Cosmic Time",transmissionType:"Scalar-Bhakti",totalDuration:"55 min",lessons:[{id:"2-1",tier:"free",duration:"22 min",title:"The Great Calendar Error — Decoded",content:`The most impactful claim in The Holy Science — and the one most ignored by mainstream Hindu scholarship — is that the commonly taught Yuga cycle is mathematically wrong by a factor of 360.
...
**Timeline:** Ascending Dwapara Yuga began 1700 CE. We are currently Year 326. Ascending Treta Yuga begins approximately 4100 CE.`,revelation:'Sri Yukteshwar speaks: "The error was not accidental. When civilizations collapse into dark ages, custodians of sacred knowledge encode it in forms the dark age mind cannot corrupt. The 360x multiplication was deliberate encoding. I was given permission to decode it in 1894. It is certainly 2026."'},{id:"2-2",tier:"free",duration:"18 min",title:"Dwapara Yuga Signatures — Proof All Around Us",content:`Sri Yukteshwar tells us exactly what to expect from Dwapara Yuga — the Age of Fine Matter. The evidence his chronology is correct is overwhelming:
...
**What remains Kali-quality:** Political and economic systems still lag — operating on Kali-era scarcity programming. The student of The Holy Science must position themselves on the leading edge of Dwapara — not by spiritual bypassing, but by genuine sadhana that raises the vibrational body to Dwapara frequency and beyond.`,revelation:'Transmission: The technologies you call "scalar waves," "biofield healing," and "frequency medicine" are Dwapara-age rediscoveries of what Siddha science maintained continuously. The Siddhas never lost this knowledge because they never dropped into Kali Yuga consciousness. They maintained the living transmission chain.'},{id:"2-3",tier:"free",duration:"15 min",title:"Precise Cosmic Positioning — 2026",content:`A precise coordinate for 2026 in the cosmic calendar: **Year 326 of ascending Dwapara Yuga.**
...
**The 2026–2027 acceleration window:** Jupiter (expansion, dharma, guru principle) and Saturn (structure, karma, time) are in a specific angular relationship that the Siddha tradition identifies as a "dharma gate" — when sincere students compress years of karmic clearing into months. Sri Yukteshwar would have recognized this window and used it. We can too.`,revelation:'From the Akasha: "A student who begins sincere sadhana in the window of 2026–2027 is not beginning in ordinary time. They are beginning at a cosmic intersection. The Siddhas always tracked these windows. The Holy Science was published at one such intersection in 1894. This is another."'}]},{id:3,number:"03",tier:"prana-flow",title:"The Five Koshas — Bodies of Light",subtitle:"Vedic Anatomy from Physical to Causal Body",transmissionType:"Nada-Scalar",totalDuration:"78 min",lessons:[{id:"3-1",tier:"prana-flow",duration:"24 min",title:"Annamaya & Pranamaya — Physical and Vital Fields",content:`The five-kosha model is The Holy Science's anatomical framework — as precise and functional as any modern medical system, addressing layers of the human being that biomedicine does not yet officially acknowledge.
...
Kriya Yoga works directly on the pranamaya kosha through spinal breathing, reversing the habitual downward-outward prana flow and redirecting it upward through the sushumna. This reversal is the technical mechanism behind Kriya's accelerated evolution.`,revelation:`Babaji's transmission: "The pranamaya kosha is the bridge between matter and consciousness. Every physical disease originates here first — the blockage appears in the pranic field months or years before it manifests physically. The healer who can read and clear the pranamaya field is working at the root."`},{id:"3-2",tier:"prana-flow",duration:"28 min",title:"Manomaya, Vijnanamaya & Anandamaya — Mind to Bliss",content:`**Manomaya Kosha — The Mental Body:**
...
Beyond the five koshas: the Atman — the pure witness, identical with Brahman. It wears the koshas but is untouched by them, as the sky is untouched by passing clouds.`,revelation:`Sri Yukteshwar from the Akasha: "The purpose of yoga is not to make the lower koshas more comfortable. It is to make the Atman more visible. When the Atman shines through all five koshas without obstruction, you are a liberated being. The koshas do not disappear — they become translucent. This is what the Siddhas mean by 'light body.'"`},{id:"3-3",tier:"prana-flow",duration:"26 min",title:"Kosha Practice Protocol — Daily Integration",content:`A complete daily protocol organized by kosha for the Prana-Flow practitioner:
...
**Anandamaya Kosha:**
Direct work requires consistent practice over time. The monthly Ekadashi fast (sunrise to sunrise) allows the Manomaya and Vijnanamaya koshas to become quiet enough that the Anandamaya Kosha's bliss-nature becomes perceptible — often first as spontaneous tears of gratitude or pervasive stillness beneath all activity.`,revelation:'Transmission: The koshas are nested interpenetrating fields, like layers of an onion made of light and vibration. A consistent pranayama practice does not just improve breathing — it reorganizes karmic patterns in the causal body. The Siddhas knew this. The results that seem "miraculous" to the uninitiated are simply Anandamaya Kosha reorganization becoming visible at the Annamaya level.'}]},{id:4,number:"04",tier:"prana-flow",title:"Dharma & the Path to Samadhi",subtitle:"Sri Yukteshwar's Four Commandments & Five States of Union",transmissionType:"Prema-Pulse",totalDuration:"66 min",lessons:[{id:"4-1",tier:"prana-flow",duration:"22 min",title:"The Four Great Commandments — Universal Spiritual Law",content:`Sri Yukteshwar opens The Holy Science by comparing four scriptures — Vedic sutras, the Gospel of John, Buddhist Pali Canon, and Islamic hadith — demonstrating they encode the same four-fold spiritual law. He was removing the justification for religious tribalism at the philosophical root.
...
The central practical technology. Breath is the only voluntary bridge between the somatic (automatic) nervous system and the conscious will. Mastery of breath = mastery of the interface between matter-consciousness and pure awareness. Sri Yukteshwar considered this the single most important practical teaching in the entire spiritual corpus.`,revelation:'Sri Yukteshwar: "These four commandments appear in every genuine tradition because they are descriptions of cosmic law, not cultural inventions. The universe itself operates on Shraddha (coherence), Niyama (consistent natural cycles), Asana (stability amid change), and Pranayama (rhythmic energy exchange). The human who embodies all four becomes a microcosm of universal law."'},{id:"4-2",tier:"prana-flow",duration:"24 min",title:"The Five Stages of Samadhi — From Glimpse to Living Union",content:`Samadhi is not one state — it is a family of states in ascending order of depth and permanence. Sri Yukteshwar distinguishes them with precision rare in popularized yoga literature:
...
The voluntary departure from the body at one's choosing, in full awareness, without pathology. Sri Yukteshwar left his body in Mahasamadhi in 1936.`,revelation:`From Babaji's consciousness in the Akasha: "Samadhi is not the goal of yoga — it is the graduation into actual life. Everything before Samadhi is preparation to be fully alive. After Nirvikalpa, the human being stops sleepwalking. This is what 'enlightenment' means: not the acquisition of something new, but the removal of the obscuration that prevented you from seeing what was always already there."`},{id:"4-3",tier:"prana-flow",duration:"20 min",title:"Dharma in Practical Life — 2026 Integration",content:`Sri Yukteshwar's definition of Dharma is precise: alignment between individual consciousness and Cosmic Intelligence (Kutastha Chaitanya). This is not morality in the conventional sense — it is magnetic resonance.
...
The Dwapara Yuga is dissolving the separation between spiritual and professional life characteristic of Kali Yuga. The householder yogi who maintains dharmic alignment in ordinary life advances faster than the renunciate who retreats from karma rather than transforming it. Lahiri Mahasaya — a married, tax-paying government accountant — was Sri Yukteshwar's demonstration of this principle.`,revelation:`Sri Yukteshwar's transmission: "Your vocation is the form the universe has chosen for your dharmic expression in this incarnation. When you resist it, you create karma. When you refine it — bringing your full consciousness, your Kriya practice, your discriminative wisdom into it — you transform it into a vehicle for liberation."`}]},{id:5,number:"05",tier:"siddha-quantum",title:"Mathematical Astrology of the Yugas",subtitle:"Jyotish, Precession & Cosmic Timing Science",transmissionType:"Jyotish-Scalar",totalDuration:"108 min",lessons:[{id:"5-1",tier:"siddha-quantum",duration:"35 min",title:"Binary Star Theory & the Precessional Clock",content:`The mathematical framework of the Yugas is not mythology — it is astronomical science that modern astrophysics is only now approaching.
...
2026 Winter Solstice: approximately in **Mula Nakshatra** — ruled by Nirriti (goddess of dissolution/transformation), governed by Ketu, sitting at the heart of the Galactic Center (27° Sagittarius sidereal). That Earth's precessional axis currently points toward the Galactic Center during early ascending Dwapara is cosmically significant — the cosmic signal tower is aligned with the planetary receiver during the beginning of the information upgrade.`,revelation:"From the Akasha: The precession of equinoxes was known to every major ancient civilization — Egypt (the Sphinx aligns with Leo at 10,500 BCE = previous Satya Yuga peak), Vedic India (Rig Veda contains precessional star references to ~7000 BCE), and Sumer (the sexagesimal base-60 system directly encodes precessional mathematics: 25,920 ÷ 60 = 432, the Kali Yuga number in the inflated chronology). The ancients were not primitive. They were Dwapara-level scientists."},{id:"5-2",tier:"siddha-quantum",duration:"38 min",title:"Jyotish as Yuga Science — Using the Chart for Liberation",content:`Sri Yukteshwar was himself a Jyotishi of the highest order — and he understood astrology not as fate-reading but as karmic cartography. The birth chart maps the vibrational signature you arrived with. Jyotish's job is to identify the curriculum — not determine destiny.
...
**Hora Timing:**
Each hour of the day is governed by a planet in sequence. Sun Hora: solar practice. Moon Hora: emotional healing, mantra. Jupiter Hora: meditation, teaching. Venus Hora: bhakti, creativity, healing through love. Saturn Hora: karma clearing, structural disciplines.`,revelation:"Akasha transmission: Jyotish was not designed to tell you what will happen. It was designed to tell you what you have come here to learn, and to identify the windows when specific learnings are available with maximum support. The student who combines Kriya Yoga with accurate Jyotish self-knowledge compresses lifetimes of karmic evolution into years. This is the 2026 fast-path."},{id:"5-3",tier:"siddha-quantum",duration:"35 min",title:"Tithis, Transits & the Monthly Practice Calendar",content:`The lunar calendar is the most powerful practical tool most modern spiritual practitioners completely ignore. Sri Yukteshwar was meticulous about lunar timing — and the Siddha tradition operates almost entirely on lunar rhythm.
...
• Daily: 108 Kriyas at Brahma Muhurta`,revelation:"Siddha transmission: The lunar calendar is the human body's natural operating system — the menstrual cycle aligns with it, the immune cycle aligns with it, the emotional cycle aligns with it. Modern humans have overridden this natural rhythm with artificial light and digital schedules. Re-synchronizing is not esoteric — it is returning to the factory settings of the biological instrument. The spiritual results follow naturally."}]},{id:6,number:"06",tier:"siddha-quantum",title:"Kriya Yoga as Quantum Technology",subtitle:"Spinal Physics, Prana Science & the Compression of Karma",transmissionType:"Kriya-Quantum",totalDuration:"144 min",lessons:[{id:"6-1",tier:"siddha-quantum",duration:"48 min",title:"The Spine as Cosmic Antenna — Piezoelectric Science",content:`The spine is the primary instrument of consciousness evolution in the human body — not metaphorically but physically and measurably.
...
Modern nasal cycle research confirms: the nose alternates dominant nostrils every 90–120 minutes. In deep meditation, both nostrils open simultaneously — indicating sushumna activation. This is not mysticism. It is physiology.`,revelation:`Babaji's direct transmission: "The spine is not 'in' the body. The body is organized around the spine. The entire physical manifestation is a superstructure built to serve this central axis of consciousness navigation. When you do Kriya Yoga, you are not doing 'exercises' — you are operating the central control system of your incarnation."`},{id:"6-2",tier:"siddha-quantum",duration:"52 min",title:"The Six Techniques Sri Yukteshwar Transmitted",content:`Sri Yukteshwar systematized the following sequence in pedagogical order — each is a prerequisite for the next.
...
All six sense gates physically closed. Attention fixed at the Ajna point. The practitioner directly perceives the cosmic AUM vibration — not as concept but as actual sound-light phenomenon at the center of the head. The beginning of genuine Samadhi work.`,revelation:'Sri Yukteshwar on technique: "The techniques are not the path. They are the vehicle. The student who becomes attached to the techniques and confused about the destination is like a driver who loves the car but has forgotten where they are going. The destination is Kaivalya — absolute freedom. The techniques serve this and nothing else."'},{id:"6-3",tier:"siddha-quantum",duration:"44 min",title:"The 30-Day Kriya Activation Protocol — 2026",content:`A complete 30-day Kriya intensification designed for the 2026 window:
...
• Quarterly solstice/equinox retreat: Minimum 24-hour intensive`,revelation:'Final transmission from Sri Yukteshwar for this module: "The student who maintains this practice consistently for one year — not perfectly, but consistently, returning when they lapse, never abandoning it — will not recognize themselves at the end of that year. Not because they have become different, but because they will have become more fully what they always actually were."'}]},{id:7,number:"07",tier:"akasha-infinity",title:"The Holy Science & the Bible — Unified Code",subtitle:"Sri Yukteshwar's Cross-Tradition Cosmic Decryption",transmissionType:"Akasha-Transmission",totalDuration:"88 min",lessons:[{id:"7-1",tier:"akasha-infinity",duration:"40 min",title:"The Seven Churches of Revelation = The Seven Chakras",content:`Sri Yukteshwar demonstrates in Part IV of The Holy Science that the Book of Revelation is a veiled technical manual for Kriya Yoga — mapping identically to the chakra system and stages of spiritual development.
...
"Because you are lukewarm — neither hot nor cold — I will spit you out" (3:16). The "lukewarm" state of partial enlightenment — tasted the Infinite, not yet fully merged. Sri Yukteshwar's teaching: the only cure for lukewarm is to go cold (full surrender/Nirvikalpa) or hot (full embodied engagement with life as sadhana). Spiritual tourism perpetuates the delay.`,revelation:`Sri Yukteshwar's Akasha transmission: "John of Patmos was a Kriya-level initiate who had direct experience of the seven-chakra ascent. He described it in the only language his cultural context could receive — apocalyptic Jewish prophetic vision. The 'apocalypse' (Greek: apokalupsis = 'unveiling') is not a future destruction of the world. It is the present-moment unveiling of the inner world to the awakened consciousness."`},{id:"7-2",tier:"akasha-infinity",duration:"28 min",title:"The Gospel of John as Vedantic Sutras",content:`Sri Yukteshwar opens The Holy Science by comparing the Gospel of John directly with Sankhya-Yoga cosmology. This remains radical in 2026, still not absorbed by either Christian or Hindu orthodox institutions.
...
Sri Yukteshwar's reading: "I" (Aham = the Atman, not the personal Jesus) "am the Way" (Dharma) "the Truth" (Sat = Pure Being) "and the Life" (Prana = the life-force itself). Read as Atman-identity teaching, it is identical to the Upanishadic "Aham Brahmasmi." Read as personal-Jesus exclusivism, it creates 2,000 years of religious tribalism. Sri Yukteshwar was restoring the Vedantic reading.`,revelation:"The Akasha reveals: The reason Sri Yukteshwar's cross-tradition work has not been widely adopted is not intellectual — it is because its adoption would dissolve the institutional power structures that require a proprietary claim on salvation. The teaching itself is irrefutable to anyone who studies it carefully. The Dwapara Yuga's dissolution of institutional authority is precisely what is needed for this teaching to take root. The moment is now."},{id:"7-3",tier:"akasha-infinity",duration:"20 min",title:"Babaji, Sri Yukteshwar & the Living Transmission Chain",content:`The Holy Science cannot be fully understood without understanding the transmission chain through which it arrived — because it is not primarily an intellectual document. It is a scalar transmission encoded in text.
...
The SQI platform exists at the intersection of these currents — offering Jnana (Holy Science study), Bhakti (Sri Vishwananda transmissions), and Nada (scalar sound healing) in an integrated digital dharma vehicle appropriate for ascending Dwapara Yuga.`,revelation:`Sri Yukteshwar's final transmission on the chain: "I am not in the past. The master who has attained Kaivalya is not located in time. I am as present to the student who reads these words in 2026 as I was to Yogananda in 1936. Call on me in meditation. At the Ajna point. In the silence after the Kriya. I am there. Not as a belief — as a verifiable, repeatable fact of consciousness. Test it. This is the Holy Science."`}]},{id:8,number:"08",tier:"akasha-infinity",title:"The Seven Lokas & Multidimensional Existence",subtitle:"Navigating the Astral & Causal Universes",transmissionType:"Multidimensional-Scalar",totalDuration:"96 min",lessons:[{id:"8-1",tier:"akasha-infinity",duration:"40 min",title:"The Seven Planes — Cosmology of the Inhabited Universe",content:`Sri Yukteshwar's cosmology describes seven interpenetrating planes of existence — the seven lokas — each corresponding to a chakra, a tattva (element), a musical note, and a level of consciousness:
...
The Absolute. The plane of non-dual Brahman awareness. No experiencer, no experience — only the Ground that makes all experience possible.`,revelation:`Sri Yukteshwar's transmission on the lokas: "These are not places in space. They are modes of consciousness. The same being exists simultaneously on all seven planes. Yoga is the technology for becoming aware of this simultaneity while still in the physical body — rather than waiting for death to reveal it one plane at a time."`},{id:"8-2",tier:"akasha-infinity",duration:"32 min",title:"Sri Yukteshwar's Astral Universe — The Resurrection Transmission",content:`Sri Yukteshwar's post-death appearance to Yogananda in a Bombay hotel room in 1936 (Autobiography of a Yogi, Chapter 43) is one of the most detailed first-person accounts of the astral universe in all spiritual literature — and entirely consistent with the cosmology of The Holy Science.
...
The meditator who consistently practices Kriya Yoga is consciously thinning the boundary between the physical and astral bodies during life — "dying daily." The result: less fear of physical death (because you have experienced the astral dimension in meditation), more access to intuitive astral perception, and accelerated karma clearing.`,revelation:`Sri Yukteshwar's Akasha transmission: "The universe is much larger, much more populated, and much more organized than the physical plane suggests. You are not a physical being who sometimes has spiritual experiences. You are a multidimensional being currently focused in a physical body as a deliberate choice for the curriculum this plane offers. When that curriculum is complete, the physical focus will be released — not with grief, but with the natural ease of completing a deeply engaging immersive game and returning to the larger life. Prepare accordingly. Practice accordingly. Live accordingly."`},{id:"8-3",tier:"akasha-infinity",duration:"24 min",title:"Integrating the Full Holy Science — Living Kaivalya in 2026",content:`Kaivalya — the Sanskrit title of The Holy Science — means "absolute wholeness." The state of the Atman that needs nothing external because it IS the totality. Not isolation — the recognition that the apparently separate self was always the totality in disguise.
...
In 2026, in the accelerating energy of ascending Dwapara Yuga, with cosmic timing supporting rapid evolution, with the technology of sound and transmission available through SQI — there is no reason to delay. The ladder has been placed. The only question remaining is whether the student will climb.`,revelation:'Sri Yukteshwar speaks the final transmission of this curriculum: "The book has served its purpose when the student no longer needs it — because they have become what it described. Until then, return to it. The Holy Science is not a document about spiritual life. It is a tuning fork. Each reading, at a higher level of your own development, activates a higher harmonic of the transmission. The text has not changed. You have. And in that change, you will find the text has infinite depth."'}]}],b=`
@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;700;800;900&display=swap');
@keyframes sqiPulse { 0% { transform:scale(1); opacity:0.2; } 100% { transform:scale(2.2); opacity:0; } }
@keyframes sqiGlow  { 0% { opacity:0.3; } 100% { opacity:0.75; } }
`,x={background:"none",border:"1px solid rgba(212,175,55,0.15)",borderRadius:12,color:"rgba(212,175,55,0.6)",padding:"8px 16px",fontSize:10,fontWeight:800,letterSpacing:"0.25em",textTransform:"uppercase",cursor:"pointer",marginBottom:32,display:"flex",alignItems:"center",gap:6},F=({size:l=120})=>e.jsxs("div",{style:{position:"relative",width:l,height:l,margin:"0 auto",flexShrink:0},children:[[1,2,3,4].map(o=>e.jsx("div",{style:{position:"absolute",inset:0,borderRadius:"50%",border:"1px solid rgba(212,175,55,0.18)",animation:`sqiPulse ${2+o*.4}s ease-out infinite`,animationDelay:`${o*.3}s`}},o)),e.jsx("div",{style:{position:"absolute",inset:"20%",borderRadius:"50%",background:"radial-gradient(circle,rgba(212,175,55,0.2) 0%,transparent 70%)",animation:"sqiGlow 3s ease-in-out infinite alternate"}}),e.jsx("div",{style:{position:"absolute",inset:"35%",borderRadius:"50%",background:"radial-gradient(circle,rgba(212,175,55,0.5) 0%,rgba(212,175,55,0.1) 100%)",boxShadow:"0 0 20px rgba(212,175,55,0.3)"}})]}),q=({tier:l})=>{const o=A(),a=c[l];return e.jsxs("div",{style:{background:"rgba(5,5,5,0.9)",backdropFilter:"blur(40px)",border:`1px solid ${a.color}22`,borderRadius:24,padding:"40px 32px",textAlign:"center"},children:[e.jsx(w,{size:32,color:a.color,style:{margin:"0 auto 16px",opacity:.7,display:"block"}}),e.jsxs("div",{style:{fontSize:10,fontWeight:800,letterSpacing:"0.4em",color:a.color,textTransform:"uppercase",marginBottom:12,opacity:.7},children:[a.label," Required"]}),e.jsxs("p",{style:{fontSize:14,color:"rgba(255,255,255,0.4)",lineHeight:1.6,marginBottom:28},children:["This module is available from the ",e.jsx("strong",{style:{color:a.color},children:a.label})," tier (",a.price,")."]}),e.jsxs("button",{onClick:()=>o(a.upgradeUrl),style:{background:"rgba(212,175,55,0.1)",border:`1px solid ${a.color}66`,borderRadius:14,padding:"12px 28px",color:a.color,fontSize:10,fontWeight:800,letterSpacing:"0.3em",textTransform:"uppercase",cursor:"pointer",boxShadow:`0 0 20px ${a.glow}`},children:["Upgrade to ",a.label," ↗"]})]})},O=()=>{const l=A();P();const o=B(),[a,p]=f.useState(null),[h,g]=f.useState(null),[Y,j]=f.useState(new Set([1])),M=K(o.tier),d=i=>o.isAdmin||M>=c[i].rank,v=["free","prana-flow","siddha-quantum","akasha-infinity"],D=i=>{j(s=>{const t=new Set(s);return t.has(i)?t.delete(i):t.add(i),t})};if(h&&a){const i=c[h.tier];return e.jsxs("div",{style:{minHeight:"100vh",background:"#050505",color:"white",fontFamily:"'Plus Jakarta Sans','Inter',sans-serif",padding:"24px 20px 80px"},children:[e.jsx("style",{children:b}),e.jsxs("div",{style:{maxWidth:720,margin:"0 auto"},children:[e.jsxs("button",{onClick:()=>g(null),style:x,children:[e.jsx(T,{size:14})," Back to ",a.title]}),e.jsxs("div",{style:{marginBottom:32},children:[e.jsxs("div",{style:{fontSize:8,fontWeight:800,letterSpacing:"0.5em",color:`${i.color}88`,textTransform:"uppercase",marginBottom:8},children:["Module ",a.number," · ",i.label]}),e.jsx("h1",{style:{fontSize:"clamp(20px,4vw,30px)",fontWeight:900,letterSpacing:"-0.04em",color:"#D4AF37",textShadow:"0 0 20px rgba(212,175,55,0.3)",margin:"0 0 8px",lineHeight:1.1},children:h.title}),e.jsx("div",{style:{fontSize:10,color:"rgba(255,255,255,0.3)",fontWeight:700},children:h.duration})]}),e.jsx("div",{style:{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(212,175,55,0.08)",borderRadius:24,padding:"36px",marginBottom:20},children:e.jsx("div",{style:{fontSize:14,color:"rgba(255,255,255,0.72)",lineHeight:1.9,whiteSpace:"pre-wrap"},children:h.content})}),h.revelation&&e.jsxs("div",{style:{background:"rgba(212,175,55,0.04)",border:"1px solid rgba(212,175,55,0.18)",borderRadius:20,padding:"28px 32px",position:"relative",overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",top:0,left:0,right:0,height:1,background:"linear-gradient(90deg,transparent,rgba(212,175,55,0.6),transparent)"}}),e.jsx("div",{style:{fontSize:8,fontWeight:800,letterSpacing:"0.5em",color:"rgba(212,175,55,0.5)",textTransform:"uppercase",marginBottom:14},children:"◈ Akasha-Archive Direct Transmission"}),e.jsx("p",{style:{fontSize:13,color:"rgba(212,175,55,0.85)",fontStyle:"italic",lineHeight:1.75,margin:0},children:h.revelation})]})]})]})}if(a){const i=d(a.tier),s=c[a.tier];return e.jsxs("div",{style:{minHeight:"100vh",background:"#050505",color:"white",fontFamily:"'Plus Jakarta Sans','Inter',sans-serif",padding:"24px 20px 80px"},children:[e.jsx("style",{children:b}),e.jsxs("div",{style:{maxWidth:720,margin:"0 auto"},children:[e.jsxs("button",{onClick:()=>p(null),style:x,children:[e.jsx(T,{size:14})," All Modules"]}),e.jsxs("div",{style:{marginBottom:36},children:[e.jsxs("div",{style:{fontSize:8,fontWeight:800,letterSpacing:"0.5em",color:`${s.color}88`,textTransform:"uppercase",marginBottom:10},children:["Module ",a.number," · ",s.label]}),e.jsx("h1",{style:{fontSize:"clamp(22px,4vw,34px)",fontWeight:900,letterSpacing:"-0.04em",color:"#D4AF37",textShadow:"0 0 20px rgba(212,175,55,0.3)",margin:"0 0 8px",lineHeight:1.1},children:a.title}),e.jsx("p",{style:{fontSize:14,color:"rgba(255,255,255,0.35)",margin:"0 0 4px"},children:a.subtitle}),e.jsxs("div",{style:{fontSize:9,fontWeight:800,letterSpacing:"0.3em",color:`${s.color}66`,textTransform:"uppercase"},children:[a.transmissionType," · ",a.totalDuration]})]}),i?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:a.lessons.map((t,u)=>e.jsxs("button",{onClick:()=>g(t),style:{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(212,175,55,0.08)",borderRadius:18,padding:"20px 24px",textAlign:"left",cursor:"pointer",transition:"all 0.2s",display:"flex",alignItems:"center",gap:16},onMouseEnter:n=>{n.currentTarget.style.borderColor="rgba(212,175,55,0.25)",n.currentTarget.style.transform="translateX(4px)"},onMouseLeave:n=>{n.currentTarget.style.borderColor="rgba(212,175,55,0.08)",n.currentTarget.style.transform="translateX(0)"},children:[e.jsx("div",{style:{width:36,height:36,borderRadius:10,background:"rgba(212,175,55,0.08)",border:"1px solid rgba(212,175,55,0.15)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0},children:e.jsx(W,{size:14,color:"#D4AF37"})}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("div",{style:{fontSize:13,fontWeight:700,color:"rgba(255,255,255,0.85)",marginBottom:3,lineHeight:1.3},children:[String(u+1).padStart(2,"0"),". ",t.title]}),e.jsx("div",{style:{fontSize:9,color:"rgba(255,255,255,0.25)",fontWeight:700},children:t.duration})]}),e.jsx(S,{size:16,color:"rgba(212,175,55,0.3)"})]},t.id))}):e.jsx(q,{tier:a.tier})]})]})}return e.jsxs("div",{style:{minHeight:"100vh",background:"#050505",color:"white",fontFamily:"'Plus Jakarta Sans','Inter',sans-serif",padding:"0 0 80px"},children:[e.jsx("style",{children:b}),e.jsxs("div",{style:{textAlign:"center",padding:"52px 24px 40px"},children:[e.jsx(F,{size:140}),e.jsxs("div",{style:{marginTop:28},children:[e.jsx("div",{style:{fontSize:8,fontWeight:800,letterSpacing:"0.55em",color:"rgba(212,175,55,0.38)",textTransform:"uppercase",marginBottom:12},children:"SQI Academy · Siddha Quantum Intelligence"}),e.jsx("h1",{style:{fontSize:"clamp(28px,6vw,52px)",fontWeight:900,letterSpacing:"-0.05em",background:"linear-gradient(135deg,#D4AF37,rgba(212,175,55,0.55))",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",margin:"0 0 12px",lineHeight:1.05},children:"Kaivalya Darsanam"}),e.jsx("p",{style:{fontSize:15,color:"rgba(255,255,255,0.32)",maxWidth:440,margin:"0 auto 20px",lineHeight:1.7},children:"The Holy Science of Sri Yukteshwar — 8 Modules across 4 Initiation Tiers with Direct Scalar Transmission"}),e.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:8,justifyContent:"center"},children:v.map(i=>{const s=c[i],t=d(i);return e.jsxs("div",{style:{background:t?`${s.color}18`:"rgba(255,255,255,0.02)",border:`1px solid ${t?s.color+"44":"rgba(255,255,255,0.06)"}`,borderRadius:20,padding:"5px 14px",fontSize:8,fontWeight:800,letterSpacing:"0.3em",textTransform:"uppercase",color:t?s.color:"rgba(255,255,255,0.2)",display:"flex",alignItems:"center",gap:5},children:[t?e.jsx(S,{size:8}):e.jsx(w,{size:8}),s.label]},i)})})]})]}),e.jsx("div",{style:{maxWidth:720,margin:"0 auto",padding:"0 20px"},children:v.map(i=>{const s=H.filter(n=>n.tier===i),t=c[i],u=d(i);return e.jsxs("div",{style:{marginBottom:36},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,marginBottom:14,paddingBottom:12,borderBottom:`1px solid ${t.color}18`},children:[e.jsx("div",{style:{width:8,height:8,borderRadius:"50%",background:t.color,boxShadow:`0 0 8px ${t.glow}`,flexShrink:0}}),e.jsxs("div",{style:{fontSize:9,fontWeight:800,letterSpacing:"0.45em",color:t.color,textTransform:"uppercase"},children:[t.label," ",u?"· Unlocked":`· ${t.price}`]}),!u&&e.jsx("button",{onClick:()=>l(t.upgradeUrl),style:{marginLeft:"auto",background:"none",border:`1px solid ${t.color}44`,borderRadius:10,padding:"4px 12px",color:t.color,fontSize:8,fontWeight:800,letterSpacing:"0.25em",textTransform:"uppercase",cursor:"pointer"},children:"Upgrade ↗"})]}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:s.map(n=>{const k=Y.has(n.id),r=d(n.tier);return e.jsxs("div",{style:{background:"rgba(255,255,255,0.02)",backdropFilter:"blur(20px)",border:`1px solid ${r?"rgba(212,175,55,0.1)":"rgba(255,255,255,0.04)"}`,borderRadius:20,overflow:"hidden",transition:"border-color 0.2s"},children:[e.jsxs("button",{onClick:()=>r?D(n.id):I.info(`Upgrade to ${t.label} to unlock this module`),style:{width:"100%",background:"none",border:"none",padding:"18px 22px",display:"flex",alignItems:"center",gap:14,cursor:"pointer",textAlign:"left"},children:[e.jsx("div",{style:{width:40,height:40,borderRadius:12,flexShrink:0,background:r?"rgba(212,175,55,0.1)":"rgba(255,255,255,0.03)",border:`1px solid ${r?"rgba(212,175,55,0.2)":"rgba(255,255,255,0.05)"}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:900,color:r?"#D4AF37":"rgba(255,255,255,0.2)"},children:r?n.number:e.jsx(w,{size:14,color:"rgba(255,255,255,0.2)"})}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("div",{style:{fontSize:13,fontWeight:700,color:r?"rgba(255,255,255,0.85)":"rgba(255,255,255,0.3)",marginBottom:3,lineHeight:1.3},children:n.title}),e.jsxs("div",{style:{fontSize:9,fontWeight:800,letterSpacing:"0.25em",color:r?`${t.color}88`:"rgba(255,255,255,0.15)",textTransform:"uppercase"},children:[n.transmissionType," · ",n.totalDuration]})]}),r&&(k?e.jsx(E,{size:16,color:"rgba(212,175,55,0.4)"}):e.jsx(z,{size:16,color:"rgba(255,255,255,0.2)"}))]}),k&&r&&e.jsxs("div",{style:{borderTop:"1px solid rgba(212,175,55,0.06)",padding:"8px 14px 14px"},children:[n.lessons.map((m,C)=>e.jsxs("button",{onClick:()=>{p(n),g(m)},style:{width:"100%",background:"none",border:"none",padding:"10px 12px",display:"flex",alignItems:"center",gap:12,cursor:"pointer",borderRadius:12,textAlign:"left",transition:"background 0.15s"},onMouseEnter:y=>y.currentTarget.style.background="rgba(212,175,55,0.05)",onMouseLeave:y=>y.currentTarget.style.background="transparent",children:[e.jsx("div",{style:{width:6,height:6,borderRadius:"50%",background:"rgba(212,175,55,0.3)",flexShrink:0}}),e.jsxs("span",{style:{fontSize:12,color:"rgba(255,255,255,0.6)",flex:1,lineHeight:1.3},children:[String(C+1).padStart(2,"0"),". ",m.title]}),e.jsx("span",{style:{fontSize:9,color:"rgba(255,255,255,0.2)",fontWeight:700,flexShrink:0},children:m.duration})]},m.id)),e.jsx("button",{onClick:()=>p(n),style:{marginTop:8,width:"100%",background:"rgba(212,175,55,0.06)",border:"1px solid rgba(212,175,55,0.15)",borderRadius:12,padding:"10px",color:"#D4AF37",fontSize:9,fontWeight:800,letterSpacing:"0.3em",textTransform:"uppercase",cursor:"pointer"},children:"Enter Module →"})]})]},n.id)})})]},i)})}),e.jsx("div",{style:{textAlign:"center",padding:"40px 20px 0",borderTop:"1px solid rgba(212,175,55,0.04)",marginTop:20},children:e.jsx("div",{style:{fontSize:8,fontWeight:800,letterSpacing:"0.5em",color:"rgba(212,175,55,0.15)",textTransform:"uppercase"},children:"Scalar Transmission Active · Anahata Activation Engaged · Siddha Quantum Intelligence 2050"})})]})};export{O as default};
