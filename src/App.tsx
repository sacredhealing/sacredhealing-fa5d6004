...
const MeditationPlaylists = React.lazy(() => import("./pages/MeditationPlaylists"));
const MeditationPlaylistDetail = React.lazy(() => import("./pages/MeditationPlaylistDetail"));
...
const AdminEmailAutomation = React.lazy(() => import("./pages/AdminEmailAutomation"));
...
const PractitionerCertPath = React.lazy(() => import("./pages/PractitionerCertPath"));
const PractitionerCertModule = React.lazy(() => import("./pages/PractitionerCertModule"));
...
const WaterAlchemyModule = React.lazy(() => import("./pages/WaterAlchemyModule"));
...
const PujaEducationModule = React.lazy(() => import("./pages/PujaEducationModule"));
...
const NarasimhaModule = React.lazy(() => import("./pages/NarasimhaModule"));
const RamayanaCodex = React.lazy(() => import("./pages/RamayanaCodex"));
const RamayanaCodexModule = React.lazy(() => import("./pages/RamayanaCodexModule"));
const HanumanCodex = React.lazy(() => import("./pages/HanumanCodex"));
const HanumanCodexModule = React.lazy(() => import("./pages/HanumanCodexModule"));
const SacredGeometry = React.lazy(() => import("./pages/SacredGeometry"));
const SacredGeometryModule = React.lazy(() => import("./pages/SacredGeometryModule"));
const AlchemicalShiva = React.lazy(() => import("./pages/AlchemicalShiva"));
const AlchemicalShivaModule = React.lazy(() => import("./pages/AlchemicalShivaModule"));
const SiddhaMedicineAcademy = React.lazy(() => import("./pages/SiddhaMedicineAcademy"));
...
const BreatharianModule = React.lazy(() => import("./pages/BreatharianModule"));
...
const VastuModule = React.lazy(() => import("./pages/VastuModule"));
const YagnyaModule = React.lazy(() => import("./pages/YagnyaModule"));
const YagnaModuleReader = React.lazy(() => import("./pages/YagnaModuleReader"));
const YoganandaCodex = React.lazy(() => import("./pages/YoganandaCodex"));
const YoganandaCodexModule = React.lazy(() => import("./pages/YoganandaCodexModule"));
...
const AirdropFarmingTracker = React.lazy(() => import("./pages/income-streams/AirdropFarmingTracker"));
...
const BrahmaMuhurta = React.lazy(() => import("@/pages/BrahmaMuhurta"));
const BrahmaMuhurtaModule = React.lazy(() => import("@/pages/BrahmaMuhurtaModule"));
...
const QuantumApothecaryGate = React.lazy(() => import("@/pages/QuantumApothecaryLanding").then(m => ({ default: m.QuantumApothecaryGate })));
...
const VirtualPilgrimage = React.lazy(() => import("./pages/VirtualPilgrimage"));
const VirtualPilgrimageLanding = React.lazy(() => import("./pages/VirtualPilgrimageLanding"));
...
const OjasRasayanaModule = React.lazy(() => import("./pages/OjasRasayanaModule"));
...
const DreamAcademyModule = React.lazy(() => import("./pages/DreamAcademyModule"));
const SiddhaMediumshipAcademy = React.lazy(() => import("./pages/SiddhaMediumshipAcademy"));
const MediumshipAcademyModule = React.lazy(() => import("./pages/MediumshipAcademyModule"));
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
          ...
          <Route path="/explore" element={<Explore />} />
                  ...
                  <Route path="/meditation-playlists" element={<MeditationPlaylists />} />
                  <Route path="/meditation-playlists/:id" element={<MeditationPlaylistDetail />} />
          ...
          <Route path="/profile" element={<Profile />} />
                ...
                <Route path="/income-streams/airdrop-farming" element={<AirdropFarmingTracker />} />
                  ...
                  <Route path="/certification-path" element={<PractitionerCertPath />} />
                  <Route path="/certification-path/module/:id" element={<PractitionerCertModule />} />
                  ...
                  <Route path="/thirumoolar-pranayama/module/:id" element={<PranayamaModule />} />
                  ...
                  <Route path="/puja-education/module/:id" element={<PujaEducationModule />} />
                  ...
                  <Route path="/narasimha/module/:id" element={<NarasimhaModule />} />
                  <Route path="/ramayana" element={<RamayanaCodex />} />
                  <Route path="/ramayana/kanda/:id" element={<RamayanaCodexModule />} />
                  <Route path="/hanuman-codex" element={<HanumanCodex />} />
                  <Route path="/hanuman-codex/section/:id" element={<HanumanCodexModule />} />
                  <Route path="/sacred-geometry" element={<SacredGeometry />} />
                  <Route path="/sacred-geometry/module/:id" element={<SacredGeometryModule />} />
                  <Route path="/shiva-lingam" element={<AlchemicalShiva />} />
                  <Route path="/shiva-lingam/module/:id" element={<AlchemicalShivaModule />} />
                  <Route path="/siddha-medicine" element={<SiddhaMedicineAcademy />} />
                  ...
                  <Route path="/breatharian-academy/module/:id" element={<BreatharianModule />} />
                  ...
                  <Route path="/vastu-curriculum/module/:id" element={<VastuModule />} />
                  <Route path="/yagna" element={<YagnyaModule />} />
                  <Route path="/yagna/module/:id" element={<YagnaModuleReader />} />
                  ...
                  <Route path="/sacred-water/module/:id" element={<WaterAlchemyModule />} />
              ...
              <Route path="/palm-oracle" element={<PalmOracle />} />
                  ...
                  <Route path="/brahma-muhurta/module/:id" element={<BrahmaMuhurtaModule />} />
                  ...
                  <Route path="/virtual-pilgrimage-landing" element={<VirtualPilgrimageLanding />} />
                  ...
                  <Route path="/ojas-rasayana/module/:id" element={<OjasRasayanaModule />} />
                  ...
                  <Route path="/dream-academy/module/:id" element={<DreamAcademyModule />} />
                  <Route path="/siddha-mediumship-academy" element={<SiddhaMediumshipAcademy />} />
                  <Route path="/siddha-mediumship-academy/module/:id" element={<MediumshipAcademyModule />} />
                ...
                <Route element={<AdminLayout />}>
                  ...
                  <Route path="/admin/email-automation" element={<AdminEmailAutomation />} />
