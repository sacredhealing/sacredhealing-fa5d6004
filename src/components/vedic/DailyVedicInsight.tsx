...
export const DailyVedicInsight: React.FC<DailyVedicInsightProps> = ({ tier }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 space-y-4">
      ...
      <Card className="border-2 border-primary/30 bg-gradient-to-br from-purple-500/5 to-blue-500/5">
        ...
        <CardContent className="p-4 sm:p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{dailyInfluence.planetaryInfluence}</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 sm:p-6 rounded-xl bg-green-500/10 border border-green-500/20">
              ...
              <ul className="space-y-2">
                {dailyInfluence.do.map((item, idx) => (
                  <li key={idx} className="text-base sm:text-lg text-muted-foreground flex items-start gap-2">
            ...
            <div className="p-4 sm:p-6 rounded-xl bg-red-500/10 border border-red-500/20">
              <div className="flex items-center gap-2 mb-3">
      ...
      {premiumGuidance && (
        <Card className="border-2 border-purple-500/30 bg-gradient-to-br from-purple-500/5 to-pink-500/5">
          ...
          <CardContent className="p-4 sm:p-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 sm:p-6 rounded-xl bg-blue-500/10 border border-blue-500/20">
                <h4 className="font-semibold text-base sm:text-lg mb-2 text-foreground flex items-center gap-2">
                  💼 Career Insights
                </h4>
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{premiumGuidance.career}</p>
              </div>
              <div className="p-4 sm:p-6 rounded-xl bg-pink-500/10 border border-pink-500/20">
                <h4 className="font-semibold text-base sm:text-lg mb-2 text-foreground flex items-center gap-2">
                  💕 Relationship Harmony
                </h4>
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{premiumGuidance.relationships}</p>
              </div>
              <div className="p-4 sm:p-6 rounded-xl bg-green-500/10 border border-green-500/20">
                <h4 className="font-semibold text-base sm:text-lg mb-2 text-foreground flex items-center gap-2">
                  🌿 Health Recommendations
                </h4>
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{premiumGuidance.health}</p>
              </div>
              <div className="p-4 sm:p-6 rounded-xl bg-amber-500/10 border border-amber-500/20">
                <h4 className="font-semibold text-base sm:text-lg mb-2 text-foreground flex items-center gap-2">
                  💰 Financial Timing
                </h4>
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{premiumGuidance.finances}</p>
              </div>
            </div>
      ...
      {masterReading && (
        <Card className="border-2 border-amber-500/30 bg-gradient-to-br from-amber-500/5 to-orange-500/5">
          ...
          <CardContent className="p-4 sm:p-6 space-y-5">
            {/* Soul Purpose */}
            <div className="p-4 sm:p-6 rounded-xl bg-purple-500/10 border border-purple-500/20">
              <h4 className="font-semibold text-base sm:text-lg mb-2 text-foreground flex items-center gap-2">
                🔮 Soul Purpose Analysis
              </h4>
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{masterReading.soulPurpose}</p>
            </div>

            {/* Karma Patterns */}
            <div className="p-4 sm:p-6 rounded-xl bg-indigo-500/10 border border-indigo-500/20">
              <h4 className="font-semibold text-base sm:text-lg mb-2 text-foreground flex items-center gap-2">
                ⚖️ Karma Pattern Insights
              </h4>
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{masterReading.karmaPatterns}</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 sm:p-6 rounded-xl bg-green-500/10 border border-green-500/20">
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{masterReading.strengths}</p>
              </div>
              <div className="p-4 sm:p-6 rounded-xl bg-red-500/10 border border-red-500/20">
                <h4 className="font-semibold text-base sm:text-lg mb-2 text-foreground flex items-center gap-2">
                  🎯 Challenge Mapping
                </h4>
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{masterReading.challenges}</p>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6 rounded-xl bg-blue-500/10 border border-blue-500/20">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{masterReading.timingPeaks}</p>
            </div>
            ...
            <div className="p-4 sm:p-6 rounded-xl bg-amber-500/10 border border-amber-500/20">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{masterReading.birthChartSummary}</p>
            </div>
