      ...
      <div className="grid grid-cols-2 gap-3">
        {breathingJourneys.map((journey, index) => (
          <Link key={journey.id} to={journey.route}>
            <motion.div
              className="flex flex-col items-center gap-2 p-4 rounded-xl bg-background/40 border border-border/30 hover:border-secondary/40 hover:bg-background/60 transition-all group cursor-pointer"
