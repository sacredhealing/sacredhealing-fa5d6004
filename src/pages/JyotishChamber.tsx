...
const JYOTISH_MODULES = [
  ...
  { id:4, tier:'free', title:'The 12 Bhāvas (Houses)', sub:'The Map of Your Life's Karma', dur:'20 min', topics:['Four aims: Dharma, Artha, Kāma, Moksha','Kendra (1,4,7,10) — pillars of existence','Trikona (1,5,9) — dharmic trinity','Dusthāna (6,8,12) — transformation houses','Each house complete meaning — 1st through 12th'] },
  { id:5, tier:'free', title:'27 Nakshatra Awakening', sub:'Lunar Mansions — Your Soul's Original Frequency', dur:'25 min', topics:['What is a Nakshatra — Moon's 27 daily mansions','Your birth star — how to find it and what it means','Nakshatra deity, ruling planet, symbol','All 27 Nakshatras from Ashvinī to Revatī','Nakshatra-specific mantras and practices'] },
  ...
  { id:21, tier:'siddha', title:'Medical Jyotish', sub:'Body, Disease & Healing Through the Chart', dur:'65 min', topics:['Each planet's body parts and organ systems','Dusthāna analysis — disease, chronic, hospitalization','Longevity assessment methods','Ayurvedic dosha from Lagna and Moon'] },
  ...
  { id:31, tier:'akasha', title:'Spirituality, Moksha & the Chart of Liberation', sub:'Reading the Soul's Journey Toward Liberation', dur:'70 min', topics:['Moksha indicators in the chart','Reading charts of Siddha masters','Timing of spiritual awakening','Past-life indicators through D-60 and Ketu'] },
...
const LEXICON = [
  ...
  { term:'Vimshottari Dasha', skt:'विंशोत्तरी', cat:'Dasha', m:'The 120-year planetary timing system used in Vedic astrology. Based on the Moon's Nakshatra at birth. The most widely used and reliable predictive timing system in Jyotish.' },
  ...
  { term:'Atmakaraka', skt:'आत्मकारक', cat:'Jaimini', m:'The planet at the highest degree in your natal chart (in the Jaimini system). It represents your soul's core lesson and primary mission in this incarnation — the most important planet for spiritual reading.' },
  ...
  { term:'Karakamsha', skt:'कारकांश', cat:'Jaimini', m:'The sign occupied by the Atmakaraka (soul planet) in the Navamsha chart. This is the most important point in Jaimini Jyotish — it reveals the soul's ultimate dharmic purpose and spiritual direction.' },
];
