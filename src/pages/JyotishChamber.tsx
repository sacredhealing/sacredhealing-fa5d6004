...
const JYOTISH_MODULES = [
  ...
  { id:4, tier:'free', title:'The 12 Bhāvas (Houses)', sub:'The Map of Your Life Karma', dur:'20 min', topics:['Four aims: Dharma, Artha, Kama, Moksha','Kendra (1,4,7,10) — pillars of existence','Trikona (1,5,9) — dharmic trinity','Dusthana (6,8,12) — transformation houses','Each house complete meaning — 1st through 12th'] },
  { id:5, tier:'free', title:'27 Nakshatra Awakening', sub:'Lunar Mansions — Soul Original Frequency', dur:'25 min', topics:['What is a Nakshatra — the Moon 27 daily mansions','Your birth star — how to find it and what it means','Nakshatra deity, ruling planet, symbol','All 27 Nakshatras from Ashvini to Revati','Nakshatra-specific mantras and practices'] },
