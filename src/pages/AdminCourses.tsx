...
const categories = ['healing', 'yoga', 'meditation', 'spiritual', 'wellness', 'mindfulness'];
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Create and manage courses & lessons</p>
          </div>
        </div>
            ...
            <Card className="p-6">
              ...
              <form onSubmit={handleCreateCourse} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label>Price (SHC)</Label>
                    <Input
                      type="number"
                      value={courseForm.price_shc}
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                ...
                                {lesson.is_preview && <span className="text-green-500 ml-2">Preview</span>}
                              </p>
                            </div>
                          </div>
                          <Button
