...
const SITE_DB: Record<string, { title: string; primaryBenefit: string; instruction: string; experience: string; signature: string; intensityLabel?: string; bio?: string }> = {
  giza: { title: 'Pyramid of Giza', primaryBenefit: 'Spinal Alignment', instruction: 'Visualize a golden pillar of light passing through your spine, root to crown.', experience: 'A sense of vertical alignment and structural integrity.', signature: 'GIZA_TORSION' },
  babaji: { title: "Mahavatar Babaji's Cave", primaryBenefit: 'Kriya DNA Activation', instruction: "Focus on the Third Eye. Breathe up and down the spine in a spiral.", experience: 'Deep stillness, spinal heat, timeless presence.', signature: 'KRIYA_SYNC' },
  arunachala: { title: 'Arunachala', primaryBenefit: 'Self-Inquiry & Silence', instruction: "Rest in the I AM presence. Let all thoughts dissolve.", experience: 'The mind becoming quiet. The heart expanding.', signature: 'STILLNESS_FIELD' },
  samadhi: { title: 'Samadhi Portal', primaryBenefit: 'Aura Repair', instruction: 'Merge your awareness with the infinite void.', experience: 'A feeling of dissolving into the infinite. The aura resets.', signature: 'AURA_REPAIR' },
  machu_picchu: { title: 'Machu Picchu', primaryBenefit: 'Solar Vitality & Manifestation', instruction: 'Breathe the golden sun directly into your Solar Plexus.', experience: 'A surge of vitality and manifestation clarity.', signature: 'SOLAR_SYNC' },
  lourdes: { title: 'Lourdes Grotto', primaryBenefit: 'Physical Restoration', instruction: 'Imagine pure healing water flowing through every cell.', experience: 'A soothing, cooling, cleansing sensation.', signature: 'WATER_RESONANCE' },
  mansarovar: { title: 'Lake Mansarovar', primaryBenefit: 'Mental Detox & Crown Purification', instruction: 'Visualize crystal clear Himalayan water pouring through the Crown chakra.', experience: 'Mental clarity. Pure, high-altitude air in the mind.', signature: 'MENTAL_DETOX' },
  zimbabwe: { title: 'Great Zimbabwe', primaryBenefit: 'Ancestral Strength', instruction: "Feel thousands of years of lineage grounding you into the Earth's core.", experience: 'Ancestral support, solid foundation, deep belonging.', signature: 'ANCESTRAL_STRENGTH' },
  shasta: { title: 'Mount Shasta', primaryBenefit: 'Light-Body Activation', instruction: 'Visualize a violet flame surrounding the entire body.', experience: "A cool, breezy feeling in the aura.", signature: 'LIGHT_BODY_SYNC' },
  luxor: { title: 'Luxor Temples', primaryBenefit: 'Ka Body & Healer Activation', instruction: 'Breathe warm alchemical gold light into the palms of the hands.', experience: 'Heat and tingling in the hands. Warm sensation in the body.', signature: 'KA_ACTIVATION' },
  uluru: { title: 'Uluru', primaryBenefit: 'Dreamtime & Ancestral DNA', instruction: "Sink deep into the red earth. Feel the Dreamtime consciousness rising.", experience: "Intense grounding. Being held by the entire Earth.", signature: 'DREAMTIME_SYNC' },
  kailash_13x: { title: 'Mount Kailash 13X Awakening', primaryBenefit: 'Moksha / Total Purification', instruction: 'Breathe in a 7.83-second cycle. Allow all karmic layers to dissolve into the void.', experience: 'Shimmering violet clarity. Total purification. Liberation.', signature: 'KAILASH_SHIMMER', bio: 'The Axis Mundi. Strips karmic imprints and 13x amplifies any mantra or healing audio.' },
  glastonbury: { title: 'Glastonbury (Avalon)', primaryBenefit: 'Heart-Gate Activation', instruction: 'Open the heart gate. Breathe emerald light into the chest.', experience: 'Heart-Gate activation. Emotional restoration.', signature: 'AVALON_MIST', bio: 'Heart-Gate activation and emotional restoration. Heals relationships and grief.' },
  sedona: { title: 'Sedona Vortex', primaryBenefit: 'Psychic Vision Activation', instruction: "Align with the magnetic spiral. Focus at the Third Eye.", experience: 'Magnetic spiral activation. Heightened psychic vision.', signature: 'SEDONA_VORTEX', bio: 'Spins out mental fog and activates dormant psychic abilities.' },
  titicaca: { title: 'Lake Titicaca', primaryBenefit: 'Creative Rebirth & Manifestation', instruction: 'Connect to the sacral center. Solar gold light ripples into the lower belly.', experience: 'Solar gold ripples. Creative energy surging.', signature: 'SOLAR_RIPPLES', bio: 'Activates the sacral center for creative rebirth and manifestation.' },
  amritsar: { title: 'Golden Temple — Harmandir Sahib', primaryBenefit: 'Selfless Service (Seva) & Abundance', instruction: 'Visualize wading into still, golden water. Liquid gold light rises into your heart. Serve without expectation.', experience: 'A warm liquid-gold sensation flooding the chest. Deep equality and calm.', signature: 'AMRIT_SAROVAR', bio: 'Clears poverty consciousness. Aligns the heart with selfless giving. Abundance follows.' },
  ...
  shirdi: { title: 'Shirdi Sai Baba Dhuni Samadhi', primaryBenefit: 'Total Surrender & Nervous System Protection', instruction: 'Visualize the Dhuni — ancient sacred fire. Offer every fear into the flame. Repeat: Shraddha. Saburi.', experience: 'A warm weight settling on the shoulders. Fear dissolving. Deep protection.', signature: 'DHUNI_FLAME', intensityLabel: 'Faith & Patience (Shraddha / Saburi)', bio: 'Drastically lowers cortisol. Creates a Faith Shield for the nervous system.' },
  vrindavan_krsna: { title: 'Ancient Vrindavan (Era of Krishna)', primaryBenefit: 'Premananda — Supreme Bliss', instruction: 'Rest in the peacock-blue field of divine play. Allow falling lotus petals to carry you.', experience: 'Supreme bliss arising from love. Spontaneous joy.', signature: 'FALLING_LOTUS', bio: 'Infuses the home with Supreme Bliss. Heals through joy and divine love.' },
  ayodhya_rama: { title: 'Ancient Ayodhya (Era of Rama & Hanuman)', primaryBenefit: 'Dharma & Spiritual Fortress', instruction: "Invoke the golden shield of dharma. Feel Rama and Hanuman anchoring protection.", experience: 'Golden shield aura forming. Divine protection established.', signature: 'GOLDEN_SHIELD_AURA', bio: 'The ultimate Spiritual Fortress. Provides 24/7 protection and re-establishes Dharma.' },
  lemuria: { title: 'Lemuria (Mu)', primaryBenefit: 'Maternal Healing & Inner Child Safety', instruction: 'Sink into warm turquoise waters. Allow maternal energy to restore the heart.', experience: 'Tropical soft warmth. Deep emotional safety.', signature: 'TROPICAL_SOFT_GLOW', bio: 'Maternal and Ancestral healing. Provides deep emotional safety.' },
  atlantis: { title: 'Atlantis (Poseidia)', primaryBenefit: 'Mental Clarity & High-Tech Logic', instruction: 'Merge with deep navy crystal light. Let liquid light geometry flow through the brain.', experience: 'Liquid light geometry. Crystal clarity. Mental breakthroughs.', signature: 'LIQUID_LIGHT_GEOMETRY', bio: 'Clears brain fog and enhances high-tech logic and analytical brilliance.' },
  ...
  lyra: { title: 'Lyra (The Felines)', primaryBenefit: 'Original Sound — Frequency of Creation', instruction: 'Merge with pure white light. This is the original sound. Become it.', experience: 'White light fire. The original creative frequency.', signature: 'WHITE_LIGHT_FIRE', bio: 'The Original Sound and Frequency of Creation.' },
};
...
function loadAnchorSafe(): { siteId: string; intensity: number; mode: string; anchored: boolean } {
  try {
    ...
    if (r) {
      ...
      const siteId = isKnownSiteId(p.siteId) ? p.siteId : DEFAULT_SITE_ID;
      const mode = isKnownMode(p.mode) ? p.mode : 'INTEGRATION';
      let intensity = 100;
      if (typeof p.intensity === 'number' && Number.isFinite(p.intensity)) {
        intensity = Math.min(100, Math.max(0, Math.round(p.intensity)));
      }
      return {
        siteId,
        intensity,
  ...
  return { siteId: DEFAULT_SITE_ID, intensity: 100, mode: 'INTEGRATION', anchored: false };
}
...
function getSiteGradient(id: string, color: string, intensity: number): string {
  const opacityHex = Math.min(255, Math.round(intensity * 0.18)).toString(16).padStart(2, '0');
  const gradients: Record<string, string> = {
    kailash_13x: 'radial-gradient(ellipse 120% 80% at 50% 100%, #1a0533 0%, #2d0d5c 35%, #050505 100%)',
    amritsar: 'radial-gradient(ellipse 120% 60% at 50% 100%, #1a1000 0%, #2d1f00 30%, #050505 100%)',
    ayodhya_rama: 'radial-gradient(ellipse 100% 70% at 50% 80%, #2d1000 0%, #4a1e00 35%, #050505 100%)',
    vrindavan_krsna: 'radial-gradient(ellipse 110% 70% at 50% 60%, #001428 0%, #001e3d 35%, #050505 100%)',
    glastonbury: 'radial-gradient(ellipse 110% 70% at 50% 70%, #001a0a 0%, #003318 35%, #050505 100%)',
    giza: 'radial-gradient(ellipse 120% 80% at 50% 100%, #0d0900 0%, #1a1200 35%, #050505 100%)',
    sedona: 'radial-gradient(ellipse 110% 70% at 50% 80%, #2a0800 0%, #4a1200 35%, #050505 100%)',
    pleiades: 'radial-gradient(ellipse 120% 90% at 50% 40%, #00101e 0%, #001828 35%, #050505 100%)',
    sirius: 'radial-gradient(ellipse 120% 80% at 50% 40%, #000820 0%, #000d30 35%, #050505 100%)',
    arcturus: 'radial-gradient(ellipse 110% 80% at 50% 40%, #0d0020 0%, #1a0035 35%, #050505 100%)',
    mauritius: 'radial-gradient(ellipse 110% 70% at 50% 40%, #0a0a00 0%, #141400 35%, #050505 100%)',
    shirdi: 'radial-gradient(ellipse 100% 80% at 50% 100%, #1a0800 0%, #2a1200 35%, #050505 100%)',
  };
  const base = gradients[id] ?? `radial-gradient(ellipse 100% 70% at 50% 60%, ${color}${opacityHex} 0%, #050505 70%)`;
  return base;
}
...
function TempleHomeInner() {
  ...
  const bgGradient = getSiteGradient(selectedSite, currentSite.color, auraIntensity);
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white relative overflow-hidden">
      {/* Background */}
      <div className="fixed inset-0 z-0" style={{ background: bgGradient, transition: 'all 2s ease' }} />
      <div className="fixed inset-0 z-0" style={{ background: `radial-gradient(ellipse 60% 30% at 50% 15%, ${currentSite.color}12 0%, transparent 65%)`, transition: 'all 1.5s ease' }} />
      {selectedSite === 'amritsar' && <div className="fixed bottom-0 left-0 right-0 h-32 z-0" style={{ background: 'linear-gradient(to top, rgba(212,175,55,0.15) 0%, transparent 100%)' }} />}
      {selectedSite === 'shirdi' && <div className="fixed bottom-0 left-0 right-0 h-48 z-0" style={{ background: 'radial-gradient(ellipse 80% 40% at 50% 100%, rgba(255,107,53,0.12) 0%, transparent 70%)' }} />}
      {selectedSite === 'kailash_13x' && <div className="fixed top-0 left-0 right-0 h-32 z-0" style={{ background: 'linear-gradient(180deg, rgba(123,97,255,0.1) 0%, transparent 100%)' }} />}
        ...
        {infoSite && infoSiteId && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-end justify-center p-4">
            ...
            <motion.div initial={{ y: 40, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 40, opacity: 0 }} transition={{ type: 'spring', damping: 25, stiffness: 300 }}
              className="relative w-full max-w-md rounded-[32px] p-6 space-y-4 max-h-[80vh] overflow-y-auto" style={{ background: 'rgba(8,4,2,0.95)', backdropFilter: 'blur(60px)', border: '1px solid rgba(212,175,55,0.15)' }}>
