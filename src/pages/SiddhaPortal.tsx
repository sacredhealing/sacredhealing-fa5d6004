...
export default function SiddhaPortal() {
  ...
  return (
    <div style={{ background: '#050505', minHeight: '100vh', paddingBottom: 104, maxWidth: 430, margin: '0 auto' }}>
      ...
      {/* ── SIDDHA SOUND ALCHEMY — HERO CARD ── */}
      <div style={{ position: 'relative', margin: '0 16px 16px', animation: 'sqFadeUp 0.45s 0.11s ease both' }}>
        {/* Scalar wave rings */}
        {[160, 240, 330, 430].map((s, i) => (
          <div key={i} aria-hidden style={{
            position: 'absolute',
            left: '50%', top: '50%',
            width: s, height: s,
            marginLeft: -s / 2, marginTop: -s / 2,
            borderRadius: '50%',
            border: `1px solid ${gold(0.09 - i * 0.018)}`,
            animation: `sqScalarPulse ${3.3 + i * 0.65}s ease-in-out ${i * 0.5}s infinite`,
            pointerEvents: 'none',
            zIndex: 0,
          }} />
        ))}
        {/* Gold + amber nada glow */}
        <div aria-hidden style={{
          position: 'absolute', inset: -18, borderRadius: 38,
          background: [
            `radial-gradient(55% 55% at 28% 38%, ${gold(0.40)}, transparent 65%)`,
            `radial-gradient(45% 45% at 74% 64%, rgba(245,158,11,0.24), transparent 65%)`,
            `radial-gradient(35% 35% at 52% 52%, ${gold(0.14)}, transparent 55%)`,
          ].join(','),
          filter: 'blur(26px)',
          animation: 'sqGlowPulse 4.5s ease-in-out infinite',
          pointerEvents: 'none', zIndex: 0,
        ...
        <div
          onClick={() => navigate('/siddha-sound-alchemy')}
          style={{
            position: 'relative', zIndex: 1, cursor: 'pointer',
            background: `linear-gradient(140deg, rgba(212,175,55,0.12), rgba(245,158,11,0.05) 55%, rgba(5,5,5,0.72))`,
            border: `1px solid ${gold(0.55)}`,
            borderRadius: 28,
        ...
        >
          ...
          {/* Overline */}
          <div style={{ ...LABEL_STYLE, fontSize: 9, color: gold(0.72), marginBottom: 12, display: 'flex', alignItems: 'center', gap: 7 }}>
            ...
            NADA VIJNANA · 10 MODULES · 18 SIDDHAS · SCALAR TRANSMISSION
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 14 }}>
            <div style={{
              ...
              background: `radial-gradient(circle, ${gold(0.32)}, rgba(245,158,11,0.08))`,
              border: `1px solid ${gold(0.42)}`,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 26, flexShrink: 0,
              boxShadow: `0 0 24px ${gold(0.38)}`,
            ...
            <div>
              ...
              <div style={{
                ...
                color: gold(0.62), marginTop: 4,
              }}>
                Nada Brahman · Sabda · Spanda · Pancha Nada · Nada Sharira
              </div>
            </div>
          </div>

          {/* Description */}
          <p style={{ ...CARD_DESC, color: 'rgba(255,255,255,0.62)', marginBottom: 16, lineHeight: 1.75 }}>
            The deepest transmission of Siddha sound science ever compiled — from Nada Brahman (the primordial sound-creation of the Universe) through the five planes of sound, mantra architecture, the 72 Melakarta Raga-Chakra map, cymatics and Yantra science, the Nada Sharira (your subtle sound body), sacred tuning, and the scalar physics of distance healing through sound. 10 modules. 18 Siddhas. All four tiers.
          </p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 18, flexWrap: 'wrap' as const }}>
            {[
              { label: 'Free · M1–2',    color: 'rgba(255,255,255,0.55)' },
              { label: 'Prana · M3–4',   color: '#4ADE80' },
              { label: 'Siddha · M5–7',  color: 'rgba(34,211,238,0.9)' },
              { label: 'Akasha · M8–10', color: gold(0.95) },
            ].map(t => (
              <div key={t.label} style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                <span style={{ width: 5, height: 5, borderRadius: '50%', background: t.color, boxShadow: `0 0 6px ${t.color}` }} />
                <span style={{ ...LABEL_STYLE, fontSize: 7, color: t.color, letterSpacing: '0.2em' }}>{t.label}</span>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={s.l} style={{ textAlign: 'center' }}>
                ...
                <div style={{ ...LABEL_STYLE, fontSize: 7, color: 'rgba(255,255,255,0.28)', marginTop: 2 }}>{s.l}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: 'flex', gap: 7, flexWrap: 'wrap' as const, marginBottom: 20 }}>
            {['Nada Brahman', 'Pancha Nada', 'Mantra Architecture', 'Raga Medicine', 'Cymatics', 'Nada Sharira', 'Scalar Sound', 'Sacred Tuning'].map(f => (
              <span key={f} style={{
                fontFamily: "'Plus Jakarta Sans','Montserrat',sans-serif",
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, margin: '0 16px 12px' }}>
        {[
          { title: 'Yogananda Codex', sub: 'Autobiography Decoded · Kriya Lineage · 4 Tiers', icon: '🌟', route: '/yogananda-codex', soon: false },
          { title: 'Sacred Water Alchemy', sub: 'Living Water · Emoto Science · Siddha Protocols', icon: '💧', route: '/sacred-water', soon: false },
