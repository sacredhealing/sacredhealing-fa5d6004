...
const PranaFlow: React.FC = () => {
  ...
  const includesList = [
    { title: 'Full Vedic Jyotish + Guru Chat', desc: 'Complete natal chart, daily planetary influences, Dasha timeline, Soul Blueprint, Yoga Activations — and direct chat access to the Bhrigu Nandi Nadi intelligence, reading your chart the way Bhrigu Rishi\'s own tradition would. Not a generic horoscope app. Ask anything, anytime.', badge: 'Full Access' },
