...
export default function CreativeSoulMeditationTool() {
  ...
  const commenceAlchemy = useCallback(async () => {
    ...
    try {
      ...
      // Re-apply volumes AFTER start Ã¢ÂÂ startXxx resets gain from stale state
        ...
        <div className="sqm-inner">
          ...
          <div className="grid grid-cols-2 gap-2 mb-5">
            {[
              ...
              { id: 'scalar',  icon: 'Ã¢ÂÂ',  label: 'Scalar Wave Tech', sub: `Nadi Scan ÃÂ· Resonators ÃÂ· SQI${scalarBlendHz ? ` ÃÂ· ${scalarBlendHz}Hz Active` : ''}` },
            ].map(t => (
