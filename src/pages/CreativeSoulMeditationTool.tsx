...
const meditationStyles = [
  { id: 'peaceful', name: 'Peaceful Ambient', description: 'Soft, calming atmosphere' },
  { id: 'nature', name: 'Nature Sounds', description: 'Forest, rain, ocean waves' },
  { id: 'cosmic', name: 'Cosmic Journey', description: 'Space-like ethereal sounds' },
  { id: 'tibetan', name: 'Tibetan Bowls', description: 'Traditional singing bowls' },
  { id: 'crystal', name: 'Crystal Healing', description: 'Crystal bowl harmonics' },
  { id: 'chakra', name: 'Chakra Balancing', description: '7 chakra frequencies' },
  { id: 'sleep', name: 'Deep Sleep', description: 'Delta wave inducing' },
  { id: 'focus', name: 'Focus & Clarity', description: 'Alpha wave enhancement' },
  { id: 'anxiety', name: 'Anxiety Relief', description: 'Stress-reducing tones' },
  { id: 'manifestation', name: 'Manifestation', description: 'Abundance frequencies' },
  { id: 'kundalini', name: 'Kundalini Rising', description: 'Energy awakening' },
  { id: 'shamanic', name: 'Shamanic Journey', description: 'Drum-based rhythms' },
  { id: 'zen', name: 'Zen Garden', description: 'Minimalist Japanese style' },
  { id: 'angelic', name: 'Angelic Choir', description: 'Heavenly vocal harmonics' },
  { id: 'earth', name: 'Earth Grounding', description: 'Grounding bass frequencies' },
];

const healingFrequencies = [
  { hz: 174, name: 'Pain Relief', color: 'from-red-500 to-red-600' },
  { hz: 285, name: 'Tissue Healing', color: 'from-orange-500 to-orange-600' },
  { hz: 396, name: 'Liberation', color: 'from-yellow-500 to-yellow-600' },
  { hz: 417, name: 'Change', color: 'from-green-500 to-green-600' },
  { hz: 528, name: 'DNA Repair', color: 'from-teal-500 to-teal-600' },
  { hz: 639, name: 'Relationships', color: 'from-blue-500 to-blue-600' },
  { hz: 741, name: 'Expression', color: 'from-indigo-500 to-indigo-600' },
  { hz: 852, name: 'Intuition', color: 'from-purple-500 to-purple-600' },
  { hz: 963, name: 'Divine', color: 'from-violet-500 to-violet-600' },
];
