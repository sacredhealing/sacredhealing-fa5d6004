...
export default function BrahmaMuhurta() {
  ...
  const { courses, progressByModuleId, stats, loading: loadingData, error: loadError } = useBrahmaMuhurtaProgress(membershipReady);
    ...
    <div style={{ minHeight: '100vh', background: '#050505', color: 'rgba(255,255,255,0.9)', paddingBottom: 104 }}>
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '32px 16px 0' }}>
        ...
        <CourseSyllabus
          ...
          courseTitle="Brahma Muhurta — The Creator's Hour"
          ...
          onLessonClick={(lessonId, locked) => {
            if (locked) {
              ...
              navigate(`/brahma-muhurta/module/${lessonId}`);
            }
          }}
        />
