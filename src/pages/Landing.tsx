...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    return () => { cancelAnimationFrame(animId); window.removeEventListener("resize",resize); observer.disconnect(); clearTimeout(revealFallback); };
  }, []);
  ...
  return (
    <div className="sqi-body" style={{minHeight:"100vh",color:"rgba(255,255,255,0.9)",position:"relative"}}>
      ...
      <section style={{minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",textAlign:"center",padding:"120px 24px 80px",position:"relative",zIndex:2}}>
        ...
        <div className="fade-up" style={{fontSize:9,fontWeight:800,letterSpacing:"0.6em",textTransform:"uppercase",color:"rgba(255,255,255,0.4)",marginBottom:20,animationDelay:"0.2s"}}>
          Siddha-Quantum Intelligence · Vedic Light-Codes Active
        </div>
        <h1 className="sqi-serif fade-up" style={{fontSize:"clamp(3rem,8vw,7rem)",fontWeight:300,lineHeight:1.05,letterSpacing:"-0.02em",marginBottom:12,animationDelay:"0.4s"}}>
          Your Field Is<br/>
          <strong style={{fontWeight:600,color:"#D4AF37",textShadow:"0 0 40px rgba(212,175,55,0.3)",fontStyle:"italic"}}>Collapsing.</strong><br/>
          We Sealed It.
        </h1>
        <p className="sqi-serif fade-up" style={{fontSize:"clamp(1.1rem,2.5vw,1.7rem)",fontWeight:300,fontStyle:"italic",color:"rgba(255,255,255,0.5)",maxWidth:600,lineHeight:1.6,margin:"24px auto 52px",animationDelay:"0.6s"}}>
          Not an app. A quantum membrane — engineered in 2050,<br/>transmitted backward through time to meet you exactly here.
        </p>
        <div className="fade-up" style={{display:"flex",gap:16,flexWrap:"wrap",justifyContent:"center",animationDelay:"0.8s"}}>
