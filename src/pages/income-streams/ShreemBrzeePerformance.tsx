...
const WHALES = [
  { label: 'Cupsey',        addr: 'GJRs4FwHtemZ5ZE9x3FNvJ8TMwitKTh21yxdRPqn7npE', vip: true,  note: 'Verified micro-cap sniper' },
  { label: 'Heyitsyolo',    addr: 'Av3xWHJ5EsoLZag6pr7LKbrGgLRTaykXomDD5kBhL9YQ', vip: true,  note: 'FOMO.fund leaderboard trader' },
  { label: 'Remusofmars',   addr: 'BCrTEXmWutwPz8qv6w1S5gDbaLnSLpXKM5kSGVWyyfxu', vip: true,  note: '$370→$1.2M WHITEWHALE conviction entry' },
  { label: 'Orange',        addr: '96gYZGLnJYVFmbjzopPSU6QiEV5fGqZNyN9nmNhvrZU5', vip: false, note: 'Pump.fun launch hunter' },
  { label: 'Shreem Brzee',  addr: 'HL3FZ8XWnLnn1HuktmgpNRyFRjuAxWbXNQVj5fPPzZwt', vip: false, note: 'High win-rate scalper' },
  { label: 'Lenion',        addr: 'DNfuF1L62WWyW3pNakVkyGGFzVVhj4Yr52jSmdTyeBHm', vip: false, note: 'Meme coin specialist' },
  { label: 'Boredboar',     addr: 'gasAx5Y917MYdmdnwiomwYDhmDKNGDJnN1MmEbxVdVw',  vip: false, note: 'Aggressive entry style' },
  { label: 'Hades',         addr: 'HdxkiXqeN6qpK2YbG51W23QSWj3Yygc1eEk2zwmKJExp', vip: false, note: 'High-frequency trader' },
  { label: 'Kubera 72',     addr: 'AAvdewt71kkde2segr6gYnNemhNLfokyZpdzwwi4yDfm',  vip: false, note: 'Top leaderboard wallet' },
  { label: 'Brzee God',     addr: 'JD38n7ynKYcgPpF7k1BhXEeREu1KqptU93fVGy3S624k', vip: false, note: 'Sovereign copy target' },
  { label: 'GBack',         addr: '9VPozuXeRi8FACAePmg8ckdSZkbeZfTJc6SqUDcKsUKm', vip: false, note: 'Consistent performer' },
  { label: 'Tuna',          addr: 'GjK3S2ZgxTVFEkxg43JE8eC1tbztWCseBYyZ8o8sg9f', vip: false, note: 'Active meme trader' },
  { label: 'Fireball',      addr: 'AgmLJBMDCqWynYnQiPCuj9ewsNNsBJXyzoUhD9LJzN51', vip: false, note: 'Fast entry sniper' },
  { label: 'Hachjdn',       addr: 'EqgZsS7GhtW9swJt1C4iYy5GVZgvsMVQK6nvBdPhRBmS', vip: false, note: 'Leaderboard regular' },
  { label: 'Crypto Circle', addr: '5DzUSNro5kfNwB2dxkkTTYrPDXAi6vRnjf4mAN2an7Gc', vip: false, note: 'Community whale' },
  { label: 'Crocodile',     addr: '2cBedD94RXYSEhEfQJUyLaNaHB4PVoL9z7LK6Mu11sJv', vip: false, note: 'Patient hunter' },
  { label: 'Snow Spirit',   addr: '4ev7HVsESzFxKqGzQxJ5mzSM6NstGCTQXKXT8yHiaRP3', vip: false, note: 'Consistent PnL' },
  { label: 'Cented',        addr: 'CyaE1VxvBrahnPWkqm5VsdCvyS2QmNht2UFrKJHga54o', vip: false, note: 'Active swing trader' },
  { label: 'The Grande',    addr: 'Gygj9QQby4j2jryqyqBHvLP7ctv2SaANgh4sCb69BUpA', vip: false, note: 'Large position trader' },
  { label: 'A Milly',       addr: 'Fv9w9TQnqhzUszbDGRFPPkXwu5iJWG9VytmMJTCTnjxW', vip: false, note: 'High-value trader' },
  { label: 'J2ANNaq',       addr: 'J2ANNaq4uUk3iUGoNijKCwXTReGLyg2yQpGcAZjzyBZG', vip: false, note: 'Tracked wallet' },
];
