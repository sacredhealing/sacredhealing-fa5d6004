...
import { Play, Pause, Sparkles, ArrowLeft, Loader2, Globe, Lock, ListPlus } from 'lucide-react';
...
import { AddToMeditationPlaylistSheet } from '@/components/meditation/AddToMeditationPlaylistSheet';
...
const MeditationRowSQI: React.FC<{
  ...
  return (
    ...
    >
      <AddToMeditationPlaylistSheet meditationId={med.id} open={addOpen} onOpenChange={setAddOpen} />
      ...
      <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', gap: 6 }}>
        <button
          ...
          style={{ width: 26, height: 26, borderRadius: '50%', border: 'none', background: 'transparent', color: 'rgba(255,255,255,.32)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}
        >
          <ListPlus size={15} />
        </button>
        {isFree
  ...
  return (
    <div className="sqi-page">
      ...
      <div className="sqi-content">
        ...
        {/* Supreme Siddha Meditation card removed — now lives only inside Siddha Portal */}

        {/* YOUR MEDITATION PLAYLISTS — entry point */}
        <div
          onClick={() => navigate('/meditation-playlists')}
          style={{ margin: '0 20px 16px', padding: '14px 16px', borderRadius: 20, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(212,175,55,.16)', display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontWeight: 700, fontSize: 14, color: 'rgba(255,255,255,.88)' }}>Your Meditation Playlists</div>
            <div style={{ fontSize: 11.5, color: 'rgba(255,255,255,.4)', marginTop: 1 }}>Create and play your own meditation mixes</div>
          </div>
