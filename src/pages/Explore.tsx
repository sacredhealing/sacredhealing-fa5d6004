...
export default function Explore() {
  ...
  const exploreItems: LibraryItem[] = useMemo(
    () => [
      ...
      { key: "creativeSoul", title: t("explore.creativeSoul", "Creative Soul"), subtitle: t("explore.creativeSoulDesc", "Create with AI"), href: "/healing", icon: <Sparkles className="h-5 w-5" /> },
