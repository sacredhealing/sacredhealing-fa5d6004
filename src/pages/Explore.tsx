  ...
  return (
    <div style={{ background: '#050505', minHeight: '100vh', paddingBottom: 104 }}>
      ...
      <div style={{ padding: '52px 20px 0', animation: 'sqFadeUp 0.35s ease both' }}>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '2.1rem', fontWeight: 600, color: 'rgba(255,255,255,0.9)', lineHeight: 1.1, margin: 0 }}>{t('converge.title')}</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 7, marginBottom: 16 }}>
          {[
            ...
            <div key={i} style={{ background: 'rgba(212,175,55,0.05)', border: '1px solid rgba(212,175,55,0.1)', borderRadius: 11, padding: '9px 5px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
              {svg}
              <span style={{ fontFamily: "'Montserrat',sans-serif", fontSize: 5.5, fontWeight: 800, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(212,175,55,0.48)', textAlign: 'center', lineHeight: 1.4, whiteSpace: 'pre-line' }}>{t(labelKey)}</span>
            </div>
          ))}
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginBottom: 16 }}>
            {[
              ...
              <div key={i} style={{ background: 'rgba(30,80,160,0.2)', border: '1px solid rgba(100,160,255,0.15)', borderRadius: 13, padding: '11px 8px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
                {svg}
                <span style={{ fontFamily: "'Montserrat',sans-serif", fontSize: 6, fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(120,180,255,0.6)', textAlign: 'center', lineHeight: 1.4, whiteSpace: 'pre-line' }}>{t(labelKey)}</span>
              </div>
            ))}
          </div>
