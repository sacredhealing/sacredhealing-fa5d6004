// Svapna Vidyā (Siddha Dream Academy) — extracted verbatim from
// SiddhaDreamAcademy.tsx. 15 modules on Siddha dream science: Taijasa
// dream anatomy, hypnagogic phosphenes, dream mantras, Svapna-Jagrat
// lucidity, Akashic access, Turiya-Svapna, and the 40-night Tapas.

export interface DreamLesson { title: string; body: string; }
export interface DreamModule {
  tier: 'free' | 'prana' | 'siddha' | 'akasha'; module: string;
  title: string; subtitle: string; lessons: DreamLesson[];
}

export const DREAM_CURRICULUM: DreamModule[] = [
  // ── FREE ──
  {
