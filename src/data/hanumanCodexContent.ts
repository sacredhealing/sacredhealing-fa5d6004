// Hanuman Codex — extracted verbatim from HanumanCodex.tsx
// 8 sections: Chalisa (43 verses), Ghata (movements), Sadhana curriculum,
// 8 Weapons, Physical Training, Siddhis, Nine Nidhis, Devotion practices.
// Every item is individually tier-gated via its own 'tier' field.

export const HANUMAN_CHALISA_VERSES = [
  {
    id: "doha-1",
    type: "doha",
...
export const HANUMAN_GHATA_MOVEMENTS = [
  {
    id: 1,
    name: "Anjali Pranam",
...
export const HANUMAN_SADHANA_CURRICULUM = [
  {
    level: 1,
...
export const HANUMAN_WEAPONS_DATA = [
  {
    id: "gada",
...
export const HANUMAN_PHYSICAL_TRAINING = [
  {
    id: "akhara",
...
export const HANUMAN_NINE_NIDHIS = [
...
export const HANUMAN_DEVOTION_PRACTICES = [
  {
    id: "sundara-kanda",
