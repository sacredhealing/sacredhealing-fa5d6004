// Sacred Water Alchemy — extracted verbatim from SiddhaWaterAlchemy.tsx
// 40 modules across all 4 tiers (6 free, 10 prana-flow, 8 siddha-quantum,
// 16 akasha-infinity), each with multiple teaching sections and a living
// practice. Sourced from Siddha water science, Dr. Emoto's crystal
// research, and the 18 Siddhas' water consecration teachings.

export interface WaterSection { heading: string; body: string; }

export interface WaterModuleData {
  id: string;
...
export const WATER_MODULES: WaterModuleData[] = [
// ═══════════════════════════════════════ FREE 01–06 ══════════════════════
