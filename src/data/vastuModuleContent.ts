// Vastu Shastra Curriculum — extracted verbatim from SiddhaVastuCurriculum.tsx
// 8 modules, 19 lessons, sourced from the Vastu Purusha Mandala tradition,
// Sthapatya Veda, and Tamil Siddha building-biology teachings. Each lesson
// has multiple teaching sections, a practice, and often a mantra + secret.

export type VastuTier = "free" | "prana" | "siddha" | "akasha";

export interface VastuLessonSection {
  heading: string;
  body: string;
}

export interface VastuLesson {
  id: string;
  title: string;
  duration: string;
  tier: VastuTier;
  glyph: string;
  overview: string;
  sections: VastuLessonSection[];
  practice: string;
  mantra?: string;
  secret?: string;
}

export interface VastuModuleData {
  id: string;
  level: number;
  title: string;
  subtitle: string;
...
export const VASTU_MODULES: VastuModuleData[] = [
  // ══════════════════════════════════════════════════════════
  // LEVEL 1 — BHOOMI
  // ══════════════════════════════════════════════════════════
  {
