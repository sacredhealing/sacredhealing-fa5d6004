// Sacred Geometry Education — extracted verbatim from SacredGeometry.tsx
// 10 modules, 38 lessons on Sri Yantra, planetary grids, ley lines,
// Merkaba, Platonic Solids, and sacred building, citing Thirumoolar,
// Agastya Muni, Bogar, and Mahavatar Babaji.

export type SacredGeometryTier = 'free' | 'prana' | 'quantum' | 'akasha';
export interface SacredGeometryLesson { id: string; title: string; duration: string; content: string; }
export interface SacredGeometryModule {
  id: string; number: number; title: string; subtitle: string; tier: SacredGeometryTier;
  icon: string; description: string; lessons: SacredGeometryLesson[];
}

export const SACRED_GEOMETRY_MODULES: SacredGeometryModule[] =
[
