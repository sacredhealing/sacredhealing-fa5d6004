...
req = urllib.request.Request(f'{BASE}/delta_arb_trades?select=mode,status,pnl_usdc,size_usd,created_at&order=created_at.desc&limit=10',
...
if live:
    ...
    print('Still PAPER — bot may need another minute')
