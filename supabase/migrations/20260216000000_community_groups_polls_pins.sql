-- ============================================
-- Full Community Upgrade: Groups, Chat, Polls, Pins
-- Andlig Transformation + Stargate Community, Polls, invite_link
-- ============================================

-- 1) Extend chat_rooms: invite_link, allow types 'andlig' and 'stargate'
...
-- 2) Stargate Community: manual member list (admin can add users who aren't subscribers)
...
CREATE POLICY "Users can view if they are in the list"
  ON public.stargate_community_members FOR SELECT
...
CREATE POLICY "Users can view polls in rooms they can access"
...
-- 4) Insert Andlig Transformation and Stargate Community rooms (if not exist)
DO $$
DECLARE
  admin_user_id uuid;
BEGIN
