-- Brahmacharya Siddha Academy: real Supabase-backed tables, matching the
-- established pattern. Metadata here, rich content (per-lesson body[]
-- paragraphs, keyPoints, practice, mantra) in
-- src/data/brahmacharyaModuleContent.ts. 8 modules, ~53 lessons.
