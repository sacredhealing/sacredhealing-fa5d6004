...
GRANT SELECT ON public.ramayana_codex_kandas TO authenticated;
GRANT ALL ON public.ramayana_codex_kandas TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_ramayana_codex_progress TO authenticated;
GRANT ALL ON public.user_ramayana_codex_progress TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_ramayana_codex_section_progress TO authenticated;
GRANT ALL ON public.user_ramayana_codex_section_progress TO service_role;
...
DROP TRIGGER IF EXISTS trg_ramayana_section_updated_at ON public.user_ramayana_codex_section_progress;
CREATE TRIGGER trg_ramayana_section_updated_at
  BEFORE UPDATE ON public.user_ramayana_codex_section_progress
