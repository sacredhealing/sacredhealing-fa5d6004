...
GRANT SELECT ON public.alchemical_shiva_courses TO authenticated;
GRANT ALL ON public.alchemical_shiva_courses TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_alchemical_shiva_progress TO authenticated;
GRANT ALL ON public.user_alchemical_shiva_progress TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_alchemical_shiva_section_progress TO authenticated;
GRANT ALL ON public.user_alchemical_shiva_section_progress TO service_role;
...
CREATE TRIGGER update_user_alchemical_shiva_section_progress_updated_at
BEFORE UPDATE ON public.user_alchemical_shiva_section_progress
