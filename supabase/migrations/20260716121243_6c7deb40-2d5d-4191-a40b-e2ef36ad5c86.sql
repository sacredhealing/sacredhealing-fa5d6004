...
GRANT SELECT ON public.brahma_muhurta_courses TO authenticated;
GRANT ALL ON public.brahma_muhurta_courses TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_brahma_muhurta_progress TO authenticated;
GRANT ALL ON public.user_brahma_muhurta_progress TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_brahma_muhurta_section_progress TO authenticated;
GRANT ALL ON public.user_brahma_muhurta_section_progress TO service_role;

CREATE INDEX IF NOT EXISTS idx_user_brahma_muhurta_progress_user
  ON public.user_brahma_muhurta_progress(user_id);
...
CREATE TRIGGER update_user_brahma_muhurta_section_progress_updated_at
  BEFORE UPDATE ON public.user_brahma_muhurta_section_progress
