...
GRANT SELECT ON public.pranayama_courses TO authenticated;
GRANT ALL ON public.pranayama_courses TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_pranayama_progress TO authenticated;
GRANT ALL ON public.user_pranayama_progress TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_pranayama_section_progress TO authenticated;
GRANT ALL ON public.user_pranayama_section_progress TO service_role;
...
CREATE TRIGGER update_user_pranayama_section_progress_updated_at
BEFORE UPDATE ON public.user_pranayama_section_progress
