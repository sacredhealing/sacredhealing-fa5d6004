-- Sovereign Hormonal Alchemy (Shakti Cycle Intelligence): real Supabase-
-- backed tables, matching the established pattern. Metadata here, rich
-- content (curriculum items with description/practices/herbs/mantra per
-- module, plus cycle-phase profiles and herb/planet reference tables) in
-- src/data/shaktiCycleModuleContent.ts. 35 modules across 3 tiers --
-- this academy has no siddha-quantum tier by original design, jumping
-- from prana-flow straight to akasha-infinity.
