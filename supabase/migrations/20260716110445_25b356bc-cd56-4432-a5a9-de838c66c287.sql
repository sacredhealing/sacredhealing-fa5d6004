...
GRANT SELECT ON public.kriya_yoga_courses TO authenticated;
GRANT ALL ON public.kriya_yoga_courses TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_kriya_yoga_progress TO authenticated;
GRANT ALL ON public.user_kriya_yoga_progress TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_kriya_yoga_section_progress TO authenticated;
GRANT ALL ON public.user_kriya_yoga_section_progress TO service_role;
