...
GRANT SELECT ON public.siddha_lab_entries TO anon;
GRANT ALL ON public.siddha_lab_entries TO service_role;
...
CREATE TRIGGER update_siddha_lab_entries_updated_at
BEFORE UPDATE ON public.siddha_lab_entries
