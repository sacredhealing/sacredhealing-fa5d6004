...
GRANT SELECT ON public.siddha_fasting_courses TO authenticated;
GRANT ALL ON public.siddha_fasting_courses TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_siddha_fasting_progress TO authenticated;
GRANT ALL ON public.user_siddha_fasting_progress TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_siddha_fasting_section_progress TO authenticated;
GRANT ALL ON public.user_siddha_fasting_section_progress TO service_role;
