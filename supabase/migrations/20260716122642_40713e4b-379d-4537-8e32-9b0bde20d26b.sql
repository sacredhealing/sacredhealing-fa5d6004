...
GRANT SELECT ON public.meditation_course_modules TO authenticated;
GRANT ALL ON public.meditation_course_modules TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_meditation_course_progress TO authenticated;
GRANT ALL ON public.user_meditation_course_progress TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_meditation_course_section_progress TO authenticated;
GRANT ALL ON public.user_meditation_course_section_progress TO service_role;
...
CREATE INDEX IF NOT EXISTS idx_user_meditation_course_progress_user
  ON public.user_meditation_course_progress(user_id);
...
DROP TRIGGER IF EXISTS update_user_meditation_course_section_progress_updated_at
  ON public.user_meditation_course_section_progress;
CREATE TRIGGER update_user_meditation_course_section_progress_updated_at
  BEFORE UPDATE ON public.user_meditation_course_section_progress
