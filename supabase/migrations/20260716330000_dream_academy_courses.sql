-- Svapna Vidya (Siddha Dream Academy): real Supabase-backed tables,
-- matching the established pattern. Metadata here, rich content
-- (title/body per lesson) in src/data/dreamAcademyModuleContent.ts.
-- 15 modules -- expanded from an original 8-module build in a later,
-- undocumented session; confirmed the live file genuinely has 15.
