...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.user_lesson_section_progress TO authenticated;
GRANT ALL ON public.user_lesson_section_progress TO service_role;
