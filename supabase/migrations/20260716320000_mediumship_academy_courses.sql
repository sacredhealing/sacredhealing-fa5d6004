-- Siddha Mediumship Academy: real Supabase-backed tables, matching the
-- established pattern. Metadata here, rich content (title/duration/body
-- per lesson) in src/data/mediumshipModuleContent.ts. 8 modules.
