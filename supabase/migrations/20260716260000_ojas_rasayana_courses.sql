-- Ojas Rasayana Academy: real Supabase-backed tables, matching the
-- established pattern. Metadata here, rich content (title + content per
-- lesson, ~90,000 characters across 44 lessons) in
-- src/data/ojasRasayanaModuleContent.ts. 15 modules.
