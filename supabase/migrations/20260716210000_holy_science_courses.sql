-- Holy Science Curriculum: real Supabase-backed tables, matching the
-- established pattern. Metadata here, rich lesson content (content +
-- optional revelation per lesson) in src/data/holyScienceModuleContent.ts.
