-- Bhagavad Gita: verse-by-verse holy space in Sacred Spaces.
-- Open to every tier; each verse is individually tier-gated by admin.
-- Reuses the existing tier_name_to_level / current_user_tier_level /
-- has_role infrastructure already used for jyotish_modules and mantras.
