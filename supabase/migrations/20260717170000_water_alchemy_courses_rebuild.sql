-- Sacred Water Alchemy: full rebuild to match the standard academy
...
-- module-progress migration (20260716420000) -- that table is now
-- unreferenced and can be dropped or left in place.
--
-- Metadata here, content (per-module sections + practice) in
-- src/data/waterAlchemyModuleContent.ts. 40 modules across all 4 tiers
-- (6 free, 10 prana-flow, 8 siddha-quantum, 16 akasha-infinity).
